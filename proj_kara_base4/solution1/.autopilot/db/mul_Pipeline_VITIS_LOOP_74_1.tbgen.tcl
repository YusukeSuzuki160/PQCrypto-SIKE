...
set C_modelArgList {
	...
	{ B_out int 256 regular {pointer 1}  }
	{ A_out int 256 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "Al_reload", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "B_out", "interface" : "wire", "bitwidth" : 256, "direction" : "WRITEONLY"} , 
 	{ "Name" : "A_out", "interface" : "wire", "bitwidth" : 256, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ Bl_reload sc_in sc_lv 64 signal 4 } 
	{ Bl_1_reload sc_in sc_lv 64 signal 5 } 
	{ Bl_2_reload sc_in sc_lv 64 signal 6 } 
	{ Bl_3_reload sc_in sc_lv 64 signal 7 } 
	{ B_out sc_out sc_lv 256 signal 8 } 
	{ B_out_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ A_out sc_out sc_lv 256 signal 9 } 
	{ A_out_ap_vld sc_out sc_logic 1 outvld 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "B_out", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "B_out", "role": "default" }} , 
 	{ "name": "B_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "B_out", "role": "ap_vld" }} , 
 	{ "name": "A_out", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "A_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_2_64_1_1_U17", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.partset_256ns_256ns_64ns_32ns_256_1_1_U18", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_2_64_1_1_U19", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.partset_256ns_256ns_64ns_32ns_256_1_1_U20", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	B_out { ap_vld {  { B_out out_data 1 256 }  { B_out_ap_vld out_vld 1 1 } } }
	A_out { ap_vld {  { A_out out_data 1 256 }  { A_out_ap_vld out_vld 1 1 } } }
}
