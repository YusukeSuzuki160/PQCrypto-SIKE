...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler test_mul_karatsuba_configurable_sparsemux_9_2_64_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {compactencoding_dontcare}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler test_mul_karatsuba_configurable_partset_256ns_256ns_64ns_32ns_256_1_1 BINDTYPE {op} TYPE {partset} IMPL {auto}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_B_out \
    op interface \
    ports { B_out { O 256 vector } B_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_A_out \
    op interface \
    ports { A_out { O 256 vector } A_out_ap_vld { O 1 bit } } \
} "
}
