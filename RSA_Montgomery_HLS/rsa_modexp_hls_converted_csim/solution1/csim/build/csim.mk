...
HLS_SOURCES = ../../../../src_converted/tb_top.cpp ../../../../src_converted/rsa_modexp_hw.cpp ../../../../src_converted/mont_word.cpp
...
$(ObjDir)/tb_top.o: ../../../../src_converted/tb_top.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../src_converted/tb_top.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_top.d

$(ObjDir)/rsa_modexp_hw.o: ../../../../src_converted/rsa_modexp_hw.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../src_converted/rsa_modexp_hw.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/rsa_modexp_hw.d

$(ObjDir)/mont_word.o: ../../../../src_converted/mont_word.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../src_converted/mont_word.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
