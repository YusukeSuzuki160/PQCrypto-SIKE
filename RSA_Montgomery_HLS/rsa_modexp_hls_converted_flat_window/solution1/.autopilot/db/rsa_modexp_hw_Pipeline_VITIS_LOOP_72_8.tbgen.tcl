set moduleName rsa_modexp_hw_Pipeline_VITIS_LOOP_72_8
set isTopModule 0
...
set cdfgNum 25
set C_modelName {rsa_modexp_hw_Pipeline_VITIS_LOOP_72_8}
...
dict set ap_memory_interface_dict z { MEM_WIDTH 32 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ table_r int 32 regular {array 256 { 1 3 } 1 1 }  }
	{ z int 32 regular {array 16 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "table_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ table_r_address0 sc_out sc_lv 8 signal 0 } 
	{ table_r_ce0 sc_out sc_logic 1 signal 0 } 
	{ table_r_q0 sc_in sc_lv 32 signal 0 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "rsa_modexp_hw_Pipeline_VITIS_LOOP_72_8",
		"Protocol" : "ap_ctrl_hs",
...
set Spec2ImplPortList { 
	table_r { ap_memory {  { table_r_address0 mem_address 1 8 }  { table_r_ce0 mem_ce 1 1 }  { table_r_q0 mem_dout 0 32 } } }
	z { ap_memory {  { z_address0 mem_address 1 4 }  { z_ce0 mem_ce 1 1 }  { z_we0 mem_we 1 1 }  { z_d0 mem_din 1 32 } } }
}
