...
dict set ap_memory_interface_dict a { MEM_WIDTH 32 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
set C_modelArgList {
	{ a int 32 regular {array 32 { 1 1 } 1 1 }  }
	{ a_offset int 1 regular  }
	{ b int 32 regular {array 32 { 1 1 } 1 1 }  }
	{ c int 32 regular {array 32 { 0 0 } 0 1 }  }
...
set portList { 
	...
	{ m_axi_gmem_0_AWVALID sc_out sc_logic 1 signal 4 } 
	{ m_axi_gmem_0_AWREADY sc_in sc_logic 1 signal 4 } 
	{ m_axi_gmem_0_AWADDR sc_out sc_lv 64 signal 4 } 
	{ m_axi_gmem_0_AWID sc_out sc_lv 1 signal 4 } 
	{ m_axi_gmem_0_AWLEN sc_out sc_lv 32 signal 4 } 
	{ m_axi_gmem_0_AWSIZE sc_out sc_lv 3 signal 4 } 
	{ m_axi_gmem_0_AWBURST sc_out sc_lv 2 signal 4 } 
	{ m_axi_gmem_0_AWLOCK sc_out sc_lv 2 signal 4 } 
	{ m_axi_gmem_0_AWCACHE sc_out sc_lv 4 signal 4 } 
	{ m_axi_gmem_0_AWPROT sc_out sc_lv 3 signal 4 } 
	{ m_axi_gmem_0_AWQOS sc_out sc_lv 4 signal 4 } 
	{ m_axi_gmem_0_AWREGION sc_out sc_lv 4 signal 4 } 
	{ m_axi_gmem_0_AWUSER sc_out sc_lv 1 signal 4 } 
	{ m_axi_gmem_0_WVALID sc_out sc_logic 1 signal 4 } 
	{ m_axi_gmem_0_WREADY sc_in sc_logic 1 signal 4 } 
	{ m_axi_gmem_0_WDATA sc_out sc_lv 32 signal 4 } 
	{ m_axi_gmem_0_WSTRB sc_out sc_lv 4 signal 4 } 
	{ m_axi_gmem_0_WLAST sc_out sc_logic 1 signal 4 } 
	{ m_axi_gmem_0_WID sc_out sc_lv 1 signal 4 } 
	{ m_axi_gmem_0_WUSER sc_out sc_lv 1 signal 4 } 
	{ m_axi_gmem_0_ARVALID sc_out sc_logic 1 signal 4 } 
	{ m_axi_gmem_0_ARREADY sc_in sc_logic 1 signal 4 } 
	{ m_axi_gmem_0_ARADDR sc_out sc_lv 64 signal 4 } 
	{ m_axi_gmem_0_ARID sc_out sc_lv 1 signal 4 } 
	{ m_axi_gmem_0_ARLEN sc_out sc_lv 32 signal 4 } 
	{ m_axi_gmem_0_ARSIZE sc_out sc_lv 3 signal 4 } 
	{ m_axi_gmem_0_ARBURST sc_out sc_lv 2 signal 4 } 
	{ m_axi_gmem_0_ARLOCK sc_out sc_lv 2 signal 4 } 
	{ m_axi_gmem_0_ARCACHE sc_out sc_lv 4 signal 4 } 
	{ m_axi_gmem_0_ARPROT sc_out sc_lv 3 signal 4 } 
	{ m_axi_gmem_0_ARQOS sc_out sc_lv 4 signal 4 } 
	{ m_axi_gmem_0_ARREGION sc_out sc_lv 4 signal 4 } 
	{ m_axi_gmem_0_ARUSER sc_out sc_lv 1 signal 4 } 
	{ m_axi_gmem_0_RVALID sc_in sc_logic 1 signal 4 } 
	{ m_axi_gmem_0_RREADY sc_out sc_logic 1 signal 4 } 
	{ m_axi_gmem_0_RDATA sc_in sc_lv 32 signal 4 } 
	{ m_axi_gmem_0_RLAST sc_in sc_logic 1 signal 4 } 
	{ m_axi_gmem_0_RID sc_in sc_lv 1 signal 4 } 
	{ m_axi_gmem_0_RFIFONUM sc_in sc_lv 9 signal 4 } 
	{ m_axi_gmem_0_RUSER sc_in sc_lv 1 signal 4 } 
	{ m_axi_gmem_0_RRESP sc_in sc_lv 2 signal 4 } 
	{ m_axi_gmem_0_BVALID sc_in sc_logic 1 signal 4 } 
	{ m_axi_gmem_0_BREADY sc_out sc_logic 1 signal 4 } 
	{ m_axi_gmem_0_BRESP sc_in sc_lv 2 signal 4 } 
	{ m_axi_gmem_0_BID sc_in sc_lv 1 signal 4 } 
	{ m_axi_gmem_0_BUSER sc_in sc_lv 1 signal 4 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "18", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U29", "Parent" : "0"},
	{"ID" : "19", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U30", "Parent" : "0"},
	{"ID" : "20", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U31", "Parent" : "0"},
	{"ID" : "21", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U32", "Parent" : "0"},
	{"ID" : "22", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U33", "Parent" : "0"},
	{"ID" : "23", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U34", "Parent" : "0"},
	{"ID" : "24", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U35", "Parent" : "0"},
	{"ID" : "25", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U36", "Parent" : "0"},
	{"ID" : "26", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U37", "Parent" : "0"},
	{"ID" : "27", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U38", "Parent" : "0"},
	{"ID" : "28", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U39", "Parent" : "0"},
	{"ID" : "29", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U40", "Parent" : "0"},
	{"ID" : "30", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U41", "Parent" : "0"},
	{"ID" : "31", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U42", "Parent" : "0"},
	{"ID" : "32", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U43", "Parent" : "0"},
	{"ID" : "33", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U44", "Parent" : "0"},
	{"ID" : "34", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_32_1_1_U45", "Parent" : "0"},
	{"ID" : "35", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_32_1_1_U46", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	b { ap_memory {  { b_address0 mem_address 1 5 }  { b_ce0 mem_ce 1 1 }  { b_q0 mem_dout 0 32 }  { b_address1 MemPortADDR2 1 5 }  { b_ce1 MemPortCE2 1 1 }  { b_q1 MemPortDOUT2 0 32 } } }
	c { ap_memory {  { c_address0 mem_address 1 5 }  { c_ce0 mem_ce 1 1 }  { c_we0 mem_we 1 1 }  { c_d0 mem_din 1 32 }  { c_address1 MemPortADDR2 1 5 }  { c_ce1 MemPortCE2 1 1 }  { c_we1 MemPortWE2 1 1 }  { c_d1 MemPortDIN2 1 32 } } }
