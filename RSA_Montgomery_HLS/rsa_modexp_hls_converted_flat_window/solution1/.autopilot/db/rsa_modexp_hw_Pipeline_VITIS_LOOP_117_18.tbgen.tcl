set moduleName rsa_modexp_hw_Pipeline_VITIS_LOOP_117_18
set isTopModule 0
...
set cdfgNum 25
set C_modelName {rsa_modexp_hw_Pipeline_VITIS_LOOP_117_18}
...
set C_modelArgList {
	{ zrun int 32 regular {array 16 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zrun", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zrun_address0 sc_out sc_lv 4 signal 0 } 
	{ zrun_ce0 sc_out sc_logic 1 signal 0 } 
	{ zrun_q0 sc_in sc_lv 32 signal 0 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "rsa_modexp_hw_Pipeline_VITIS_LOOP_117_18",
		"Protocol" : "ap_ctrl_hs",
...
set Spec2ImplPortList { 
	zrun { ap_memory {  { zrun_address0 mem_address 1 4 }  { zrun_ce0 mem_ce 1 1 }  { zrun_q0 mem_dout 0 32 } } }
