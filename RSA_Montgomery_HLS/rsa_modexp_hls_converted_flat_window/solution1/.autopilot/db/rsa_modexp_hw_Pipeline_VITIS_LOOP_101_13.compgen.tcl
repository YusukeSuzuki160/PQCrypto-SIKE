...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename zrun \
    op interface \
    ports { zrun_address0 { O 4 vector } zrun_ce0 { O 1 bit } zrun_we0 { O 1 bit } zrun_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'zrun'"
}
}
