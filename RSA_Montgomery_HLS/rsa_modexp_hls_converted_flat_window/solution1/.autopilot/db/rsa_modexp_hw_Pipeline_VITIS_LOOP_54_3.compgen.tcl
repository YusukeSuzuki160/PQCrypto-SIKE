...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename conv_x \
    op interface \
    ports { conv_x_address0 { O 5 vector } conv_x_ce0 { O 1 bit } conv_x_we0 { O 1 bit } conv_x_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'conv_x'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename conv_y \
    op interface \
    ports { conv_y_address0 { O 5 vector } conv_y_ce0 { O 1 bit } conv_y_we0 { O 1 bit } conv_y_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'conv_y'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln53_1 \
    op interface \
    ports { sext_ln53_1 { I 62 vector } } \
} "
}
