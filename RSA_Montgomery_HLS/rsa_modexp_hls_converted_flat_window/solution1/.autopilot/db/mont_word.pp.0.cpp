# 1 "src_converted_flat_window/mont_word.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "src_converted_flat_window/mont_word.cpp" 2
...
# 2 "src_converted_flat_window/mont_word.cpp" 2
...
# 3 "src_converted_flat_window/mont_word.cpp" 2
...
# 4 "src_converted_flat_window/mont_word.cpp" 2


# 1 "src_converted_flat_window/mont_word.h" 1
# 17 "src_converted_flat_window/mont_word.h"
extern "C" {
...
# 7 "src_converted_flat_window/mont_word.cpp" 2
...
uint32_t mont_word_compute_mprime(uint32_t m0)
{
    ...
    uint32_t inv = 1;
    VITIS_LOOP_15_1: for (int k = 0; k < 5; k++)
    {
        inv = inv * (2u - m0 * inv);
    }
