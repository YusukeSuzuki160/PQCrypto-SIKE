set moduleName rsa_modexp_hw_Pipeline_VITIS_LOOP_101_13
set isTopModule 0
...
set cdfgNum 25
set C_modelName {rsa_modexp_hw_Pipeline_VITIS_LOOP_101_13}
...
dict set ap_memory_interface_dict zrun { MEM_WIDTH 32 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ z int 32 regular {array 16 { 1 3 } 1 1 }  }
	{ zrun int 32 regular {array 16 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "z", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "zrun", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ z_address0 sc_out sc_lv 4 signal 0 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "rsa_modexp_hw_Pipeline_VITIS_LOOP_101_13",
		"Protocol" : "ap_ctrl_hs",
...
set Spec2ImplPortList { 
	...
	zrun { ap_memory {  { zrun_address0 mem_address 1 4 }  { zrun_ce0 mem_ce 1 1 }  { zrun_we0 mem_we 1 1 }  { zrun_d0 mem_din 1 32 } } }
}
