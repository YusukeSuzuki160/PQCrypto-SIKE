set moduleName rsa_modexp_hw_Pipeline_VITIS_LOOP_59_5
set isTopModule 0
...
set cdfgNum 25
set C_modelName {rsa_modexp_hw_Pipeline_VITIS_LOOP_59_5}
...
set C_modelArgList {
	{ table_r int 32 regular {array 256 { 0 0 } 0 1 }  }
	{ conv_out int 32 regular {array 32 { 1 1 } 1 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "table_r", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ table_r_we0 sc_out sc_logic 1 signal 0 } 
	{ table_r_d0 sc_out sc_lv 32 signal 0 } 
	{ table_r_address1 sc_out sc_lv 8 signal 0 } 
	{ table_r_ce1 sc_out sc_logic 1 signal 0 } 
	{ table_r_we1 sc_out sc_logic 1 signal 0 } 
	{ table_r_d1 sc_out sc_lv 32 signal 0 } 
	{ conv_out_address0 sc_out sc_lv 5 signal 1 } 
	{ conv_out_ce0 sc_out sc_logic 1 signal 1 } 
	{ conv_out_q0 sc_in sc_lv 32 signal 1 } 
	{ conv_out_address1 sc_out sc_lv 5 signal 1 } 
	{ conv_out_ce1 sc_out sc_logic 1 signal 1 } 
	{ conv_out_q1 sc_in sc_lv 32 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	table_r { ap_memory {  { table_r_address0 mem_address 1 8 }  { table_r_ce0 mem_ce 1 1 }  { table_r_we0 mem_we 1 1 }  { table_r_d0 mem_din 1 32 }  { table_r_address1 MemPortADDR2 1 8 }  { table_r_ce1 MemPortCE2 1 1 }  { table_r_we1 MemPortWE2 1 1 }  { table_r_d1 MemPortDIN2 1 32 } } }
	conv_out { ap_memory {  { conv_out_address0 mem_address 1 5 }  { conv_out_ce0 mem_ce 1 1 }  { conv_out_q0 mem_dout 0 32 }  { conv_out_address1 MemPortADDR2 1 5 }  { conv_out_ce1 MemPortCE2 1 1 }  { conv_out_q1 MemPortDOUT2 0 32 } } }
}
