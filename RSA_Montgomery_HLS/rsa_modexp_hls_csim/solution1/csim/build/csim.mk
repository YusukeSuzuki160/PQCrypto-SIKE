...
HLS_SOURCES = ../../../../src/tb_top.cpp ../../../../src/rsa_modexp_hw.cpp ../../../../src/mont_word.c
...
$(ObjDir)/rsa_modexp_hw.o: ../../../../src/rsa_modexp_hw.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../src/rsa_modexp_hw.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/rsa_modexp_hw.d

$(ObjDir)/mont_word.o: ../../../../src/mont_word.c $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../src/mont_word.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
