set moduleName montMult_words_2_1_Pipeline_VITIS_LOOP_107_8
set isTopModule 0
...
set cdfgNum 32
set C_modelName {montMult_words.2.1_Pipeline_VITIS_LOOP_107_8}
...
dict set ap_memory_interface_dict out_r { MEM_WIDTH 32 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
...
set portList { 
	...
	{ sub_address0 sc_out sc_lv 4 signal 0 } 
	{ sub_ce0 sc_out sc_logic 1 signal 0 } 
	{ sub_q0 sc_in sc_lv 32 signal 0 } 
	{ t_address0 sc_out sc_lv 5 signal 1 } 
	{ t_ce0 sc_out sc_logic 1 signal 1 } 
	{ t_q0 sc_in sc_lv 32 signal 1 } 
	{ mask sc_in sc_lv 32 signal 2 } 
	{ neg sc_in sc_lv 32 signal 3 } 
	{ out_r_address0 sc_out sc_lv 4 signal 4 } 
