...
# 2 "<built-in>" 2
# 1 "src/rsa_modexp_hw.cpp" 2


# 1 "src/rsa_modexp_hw.h" 1
# 14 "src/rsa_modexp_hw.h"
# 1 "src/mont_word.h" 1
# 12 "src/mont_word.h"
...
extern "C" __attribute__((sdx_kernel("rsa_modexp_hw", 0))) void rsa_modexp_hw(
    ...
    uint32_t p[16u])
{
#line 25 "/home/meltpoint/eeic/PQCrypto-SIKE/RSA_Montgomery_HLS/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=rsa_modexp_hw
# 17 "src/rsa_modexp_hw.cpp"
