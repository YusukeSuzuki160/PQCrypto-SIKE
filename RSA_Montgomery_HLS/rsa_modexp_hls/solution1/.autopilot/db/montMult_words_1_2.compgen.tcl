...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler rsa_modexp_hw_montMult_words_1_2_sub_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename y \
    op interface \
    ports { y_address0 { O 4 vector } y_ce0 { O 1 bit } y_q0 { I 1 vector } y_address1 { O 4 vector } y_ce1 { O 1 bit } y_q1 { I 1 vector } } \
} "
} else {
