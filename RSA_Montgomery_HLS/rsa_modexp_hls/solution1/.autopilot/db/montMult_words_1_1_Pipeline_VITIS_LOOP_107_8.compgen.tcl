...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sub \
    op interface \
    ports { sub_address0 { O 4 vector } sub_ce0 { O 1 bit } sub_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'sub'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename t \
    op interface \
    ports { t_address0 { O 5 vector } t_ce0 { O 1 bit } t_q0 { I 32 vector } } \
} "
} else {
