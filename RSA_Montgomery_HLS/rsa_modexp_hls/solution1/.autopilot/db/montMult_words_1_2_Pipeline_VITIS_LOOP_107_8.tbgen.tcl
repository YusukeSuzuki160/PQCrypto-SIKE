set moduleName montMult_words_1_2_Pipeline_VITIS_LOOP_107_8
set isTopModule 0
...
set cdfgNum 32
set C_modelName {montMult_words.1.2_Pipeline_VITIS_LOOP_107_8}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict sub { MEM_WIDTH 32 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict t { MEM_WIDTH 32 MEM_SIZE 72 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 1}  }
	{ sext_ln107 int 62 regular  }
	{ sub int 32 regular {array 16 { 1 3 } 1 1 }  }
	{ t int 32 regular {array 18 { 1 3 } 1 1 }  }
	{ mask int 32 regular  }
	{ neg int 32 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "c","offset": { "type": "dynamic","port_name": "c","bundle": "control_r"},"direction": "READONLY"},{"cName": "d","offset": { "type": "dynamic","port_name": "d","bundle": "control_r"},"direction": "READONLY"},{"cName": "m","offset": { "type": "dynamic","port_name": "m","bundle": "control_r"},"direction": "READONLY"},{"cName": "r2m","offset": { "type": "dynamic","port_name": "r2m","bundle": "control_r"},"direction": "READONLY"},{"cName": "p","offset": { "type": "dynamic","port_name": "p","bundle": "control_r"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln107", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sub", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "t", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "mask", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "neg", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sub_address0 sc_out sc_lv 4 signal 2 } 
	{ sub_ce0 sc_out sc_logic 1 signal 2 } 
	{ sub_q0 sc_in sc_lv 32 signal 2 } 
	{ t_address0 sc_out sc_lv 5 signal 3 } 
	{ t_ce0 sc_out sc_logic 1 signal 3 } 
	{ t_q0 sc_in sc_lv 32 signal 3 } 
	{ mask sc_in sc_lv 32 signal 4 } 
	{ neg sc_in sc_lv 32 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "sub", "role": "address0" }} , 
 	{ "name": "sub_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sub", "role": "ce0" }} , 
 	{ "name": "sub_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sub", "role": "q0" }} , 
 	...
 	{ "name": "neg", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "neg", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sub { ap_memory {  { sub_address0 mem_address 1 4 }  { sub_ce0 mem_ce 1 1 }  { sub_q0 mem_dout 0 32 } } }
	t { ap_memory {  { t_address0 mem_address 1 5 }  { t_ce0 mem_ce 1 1 }  { t_q0 mem_dout 0 32 } } }
	mask { ap_none {  { mask in_data 0 32 } } }
	neg { ap_none {  { neg in_data 0 32 } } }
}
