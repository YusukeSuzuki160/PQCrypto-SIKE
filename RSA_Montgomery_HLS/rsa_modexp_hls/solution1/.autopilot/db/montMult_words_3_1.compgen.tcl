...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler rsa_modexp_hw_montMult_words_3_1_t_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler rsa_modexp_hw_montMult_words_3_1_sub_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
