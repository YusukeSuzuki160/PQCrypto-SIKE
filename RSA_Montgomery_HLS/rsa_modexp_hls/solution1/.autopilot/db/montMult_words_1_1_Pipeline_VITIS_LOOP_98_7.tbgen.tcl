set moduleName montMult_words_1_1_Pipeline_VITIS_LOOP_98_7
set isTopModule 0
...
set cdfgNum 32
set C_modelName {montMult_words.1.1_Pipeline_VITIS_LOOP_98_7}
...
dict set ap_memory_interface_dict sub { MEM_WIDTH 32 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 0}  }
	{ p_cast_cast int 62 regular  }
	{ t int 32 regular {array 18 { 1 3 } 1 1 }  }
	{ sub int 32 regular {array 16 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "c","offset": { "type": "dynamic","port_name": "c","bundle": "control_r"},"direction": "READONLY"},{"cName": "d","offset": { "type": "dynamic","port_name": "d","bundle": "control_r"},"direction": "READONLY"},{"cName": "m","offset": { "type": "dynamic","port_name": "m","bundle": "control_r"},"direction": "READONLY"},{"cName": "r2m","offset": { "type": "dynamic","port_name": "r2m","bundle": "control_r"},"direction": "READONLY"},{"cName": "p","offset": { "type": "dynamic","port_name": "p","bundle": "control_r"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "sub", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ t_address0 sc_out sc_lv 5 signal 2 } 
	{ t_ce0 sc_out sc_logic 1 signal 2 } 
	{ t_q0 sc_in sc_lv 32 signal 2 } 
	{ sub_address0 sc_out sc_lv 4 signal 3 } 
	{ sub_ce0 sc_out sc_logic 1 signal 3 } 
	{ sub_we0 sc_out sc_logic 1 signal 3 } 
	{ sub_d0 sc_out sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sub", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	sub { ap_memory {  { sub_address0 mem_address 1 4 }  { sub_ce0 mem_ce 1 1 }  { sub_we0 mem_we 1 1 }  { sub_d0 mem_din 1 32 } } }
}
