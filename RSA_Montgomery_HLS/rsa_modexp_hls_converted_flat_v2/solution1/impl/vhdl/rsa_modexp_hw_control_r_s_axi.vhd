...
entity rsa_modexp_hw_control_r_s_axi is
generic (
...
end entity rsa_modexp_hw_control_r_s_axi;
...
architecture behave of rsa_modexp_hw_control_r_s_axi is
    ...
    constant ADDR_D_DATA_0   : INTEGER := 16#1c#;
    constant ADDR_D_DATA_1   : INTEGER := 16#20#;
    constant ADDR_D_CTRL     : INTEGER := 16#24#;
    constant ADDR_M_DATA_0   : INTEGER := 16#28#;
    constant ADDR_M_DATA_1   : INTEGER := 16#2c#;
    constant ADDR_M_CTRL     : INTEGER := 16#30#;
    constant ADDR_R2M_DATA_0 : INTEGER := 16#34#;
    constant ADDR_R2M_DATA_1 : INTEGER := 16#38#;
    constant ADDR_R2M_CTRL   : INTEGER := 16#3c#;
    constant ADDR_P_DATA_0   : INTEGER := 16#40#;
    constant ADDR_P_DATA_1   : INTEGER := 16#44#;
    ...
    signal int_r2m             : UNSIGNED(63 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_R2M_DATA_0 =>
                        rdata_data <= RESIZE(int_r2m(31 downto 0), 32);
                    when ADDR_R2M_DATA_1 =>
                        rdata_data <= RESIZE(int_r2m(63 downto 32), 32);
                    when ADDR_P_DATA_0 =>
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_r2m(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_R2M_DATA_0) then
                    int_r2m(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_r2m(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_r2m(63 downto 32) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_R2M_DATA_1) then
                    int_r2m(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_r2m(63 downto 32));
                end if;
            end if;
        end if;
    end process;
