set moduleName rsa_modexp_hw_Pipeline_VITIS_LOOP_43_3
set isTopModule 0
...
set cdfgNum 17
set C_modelName {rsa_modexp_hw_Pipeline_VITIS_LOOP_43_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict conv_x { MEM_WIDTH 32 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict conv_y { MEM_WIDTH 32 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 0}  }
	{ conv_x int 32 regular {array 32 { 0 3 } 0 1 }  }
	{ conv_y int 32 regular {array 32 { 0 3 } 0 1 }  }
	{ sext_ln43 int 62 regular  }
	{ sext_ln42_1 int 62 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "c","offset": { "type": "dynamic","port_name": "c","bundle": "control_r"},"direction": "READONLY"},{"cName": "d","offset": { "type": "dynamic","port_name": "d","bundle": "control_r"},"direction": "READONLY"},{"cName": "m","offset": { "type": "dynamic","port_name": "m","bundle": "control_r"},"direction": "READONLY"},{"cName": "r2m","offset": { "type": "dynamic","port_name": "r2m","bundle": "control_r"},"direction": "READONLY"},{"cName": "p","offset": { "type": "dynamic","port_name": "p","bundle": "control_r"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "conv_x", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "conv_y", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sext_ln43", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln42_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ conv_x_we0 sc_out sc_logic 1 signal 1 } 
	{ conv_x_d0 sc_out sc_lv 32 signal 1 } 
	{ conv_y_address0 sc_out sc_lv 5 signal 2 } 
	{ conv_y_ce0 sc_out sc_logic 1 signal 2 } 
	{ conv_y_we0 sc_out sc_logic 1 signal 2 } 
	{ conv_y_d0 sc_out sc_lv 32 signal 2 } 
	{ sext_ln43 sc_in sc_lv 62 signal 3 } 
	{ sext_ln42_1 sc_in sc_lv 62 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv_x_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "conv_x", "role": "we0" }} , 
 	{ "name": "conv_x_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "conv_x", "role": "d0" }} , 
 	...
 	{ "name": "conv_y_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "conv_y", "role": "we0" }} , 
 	{ "name": "conv_y_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "conv_y", "role": "d0" }} , 
 	{ "name": "sext_ln43", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln43", "role": "default" }} , 
 	{ "name": "sext_ln42_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln42_1", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	conv_x { ap_memory {  { conv_x_address0 mem_address 1 5 }  { conv_x_ce0 mem_ce 1 1 }  { conv_x_we0 mem_we 1 1 }  { conv_x_d0 mem_din 1 32 } } }
	conv_y { ap_memory {  { conv_y_address0 mem_address 1 5 }  { conv_y_ce0 mem_ce 1 1 }  { conv_y_we0 mem_we 1 1 }  { conv_y_d0 mem_din 1 32 } } }
	sext_ln43 { ap_none {  { sext_ln43 in_data 0 62 } } }
	sext_ln42_1 { ap_none {  { sext_ln42_1 in_data 0 62 } } }
}
