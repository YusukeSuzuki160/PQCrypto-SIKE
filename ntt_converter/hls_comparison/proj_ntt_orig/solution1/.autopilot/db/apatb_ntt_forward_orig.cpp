...
// wrapc file define:
#define AUTOTB_TVIN_a "../tv/cdatafile/c.ntt_forward_orig.autotvin_a.dat"
#define AUTOTB_TVOUT_a "../tv/cdatafile/c.ntt_forward_orig.autotvout_a.dat"
#define AUTOTB_TVIN_roots "../tv/cdatafile/c.ntt_forward_orig.autotvin_roots.dat"
#define AUTOTB_TVOUT_roots "../tv/cdatafile/c.ntt_forward_orig.autotvout_roots.dat"
#define AUTOTB_TVIN_mod_r "../tv/cdatafile/c.ntt_forward_orig.autotvin_mod_r.dat"
#define AUTOTB_TVOUT_mod_r "../tv/cdatafile/c.ntt_forward_orig.autotvout_mod_r.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_a "../tv/rtldatafile/rtl.ntt_forward_orig.autotvout_a.dat"
...
extern "C"
void ntt_forward_orig_hw_stub_wrapper(void*, void*, hls::sim::Byte<4>);

extern "C"
void apatb_ntt_forward_orig_hw(void* __xlx_apatb_param_a, void* __xlx_apatb_param_roots, hls::sim::Byte<4> __xlx_apatb_param_mod_r)
{
  ...
  port0.param = &__xlx_apatb_param_mod_r;
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port2 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_roots),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_roots),
#endif
#endif
    .hasWrite = { false },
  };
  port2.param = { __xlx_apatb_param_roots };
  port2.mname = { "roots" };
  port2.nbytes = { 1024 };
  ...
  try {
    ...
    ntt_forward_orig_hw_stub_wrapper(__xlx_apatb_param_a, __xlx_apatb_param_roots, __xlx_apatb_param_mod_r);
