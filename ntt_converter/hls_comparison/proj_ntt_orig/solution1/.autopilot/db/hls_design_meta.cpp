...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("roots_Addr_A", 32, hls_out, 1, "bram", "MemPortADDR2", 1),
	Port_Property("roots_EN_A", 1, hls_out, 1, "bram", "MemPortCE2", 1),
	Port_Property("roots_WEN_A", 4, hls_out, 1, "bram", "MemPortWE2", 1),
	Port_Property("roots_Din_A", 32, hls_out, 1, "bram", "MemPortDIN2", 1),
	Port_Property("roots_Dout_A", 32, hls_in, 1, "bram", "MemPortDOUT2", 1),
	Port_Property("roots_Clk_A", 1, hls_out, 1, "bram", "mem_clk", 1),
	Port_Property("roots_Rst_A", 1, hls_out, 1, "bram", "mem_rst", 1),
...
const char* HLS_Design_Meta::dut_name = "ntt_forward_orig";
