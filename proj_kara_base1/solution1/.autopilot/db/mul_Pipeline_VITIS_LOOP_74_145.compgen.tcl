...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_A_22_out \
    op interface \
    ports { A_22_out { O 64 vector } A_22_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { B_21_out { O 64 vector } B_21_out_ap_vld { O 1 bit } } \
} "
}
