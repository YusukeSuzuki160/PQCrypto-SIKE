set moduleName mul_Pipeline_VITIS_LOOP_113_397
set isTopModule 0
...
set cdfgNum 110
set C_modelName {mul_Pipeline_VITIS_LOOP_113_397}
...
set C_modelArgMapList {[ 
	{ "Name" : "Pacc_12", "interface" : "wire", "bitwidth" : 1029, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ Pacc_12 sc_in sc_lv 1029 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "Pacc_12", "direction": "in", "datatype": "sc_lv", "bitwidth":1029, "type": "signal", "bundle":{"name": "Pacc_12", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.partselect_64ns_1056s_32ns_64_1_1_U652", "Parent" : "0"},
...
set Spec2ImplPortList { 
	Pacc_12 { ap_none {  { Pacc_12 in_data 0 1029 } } }
