...
{ // SIKE's encapsulation
  ...
  cshake256_simple(ss, CRYPTO_BYTES, H_CONST, temp, CRYPTO_CIPHERTEXTBYTES + MSG_BYTES);
...
{ // SIKE's decapsulation
  ...
  cshake256_simple(h_, MSG_BYTES, P_CONST, jinvariant_, FP2_ENCODED_BYTES);
  ...
  cshake256_simple(ephemeralsk_, SECRETKEY_A_BYTES, G_CONST, temp, CRYPTO_PUBLICKEYBYTES + MSG_BYTES);
