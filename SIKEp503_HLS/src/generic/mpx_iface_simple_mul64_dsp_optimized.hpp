// mpx_iface_simple_mul64_dsp_optimized.hpp
// fp_generic_origのDSP最適化手法を直接適用した版（LUT使用率87%目標）
// BLOCK_BITS = 64
// Interface:
...
#pragma HLS ALLOCATION instances = mul limit = 8 function
