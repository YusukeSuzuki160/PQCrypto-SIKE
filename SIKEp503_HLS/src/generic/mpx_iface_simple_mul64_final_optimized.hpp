// mpx_iface_simple_mul64_final_optimized.hpp
// fp_generic_origの手法を完全に適用した最終最適化版（LUT使用率87%目標）
// BLOCK_BITS = 64
// Interface:
...
#pragma HLS ALLOCATION instances = mul limit = 16 function
