// mpx_iface_simple_mul256.hpp
// Simple block-based schoolbook mul with original interface preserved.
// BLOCK_BITS = 256
// Interface:
...
struct PackedOps
{
    ...
    #pragma HLS INLINE off
        ...
        #pragma HLS loop_tripcount min=1 max=( (W*MAX_NWORDS + 256 - 1) / 256 )
            // a の i番目ブロック
            ...
            #pragma HLS PIPELINE II=1
                ...
                ap_uint<512> prod = (ap_uint<512>)ai * (ap_uint<512>)bj;
