// mpx_iface_simple_mul64_ultra_optimized.hpp
// fp_generic_origの手法を参考にした超最適化版（LUT使用率87%目標）
// BLOCK_BITS = 64
// Interface:
...
#pragma HLS ALLOCATION instances = mul limit = 4 function
...
#pragma HLS UNROLL factor = 1
            ...
            // fp_generic_origの手法を参考にした超最適化
            // DSP使用を最大化してLUT使用を最小化
