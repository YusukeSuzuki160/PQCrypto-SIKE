...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sikep503_kem_enc_hw_sparsemux_31_4_64_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {compactencoding_dontcare}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_zext_ln69_9 \
    op interface \
    ports { zext_ln69_9 { I 4 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_carry_597_out \
    op interface \
    ports { carry_597_out { O 64 vector } carry_597_out_ap_vld { O 1 bit } } \
} "
}
