set moduleName LADDER3PT_impl_250_Pipeline_VITIS_LOOP_17_1256
set isTopModule 0
...
set cdfgNum 623
set C_modelName {LADDER3PT_impl<250>_Pipeline_VITIS_LOOP_17_1256}
...
set C_modelArgList {
	{ R2_X_4 int 64 regular {array 8 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "R2_X_4", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ R2_X_4_address0 sc_out sc_lv 3 signal 0 } 
	{ R2_X_4_ce0 sc_out sc_logic 1 signal 0 } 
	{ R2_X_4_we0 sc_out sc_logic 1 signal 0 } 
	{ R2_X_4_d0 sc_out sc_lv 64 signal 0 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.XRA_1_U", "Parent" : "0"},
...
set Spec2ImplPortList { 
	R2_X_4 { ap_memory {  { R2_X_4_address0 mem_address 1 3 }  { R2_X_4_ce0 mem_ce 1 1 }  { R2_X_4_we0 mem_we 1 1 }  { R2_X_4_d0 mem_din 1 64 } } }
}
