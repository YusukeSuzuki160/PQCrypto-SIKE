# 1 "src_montcsa/sha3/fips202.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "src_montcsa/sha3/fips202.cpp" 2
# 14 "src_montcsa/sha3/fips202.cpp"
...
# 15 "src_montcsa/sha3/fips202.cpp" 2
...
# 16 "src_montcsa/sha3/fips202.cpp" 2
# 1 "src_montcsa/sha3/fips202.h" 1
# 10 "src_montcsa/sha3/fips202.h"
...
# 17 "src_montcsa/sha3/fips202.cpp" 2
...
# 18 "src_montcsa/sha3/fips202.cpp" 2
...
void KeccakF1600_StatePermute(uint64_t *state)
{
  ...
  VITIS_LOOP_121_1: for (round = 0; round < 24; round += 2)
  {
...
# 383 "src_montcsa/sha3/fips202.cpp" 2
...
static void keccak_absorb(uint64_t *s, unsigned int r, const unsigned char *m, unsigned long long int mlen, unsigned char p)
{
  ...
  VITIS_LOOP_388_1: while (mlen >= r)
  {

    VITIS_LOOP_391_2: for (i = 0; i < r / 8; ++i)
    {
  ...
  VITIS_LOOP_400_3: for (unsigned lane = 0; lane < r / 8; ++lane) {
...
static void keccak_squeezeblocks(unsigned char *h, unsigned long long int nblocks, uint64_t *s, unsigned int r)
{
  ...
  VITIS_LOOP_432_1: while (nblocks > 0)
  {

    KeccakF1600_StatePermute(s);
    VITIS_LOOP_436_2: for (i = 0; i < (fixed_r >> 3); i++)
    {
      store64(h + 8 * i, s[i]);
    }
    h += fixed_r;
...
void shake128(unsigned char *output, unsigned long long outlen, const unsigned char *input, unsigned long long inlen)
{
  ...
  if (outlen)
  {
    ...
    VITIS_LOOP_476_1: for (i = 0; i < outlen; i++)
    {
...
void cshake128_simple_absorb(uint64_t s[25], uint16_t cstm, const unsigned char *in, unsigned long long inlen)
{
  ...
  VITIS_LOOP_491_1: for (i = 0; i < 25; i++)
    s[i] = 0;
...
# 537 "src_montcsa/sha3/fips202.cpp"
  ...
  if (outlen % 168)
  {
    ...
    VITIS_LOOP_553_1: for (i = 0; i < outlen % 168; i++)
    {
...
void shake256(unsigned char *output, unsigned long long outlen, const unsigned char *input, unsigned long long inlen)
{
  ...
  VITIS_LOOP_580_1: for (i = 0; i < 25; ++i)
    s[i] = 0;
  ...
  if (outlen)
  {
    ...
    VITIS_LOOP_595_2: for (i = 0; i < outlen; i++)
    {
...
void cshake256_simple_absorb(uint64_t s[25], uint16_t cstm, const unsigned char *in, unsigned long long inlen)
{
  ...
  VITIS_LOOP_610_1: for (i = 0; i < 25; i++)
  {
    s[i] = 0;
  }
...
# 654 "src_montcsa/sha3/fips202.cpp"
  ...
  if (outlen % 136)
  {
    ...
    VITIS_LOOP_668_1: for (i = 0; i < outlen % 136; i++)
    {
