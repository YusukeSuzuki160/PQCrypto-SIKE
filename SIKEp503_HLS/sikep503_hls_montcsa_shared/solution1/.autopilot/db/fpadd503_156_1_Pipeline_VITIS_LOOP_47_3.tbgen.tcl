set moduleName fpadd503_156_1_Pipeline_VITIS_LOOP_47_3
set isTopModule 0
...
set cdfgNum 623
set C_modelName {fpadd503.156.1_Pipeline_VITIS_LOOP_47_3}
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln36_31", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln36_31 sc_in sc_lv 4 signal 0 } 
	...
	{ sext_ln31 sc_in sc_lv 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln36_31", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln36_31", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "fpadd503_156_1_Pipeline_VITIS_LOOP_47_3",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	fpadd503_156_1_Pipeline_VITIS_LOOP_47_3 {
...
set Spec2ImplPortList { 
	zext_ln36_31 { ap_none {  { zext_ln36_31 in_data 0 4 } } }
