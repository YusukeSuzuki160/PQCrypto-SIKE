set moduleName fpsub503_2_32_Pipeline_VITIS_LOOP_69_2
set isTopModule 0
...
set cdfgNum 623
set C_modelName {fpsub503.2.32_Pipeline_VITIS_LOOP_69_2}
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln64_16", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln64_16 sc_in sc_lv 4 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln64_16", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln64_16", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln64_16 { ap_none {  { zext_ln64_16 in_data 0 4 } } }
