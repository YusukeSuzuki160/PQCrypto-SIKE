set moduleName fpadd503_22_Pipeline_VITIS_LOOP_34_1
set isTopModule 0
...
set cdfgNum 623
set C_modelName {fpadd503.22_Pipeline_VITIS_LOOP_34_1}
...
set C_modelArgList {
	{ zext_ln36_12 int 4 regular  }
	{ a int 64 regular {array 16 { 1 3 } 1 1 }  }
	{ zext_ln36_11 int 4 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln36_12", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "a", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln36_11", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ b_0_offset sc_in sc_lv 1 signal 4 } 
	{ b_0_address0 sc_out sc_lv 3 signal 5 } 
	{ b_0_ce0 sc_out sc_logic 1 signal 5 } 
	{ b_0_q0 sc_in sc_lv 64 signal 5 } 
	{ b_1_offset sc_in sc_lv 1 signal 6 } 
	{ b_1_address0 sc_out sc_lv 3 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln36_12", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln36_12", "role": "default" }} , 
 	...
 	{ "name": "zext_ln36_11", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln36_11", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "fpadd503_22_Pipeline_VITIS_LOOP_34_1",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	fpadd503_22_Pipeline_VITIS_LOOP_34_1 {
...
set Spec2ImplPortList { 
	zext_ln36_12 { ap_none {  { zext_ln36_12 in_data 0 4 } } }
	a { ap_memory {  { a_address0 mem_address 1 4 }  { a_ce0 mem_ce 1 1 }  { a_q0 mem_dout 0 64 } } }
	zext_ln36_11 { ap_none {  { zext_ln36_11 in_data 0 4 } } }
