set moduleName fpadd503_155130_Pipeline_VITIS_LOOP_34_1
set isTopModule 0
...
set cdfgNum 623
set C_modelName {fpadd503.155130_Pipeline_VITIS_LOOP_34_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "a", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln36_32", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln36_32 sc_in sc_lv 4 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln36_32", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln36_32", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln36_32 { ap_none {  { zext_ln36_32 in_data 0 4 } } }
