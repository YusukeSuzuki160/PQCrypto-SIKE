set moduleName rdc_mont_2107_Pipeline_VITIS_LOOP_299_1
set isTopModule 0
...
set cdfgNum 623
set C_modelName {rdc_mont.2107_Pipeline_VITIS_LOOP_299_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "mc", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "zext_ln301", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ zext_ln301 sc_in sc_lv 4 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln301", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln301", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	zext_ln301 { ap_none {  { zext_ln301 in_data 0 4 } } }
}
