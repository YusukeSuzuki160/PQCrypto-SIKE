set moduleName fpsub503_27_Pipeline_VITIS_LOOP_62_1
set isTopModule 0
...
set cdfgNum 623
set C_modelName {fpsub503.27_Pipeline_VITIS_LOOP_62_1}
...
set C_modelArgList {
	{ zext_ln64_13 int 4 regular  }
	{ a int 64 regular {array 16 { 1 3 } 1 1 }  }
	{ zext_ln64_12 int 4 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln64_13", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "a", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln64_12", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln64_13", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln64_13", "role": "default" }} , 
 	...
 	{ "name": "zext_ln64_12", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln64_12", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln64_13 { ap_none {  { zext_ln64_13 in_data 0 4 } } }
	a { ap_memory {  { a_address0 mem_address 1 4 }  { a_ce0 mem_ce 1 1 }  { a_q0 mem_dout 0 64 } } }
	zext_ln64_12 { ap_none {  { zext_ln64_12 in_data 0 4 } } }
