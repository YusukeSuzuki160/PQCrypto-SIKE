set moduleName from_mont_Pipeline_VITIS_LOOP_112_2
set isTopModule 0
...
set cdfgNum 623
set C_modelName {from_mont_Pipeline_VITIS_LOOP_112_2}
...
set C_modelArgList {
	{ zext_ln108_2 int 4 regular  }
	{ c int 64 regular {array 16 { 0 1 } 1 1 }  }
	{ sext_ln104 int 1 regular  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln108_2", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "c", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "sext_ln104", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ zext_ln108_2 sc_in sc_lv 4 signal 0 } 
	...
	{ sext_ln104 sc_in sc_lv 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln108_2", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln108_2", "role": "default" }} , 
 	...
 	{ "name": "sext_ln104", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "sext_ln104", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "from_mont_Pipeline_VITIS_LOOP_112_2",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "zext_ln108_2", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	from_mont_Pipeline_VITIS_LOOP_112_2 {
		zext_ln108_2 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	zext_ln108_2 { ap_none {  { zext_ln108_2 in_data 0 4 } } }
	...
	sext_ln104 { ap_none {  { sext_ln104 in_data 0 1 } } }
}
