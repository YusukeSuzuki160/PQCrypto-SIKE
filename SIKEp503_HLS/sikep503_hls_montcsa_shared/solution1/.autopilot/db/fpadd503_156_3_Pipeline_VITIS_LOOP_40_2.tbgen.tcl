set moduleName fpadd503_156_3_Pipeline_VITIS_LOOP_40_2
set isTopModule 0
...
set cdfgNum 623
set C_modelName {fpadd503.156.3_Pipeline_VITIS_LOOP_40_2}
...
set C_modelArgList {
	{ zext_ln36_25 int 4 regular  }
	{ c int 64 regular {array 16 { 0 1 } 1 1 }  }
	{ carry_637_out int 1 regular {pointer 1}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln36_25", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "c", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "carry_637_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ zext_ln36_25 sc_in sc_lv 4 signal 0 } 
	...
	{ carry_637_out sc_out sc_lv 1 signal 2 } 
	{ carry_637_out_ap_vld sc_out sc_logic 1 outvld 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln36_25", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln36_25", "role": "default" }} , 
 	...
 	{ "name": "carry_637_out", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "carry_637_out", "role": "default" }} , 
 	{ "name": "carry_637_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "carry_637_out", "role": "ap_vld" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "fpadd503_156_3_Pipeline_VITIS_LOOP_40_2",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "carry_637_out", "Type" : "Vld", "Direction" : "O"},
...
set ArgLastReadFirstWriteLatency {
	fpadd503_156_3_Pipeline_VITIS_LOOP_40_2 {
		zext_ln36_25 {Type I LastRead 0 FirstWrite -1}
		c {Type IO LastRead 0 FirstWrite 1}
		carry_637_out {Type O LastRead -1 FirstWrite 0}
...
set Spec2ImplPortList { 
	zext_ln36_25 { ap_none {  { zext_ln36_25 in_data 0 4 } } }
	...
	carry_637_out { ap_vld {  { carry_637_out out_data 1 1 }  { carry_637_out_ap_vld out_vld 1 1 } } }
}
