set moduleName mul_4178_Pipeline_COL
set isTopModule 0
...
set cdfgNum 623
set C_modelName {mul.4178_Pipeline_COL}
...
set C_modelArgList {
	...
	{ i int 3 regular  }
	{ conv int 64 regular  }
	{ carry_593_out int 64 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "acc", "interface" : "wire", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "zext_ln69_4", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "carry_593_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ zext_ln69_4 sc_in sc_lv 4 signal 1 } 
	...
	{ carry_593_out sc_out sc_lv 64 signal 19 } 
	{ carry_593_out_ap_vld sc_out sc_logic 1 outvld 19 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln69_4", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln69_4", "role": "default" }} , 
 	...
 	{ "name": "carry_593_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "carry_593_out", "role": "default" }} , 
 	{ "name": "carry_593_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "carry_593_out", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_64ns_64ns_128_1_1_U2339", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_31_4_64_1_1_U2340", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	zext_ln69_4 { ap_none {  { zext_ln69_4 in_data 0 4 } } }
	...
	carry_593_out { ap_vld {  { carry_593_out out_data 1 64 }  { carry_593_out_ap_vld out_vld 1 1 } } }
}
