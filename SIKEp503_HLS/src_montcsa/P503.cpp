...
// Standard Montgomery mprime = -p503[0]^{-1} mod 2^64, used by
// mont::MontOps<>::mul (montgomery_auto_rewriter conversion target).
// p503[0] = 0xFFFF...FFFF (-1 mod 2^64) so mprime = 1.
