...
// ==============================================================
`timescale 1ns/1ps
module sikep503_kem_enc_hw_control_s_axi
#(parameter
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_CT_DATA_0)
            int_ct[31:0] <= (WDATA[31:0] & wmask) | (int_ct[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_PK_DATA_0)
            int_pk[31:0] <= (WDATA[31:0] & wmask) | (int_pk[31:0] & ~wmask);
    end
end
