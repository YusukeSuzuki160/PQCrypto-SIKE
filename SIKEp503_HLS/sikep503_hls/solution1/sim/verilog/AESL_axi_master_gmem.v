...
//------------------------Parameter----------------------
`define TV_IN_gmem "../tv/cdatafile/c.sikep503_kem_enc_hw.autotvin_gmem.dat"
`define TV_OUT_gmem "../tv/rtldatafile/rtl.sikep503_kem_enc_hw.autotvout_gmem.dat"
...
parameter gmem_transaction_depth = 32'd 796;
parameter gmem_mem_depth = 32'd 199;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem_mem_depth) begin
                $display ("/home/meltpoint/eeic/PQCrypto-SIKE/SIKEp503_HLS/sikep503_hls/solution1/sim/verilog/AESL_axi_master_gmem.v: Write request address %d exceed AXI master gmem array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem_mem_depth) begin
                $display ("/home/meltpoint/eeic/PQCrypto-SIKE/SIKEp503_HLS/sikep503_hls/solution1/sim/verilog/AESL_axi_master_gmem.v: Read request address %d exceed AXI master gmem array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem_mem_depth); 
                $finish;
            end
...
initial begin : runtime_depth_init_process
    gmem_port0_fresh_depth[0] = 402;
    gmem_port0_blank_depth[0] = 0;
    gmem_port1_fresh_depth[0] = 378;
    gmem_port1_blank_depth[0] = 0;
    gmem_port2_fresh_depth[0] = 16;
