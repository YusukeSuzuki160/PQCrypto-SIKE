...
`define AUTOTB_DUT      sikep503_kem_enc_hw
`define AUTOTB_DUT_INST AESL_inst_sikep503_kem_enc_hw
`define AUTOTB_TOP      apatb_sikep503_kem_enc_hw_top
`define AUTOTB_LAT_RESULT_FILE "sikep503_kem_enc_hw.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "sikep503_kem_enc_hw.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_sikep503_kem_enc_hw_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_gmem 1
`define AESL_DEPTH_ct 1
`define AESL_DEPTH_pk 1
