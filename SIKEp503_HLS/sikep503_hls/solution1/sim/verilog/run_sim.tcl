...
if {[file isfile sikep503_kem_enc_hw.autotvin.dat]} {
	file delete -force sikep503_kem_enc_hw.autotvin.dat
}

if {[file isfile sikep503_kem_enc_hw.autotvout.dat]} {
	file delete -force sikep503_kem_enc_hw.autotvout.dat
}
