...
wire    ap_loop_init;
wire   [63:0] zext_ln29_5_fu_138_p1;
...
wire   [63:0] xor_ln105_98_fu_160_p2;
wire   [63:0] xor_ln105_fu_154_p2;
wire   [63:0] or_ln105_fu_166_p2;
wire   [63:0] xor_ln105_99_fu_172_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        coeff_addr_reg_241[2 : 0] <= zext_ln29_5_fu_138_p1[2 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        tmp_reg_258 <= xor_ln105_99_fu_172_p2[32'd63];
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        ...
        coeff_address0_local = zext_ln29_5_fu_138_p1;
    end else begin
...
assign or_ln105_fu_166_p2 = (xor_ln105_fu_154_p2 | xor_ln105_98_fu_160_p2);
...
assign xor_ln105_98_fu_160_p2 = (tempReg_fu_148_p2 ^ p503x2_1_q0);

assign xor_ln105_99_fu_172_p2 = (or_ln105_fu_166_p2 ^ coeff_q0);
...
assign zext_ln29_4_fu_130_p3 = {{3'd5}, {trunc_ln29_fu_126_p1}};

assign zext_ln29_5_fu_138_p1 = zext_ln29_4_fu_130_p3;
