...
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
  AP_CLANG_PATH := /home2/meltpoint/Xilinx/Vitis/2024.2/vcxx/libexec/
TOOLCHAIN += --gcc-toolchain=/home2/meltpoint/Xilinx/Vitis/2024.2/tps/lnx64/gcc-8.3.0
...
LFLAG += -lpthread
LFLAG += -L /home2/meltpoint/Xilinx/Vitis/2024.2/vcxx/lib/clang/14.0.6/lib/linux -lclang_rt.builtins-x86_64
...
$(ObjDir)/tb_top.cpp_pre.cpp.tb.o : tb_top.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_top.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/random.c_pre.c.tb.o : random.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling random.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/fp_generic.c_pre.c.tb.o : fp_generic.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling fp_generic.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/sikep503_kem_enc_hw.cpp_pre.cpp.tb.o : sikep503_kem_enc_hw.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling sikep503_kem_enc_hw.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/P503.c_pre.c.tb.o : P503.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling P503.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/sike.c_pre.c.tb.o : sike.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling sike.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/sidh.c_pre.c.tb.o : sidh.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling sidh.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/ec_isogeny.c_pre.c.tb.o : ec_isogeny.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling ec_isogeny.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/fpx.c_pre.c.tb.o : fpx.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling fpx.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
