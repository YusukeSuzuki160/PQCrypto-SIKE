// mpx_camba_mul.hpp  (型あいまいさ修正版：三項演算子→if/else 明示キャスト)
// 使い方: mpx::PackedOps<Digit, MAX_NWORDS, true>::mul(a, b, c, nwords)

#ifndef MPX_CAMBA_MUL_HPP
#define MPX_CAMBA_MUL_HPP
...
//===================== 設定（必要に応じて変更） =====================//
static constexpr unsigned MPX_CHUNK_BITS = 256;  // ★内部digit幅：8/16/32/64/128/256 等
//====================================================================//
