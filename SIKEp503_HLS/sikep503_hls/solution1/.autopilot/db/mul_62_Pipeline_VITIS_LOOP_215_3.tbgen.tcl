set moduleName mul_62_Pipeline_VITIS_LOOP_215_3
set isTopModule 0
...
set cdfgNum 684
set C_modelName {mul.62_Pipeline_VITIS_LOOP_215_3}
...
set C_modelArgMapList {[ 
	{ "Name" : "select_ln207", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln207_14", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "a", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "R_Z", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "sum_9_out", "interface" : "wire", "bitwidth" : 133, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ zext_ln207_14 sc_in sc_lv 4 signal 4 } 
	...
	{ sum_9_out sc_out sc_lv 133 signal 7 } 
	{ sum_9_out_ap_vld sc_out sc_logic 1 outvld 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln207_14", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln207_14", "role": "default" }} , 
 	...
 	{ "name": "sum_9_out", "direction": "out", "datatype": "sc_lv", "bitwidth":133, "type": "signal", "bundle":{"name": "sum_9_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_64ns_64ns_128_1_1_U545", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	zext_ln207_14 { ap_none {  { zext_ln207_14 in_data 0 4 } } }
	...
	sum_9_out { ap_vld {  { sum_9_out out_data 1 133 }  { sum_9_out_ap_vld out_vld 1 1 } } }
}
