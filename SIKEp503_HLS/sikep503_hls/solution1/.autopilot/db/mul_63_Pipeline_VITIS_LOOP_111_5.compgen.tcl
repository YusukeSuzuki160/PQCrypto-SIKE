...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_zext_ln108_7 \
    op interface \
    ports { zext_ln108_7 { I 4 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_v_144_out \
    op interface \
    ports { v_144_out { O 64 vector } v_144_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_u_123_out \
    op interface \
    ports { u_123_out_i { I 64 vector } u_123_out_o { O 64 vector } u_123_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { t_43_out { O 3 vector } t_43_out_ap_vld { O 1 bit } } \
} "
}
