set moduleName EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_13_1202
set isTopModule 0
...
set cdfgNum 684
set C_modelName {EphemeralSecretAgreement_A.1_Pipeline_VITIS_LOOP_13_1202}
...
set C_modelArgList {
	...
	{ pts_Z int 64 regular {array 56 { 0 } 0 1 }  }
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_13_1202",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_13_1202 {
...
set Spec2ImplPortList { 
	...
	pts_Z { ap_memory {  { pts_Z_address0 mem_address 1 6 }  { pts_Z_ce0 mem_ce 1 1 }  { pts_Z_we0 mem_we 1 1 }  { pts_Z_d0 mem_din 1 64 } } }
