set moduleName mp_mul_144_Pipeline_VITIS_LOOP_145_2
set isTopModule 0
...
set cdfgNum 712
set C_modelName {mp_mul.144_Pipeline_VITIS_LOOP_145_2}
...
set C_modelArgMapList {[ 
	{ "Name" : "v_017", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln146_21", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln146_21 sc_in sc_lv 4 signal 3 } 
	...
	{ v_114_out sc_out sc_lv 64 signal 7 } 
	{ v_114_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ u_95_out_i sc_in sc_lv 64 signal 8 } 
	{ u_95_out_o sc_out sc_lv 64 signal 8 } 
	{ u_95_out_o_ap_vld sc_out sc_logic 1 outvld 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln146_21", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln146_21", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln146_21 { ap_none {  { zext_ln146_21 in_data 0 4 } } }
