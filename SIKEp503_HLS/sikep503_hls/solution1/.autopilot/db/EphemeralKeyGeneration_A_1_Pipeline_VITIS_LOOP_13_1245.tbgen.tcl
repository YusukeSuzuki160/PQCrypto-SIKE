set moduleName EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_13_1245
set isTopModule 0
...
set cdfgNum 779
set C_modelName {EphemeralKeyGeneration_A.1_Pipeline_VITIS_LOOP_13_1245}
...
set C_modelArgList {
	{ zext_ln14_10 int 7 regular  }
	{ pts_X int 64 regular {array 112 { 0 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln14_10", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln14_10 sc_in sc_lv 7 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln14_10", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln14_10", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_13_1245",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "zext_ln14_10", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_13_1245 {
		zext_ln14_10 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	zext_ln14_10 { ap_none {  { zext_ln14_10 in_data 0 7 } } }
