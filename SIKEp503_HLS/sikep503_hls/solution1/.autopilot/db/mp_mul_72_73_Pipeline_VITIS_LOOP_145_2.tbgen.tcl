set moduleName mp_mul_72_73_Pipeline_VITIS_LOOP_145_2
set isTopModule 0
...
set cdfgNum 712
set C_modelName {mp_mul.72.73_Pipeline_VITIS_LOOP_145_2}
...
set C_modelArgList {
	...
	{ zext_ln146_8 int 4 regular  }
	{ a int 64 regular {array 16 { 1 3 } 1 1 }  }
	{ i int 3 regular  }
	{ zext_ln146_7 int 3 regular  }
	{ b_0 int 64 regular {array 8 { 1 3 } 1 1 }  }
	{ zext_ln146_6 int 3 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "v_017", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln146_8", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "a", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "i", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln146_7", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "b_0", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln146_6", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln146_8 sc_in sc_lv 4 signal 3 } 
	{ a_address0 sc_out sc_lv 4 signal 4 } 
	{ a_ce0 sc_out sc_logic 1 signal 4 } 
	{ a_q0 sc_in sc_lv 64 signal 4 } 
	{ i sc_in sc_lv 3 signal 5 } 
	{ zext_ln146_7 sc_in sc_lv 3 signal 6 } 
	{ b_0_address0 sc_out sc_lv 3 signal 7 } 
	{ b_0_ce0 sc_out sc_logic 1 signal 7 } 
	{ b_0_q0 sc_in sc_lv 64 signal 7 } 
	{ zext_ln146_6 sc_in sc_lv 3 signal 8 } 
	{ b_1_address0 sc_out sc_lv 3 signal 9 } 
	{ b_1_ce0 sc_out sc_logic 1 signal 9 } 
	{ b_1_q0 sc_in sc_lv 64 signal 9 } 
	{ v_87_out sc_out sc_lv 64 signal 10 } 
	{ v_87_out_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ u_68_out_i sc_in sc_lv 64 signal 11 } 
	{ u_68_out_o sc_out sc_lv 64 signal 11 } 
	{ u_68_out_o_ap_vld sc_out sc_logic 1 outvld 11 } 
	{ t_out_i sc_in sc_lv 4 signal 12 } 
	{ t_out_o sc_out sc_lv 4 signal 12 } 
	{ t_out_o_ap_vld sc_out sc_logic 1 outvld 12 } 
	{ grp_fu_515_p_din0 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_515_p_din1 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_515_p_dout0 sc_in sc_lv 64 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln146_8", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln146_8", "role": "default" }} , 
 	...
 	{ "name": "zext_ln146_7", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "zext_ln146_7", "role": "default" }} , 
 	...
 	{ "name": "zext_ln146_6", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "zext_ln146_6", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_515_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "grp_fu_515_p_dout0", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "mp_mul_72_73_Pipeline_VITIS_LOOP_145_2",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "zext_ln146_6", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	mp_mul_72_73_Pipeline_VITIS_LOOP_145_2 {
		...
		zext_ln146_6 {Type I LastRead 0 FirstWrite -1}
