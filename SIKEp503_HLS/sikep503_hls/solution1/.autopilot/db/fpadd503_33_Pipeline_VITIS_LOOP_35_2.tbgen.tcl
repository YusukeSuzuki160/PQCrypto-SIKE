set moduleName fpadd503_33_Pipeline_VITIS_LOOP_35_2
set isTopModule 0
...
set cdfgNum 855
set C_modelName {fpadd503.33_Pipeline_VITIS_LOOP_35_2}
...
set C_modelArgList {
	...
	{ carry_128_out int 1 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "c", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "carry_128_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ carry_128_out sc_out sc_lv 1 signal 1 } 
	{ carry_128_out_ap_vld sc_out sc_logic 1 outvld 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "carry_128_out", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "carry_128_out", "role": "default" }} , 
 	{ "name": "carry_128_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "carry_128_out", "role": "ap_vld" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "fpadd503_33_Pipeline_VITIS_LOOP_35_2",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "carry_128_out", "Type" : "Vld", "Direction" : "O"},
...
set ArgLastReadFirstWriteLatency {
	fpadd503_33_Pipeline_VITIS_LOOP_35_2 {
		c {Type IO LastRead 0 FirstWrite 1}
		carry_128_out {Type O LastRead -1 FirstWrite 0}
...
set Spec2ImplPortList { 
	...
	carry_128_out { ap_vld {  { carry_128_out out_data 1 1 }  { carry_128_out_ap_vld out_vld 1 1 } } }
}
