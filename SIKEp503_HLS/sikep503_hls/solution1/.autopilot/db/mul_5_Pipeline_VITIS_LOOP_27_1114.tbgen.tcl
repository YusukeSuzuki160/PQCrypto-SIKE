set moduleName mul_5_Pipeline_VITIS_LOOP_27_1114
set isTopModule 0
...
set cdfgNum 779
set C_modelName {mul.5_Pipeline_VITIS_LOOP_27_1114}
...
set C_modelArgList {
	...
	{ B_17_out int 512 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "b", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "B_17_out", "interface" : "wire", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ B_17_out sc_out sc_lv 512 signal 1 } 
	{ B_17_out_ap_vld sc_out sc_logic 1 outvld 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "B_17_out", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "B_17_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.partset_512ns_512ns_64ns_32ns_512_1_1_U1966", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	B_17_out { ap_vld {  { B_17_out out_data 1 512 }  { B_17_out_ap_vld out_vld 1 1 } } }
}
