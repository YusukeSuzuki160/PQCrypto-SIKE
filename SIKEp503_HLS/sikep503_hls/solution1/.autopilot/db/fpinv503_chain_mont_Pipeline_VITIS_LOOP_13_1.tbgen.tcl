set moduleName fpinv503_chain_mont_Pipeline_VITIS_LOOP_13_1
set isTopModule 0
...
set cdfgNum 855
set C_modelName {fpinv503_chain_mont_Pipeline_VITIS_LOOP_13_1}
...
dict set ap_memory_interface_dict tt { MEM_WIDTH 64 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ a int 64 regular {array 8 { 1 3 } 1 1 }  }
	{ tt int 64 regular {array 8 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "a", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "tt", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ tt_we0 sc_out sc_logic 1 signal 1 } 
	{ tt_d0 sc_out sc_lv 64 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	tt { ap_memory {  { tt_address0 mem_address 1 3 }  { tt_ce0 mem_ce 1 1 }  { tt_we0 mem_we 1 1 }  { tt_d0 mem_din 1 64 } } }
}
