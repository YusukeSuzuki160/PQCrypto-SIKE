...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename s \
    op interface \
    ports { s_address0 { O 5 vector } s_ce0 { O 1 bit } s_q0 { I 64 vector } s_address1 { O 5 vector } s_ce1 { O 1 bit } s_we1 { O 8 vector } s_d1 { O 64 vector } } \
} "
} else {
