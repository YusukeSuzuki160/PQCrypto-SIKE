set moduleName fp2sqr503_mont_1_Pipeline_VITIS_LOOP_57_1
set isTopModule 0
...
set cdfgNum 855
set C_modelName {fp2sqr503_mont.1_Pipeline_VITIS_LOOP_57_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "c_offset", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln373_11", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln373_11 sc_in sc_lv 7 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln373_11", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln373_11", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln373_11 { ap_none {  { zext_ln373_11 in_data 0 7 } } }
