...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sikep503_kem_enc_hw_EphemeralKeyGeneration_A_Pipeline_VITIS_LOOP_14_1230_Montgomery_one_1_ROM_AUTcud BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
