set moduleName fp2mul503_mont_119_Pipeline_VITIS_LOOP_160_1152
set isTopModule 0
...
set cdfgNum 684
set C_modelName {fp2mul503_mont.119_Pipeline_VITIS_LOOP_160_1152}
...
set C_modelArgList {
	{ tt2 int 64 regular {array 16 { 2 } 1 1 }  }
...
set portList { 
	...
	{ tt2_q0 sc_in sc_lv 64 signal 0 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "fp2mul503_mont_119_Pipeline_VITIS_LOOP_160_1152",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	fp2mul503_mont_119_Pipeline_VITIS_LOOP_160_1152 {
...
set Spec2ImplPortList { 
	tt2 { ap_memory {  { tt2_address0 mem_address 1 4 }  { tt2_ce0 mem_ce 1 1 }  { tt2_we0 mem_we 1 1 }  { tt2_d0 mem_din 1 64 }  { tt2_q0 mem_dout 0 64 } } }
