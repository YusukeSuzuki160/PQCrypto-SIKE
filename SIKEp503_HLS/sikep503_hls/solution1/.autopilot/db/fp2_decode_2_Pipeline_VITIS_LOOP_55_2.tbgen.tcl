set moduleName fp2_decode_2_Pipeline_VITIS_LOOP_55_2
set isTopModule 0
...
set cdfgNum 712
set C_modelName {fp2_decode.2_Pipeline_VITIS_LOOP_55_2}
...
set C_modelArgMapList {[ 
	{ "Name" : "enc", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "idx_cast", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "idx_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "idx_cast", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	idx_cast { ap_none {  { idx_cast in_data 0 8 } } }
