...
#define CONTROL_BITS_CT_DATA 32
#define CONTROL_ADDR_PK_DATA 0x18
#define CONTROL_BITS_PK_DATA 32
#define CONTROL_ADDR_SS_DATA 0x20
#define CONTROL_BITS_SS_DATA 32
