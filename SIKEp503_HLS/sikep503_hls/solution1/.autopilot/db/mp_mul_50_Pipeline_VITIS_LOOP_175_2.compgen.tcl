...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_v_128_out \
    op interface \
    ports { v_128_out { O 64 vector } v_128_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_u_122_out \
    op interface \
    ports { u_122_out_i { I 64 vector } u_122_out_o { O 64 vector } u_122_out_o_ap_vld { O 1 bit } } \
} "
}
