set moduleName fp2_decode_32_Pipeline_VITIS_LOOP_219_1322
set isTopModule 0
...
set cdfgNum 855
set C_modelName {fp2_decode.32_Pipeline_VITIS_LOOP_219_1322}
...
set C_modelArgList {
	...
	{ A_99_out int 512 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "A_99_out", "interface" : "wire", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ A_99_out sc_out sc_lv 512 signal 2 } 
	{ A_99_out_ap_vld sc_out sc_logic 1 outvld 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "A_99_out", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "A_99_out", "role": "default" }} , 
 	{ "name": "A_99_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "A_99_out", "role": "ap_vld" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "fp2_decode_32_Pipeline_VITIS_LOOP_219_1322",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "A_99_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
...
set ArgLastReadFirstWriteLatency {
	fp2_decode_32_Pipeline_VITIS_LOOP_219_1322 {
		empty {Type I LastRead 0 FirstWrite -1}
		PKB {Type I LastRead 0 FirstWrite -1}
		A_99_out {Type O LastRead -1 FirstWrite 0}}}
...
set Spec2ImplPortList { 
	...
	A_99_out { ap_vld {  { A_99_out out_data 1 512 }  { A_99_out_ap_vld out_vld 1 1 } } }
}
