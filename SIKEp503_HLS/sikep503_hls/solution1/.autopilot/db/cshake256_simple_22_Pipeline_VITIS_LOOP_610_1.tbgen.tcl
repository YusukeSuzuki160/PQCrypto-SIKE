set moduleName cshake256_simple_22_Pipeline_VITIS_LOOP_610_1
set isTopModule 0
...
set cdfgNum 779
set C_modelName {cshake256_simple.22_Pipeline_VITIS_LOOP_610_1}
...
set C_modelArgList {
	{ s int 64 regular {array 25 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "s", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "cshake256_simple_22_Pipeline_VITIS_LOOP_610_1",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	cshake256_simple_22_Pipeline_VITIS_LOOP_610_1 {
...
set Spec2ImplPortList { 
	s { ap_memory {  { s_address0 mem_address 1 5 }  { s_ce0 mem_ce 1 1 }  { s_we0 mem_we 1 8 }  { s_d0 mem_din 1 64 } } }
}
