set moduleName rdc_mont_140_Pipeline_VITIS_LOOP_208_5
set isTopModule 0
...
set cdfgNum 712
set C_modelName {rdc_mont.140_Pipeline_VITIS_LOOP_208_5}
...
set C_modelArgMapList {[ 
	{ "Name" : "indvars_iv", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln183", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ grp_fu_906_p_dout0 sc_in sc_lv 64 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln183", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln183", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_906_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "grp_fu_906_p_dout0", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln183 { ap_none {  { zext_ln183 in_data 0 4 } } }
