set moduleName fpinv503_chain_mont_Pipeline_VITIS_LOOP_14_1127
set isTopModule 0
...
set cdfgNum 712
set C_modelName {fpinv503_chain_mont_Pipeline_VITIS_LOOP_14_1127}
...
dict set ap_memory_interface_dict a { MEM_WIDTH 64 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ tt int 64 regular {array 8 { 1 3 } 1 1 }  }
	{ a int 64 regular {array 8 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set Spec2ImplPortList { 
	...
	a { ap_memory {  { a_address0 mem_address 1 3 }  { a_ce0 mem_ce 1 1 }  { a_we0 mem_we 1 1 }  { a_d0 mem_din 1 64 } } }
}
