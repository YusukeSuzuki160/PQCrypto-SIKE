set moduleName fpsub503_2_258_Pipeline_VITIS_LOOP_64_2
set isTopModule 0
...
set cdfgNum 855
set C_modelName {fpsub503.2.258_Pipeline_VITIS_LOOP_64_2}
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln59_15", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln59_15 sc_in sc_lv 4 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln59_15", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln59_15", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "fpsub503_2_258_Pipeline_VITIS_LOOP_64_2",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "zext_ln59_15", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	fpsub503_2_258_Pipeline_VITIS_LOOP_64_2 {
		zext_ln59_15 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	zext_ln59_15 { ap_none {  { zext_ln59_15 in_data 0 4 } } }
