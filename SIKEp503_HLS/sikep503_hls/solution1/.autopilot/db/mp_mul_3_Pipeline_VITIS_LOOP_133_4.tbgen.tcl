set moduleName mp_mul_3_Pipeline_VITIS_LOOP_133_4
set isTopModule 0
...
set cdfgNum 684
set C_modelName {mp_mul.3_Pipeline_VITIS_LOOP_133_4}
...
set C_modelArgMapList {[ 
	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln133", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln133 sc_in sc_lv 4 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln133", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln133", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln133 { ap_none {  { zext_ln133 in_data 0 4 } } }
