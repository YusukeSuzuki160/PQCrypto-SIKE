set moduleName EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_14_1237
set isTopModule 0
...
set cdfgNum 712
set C_modelName {EphemeralSecretAgreement_A.1_Pipeline_VITIS_LOOP_14_1237}
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln15", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln15 sc_in sc_lv 7 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln15", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln15", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_14_1237",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_14_1237 {
...
set Spec2ImplPortList { 
	zext_ln15 { ap_none {  { zext_ln15 in_data 0 7 } } }
