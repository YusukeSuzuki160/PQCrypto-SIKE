set moduleName mp_mul_140_Pipeline_VITIS_LOOP_145_2
set isTopModule 0
...
set cdfgNum 712
set C_modelName {mp_mul.140_Pipeline_VITIS_LOOP_145_2}
...
set C_modelArgList {
	...
	{ u_95_out int 4 regular {pointer 2}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln143", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "u_95_out", "interface" : "wire", "bitwidth" : 4, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ zext_ln143 sc_in sc_lv 4 signal 0 } 
	{ indvars_iv31 sc_in sc_lv 4 signal 1 } 
	...
	{ v_114_out sc_out sc_lv 64 signal 4 } 
	{ v_114_out_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ u_95_out_i sc_in sc_lv 4 signal 5 } 
	{ u_95_out_o sc_out sc_lv 4 signal 5 } 
	{ u_95_out_o_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ grp_fu_388_p_din0 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_388_p_din1 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_388_p_dout0 sc_in sc_lv 32 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "u_95_out_i", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "u_95_out", "role": "i" }} , 
 	{ "name": "u_95_out_o", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "u_95_out", "role": "o" }} , 
 	...
 	{ "name": "grp_fu_388_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "grp_fu_388_p_dout0", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "mp_mul_140_Pipeline_VITIS_LOOP_145_2",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	mp_mul_140_Pipeline_VITIS_LOOP_145_2 {
...
set Spec2ImplPortList { 
	...
	u_95_out { ap_ovld {  { u_95_out_i in_data 0 4 }  { u_95_out_o out_data 1 4 }  { u_95_out_o_ap_vld out_vld 1 1 } } }
}
