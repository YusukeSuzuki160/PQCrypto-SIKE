set moduleName mul_68_Pipeline_VITIS_LOOP_27_199
set isTopModule 0
...
set cdfgNum 779
set C_modelName {mul.68_Pipeline_VITIS_LOOP_27_199}
...
set C_modelArgList {
	...
	{ B_2_out int 512 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "b", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "B_2_out", "interface" : "wire", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "B_2_out", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "B_2_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.partset_512ns_512ns_64ns_32ns_512_1_1_U1189", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	B_2_out { ap_vld {  { B_2_out out_data 1 512 }  { B_2_out_ap_vld out_vld 1 1 } } }
}
