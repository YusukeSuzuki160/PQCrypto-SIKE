...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename temp \
    op interface \
    ports { temp_address0 { O 7 vector } temp_ce0 { O 1 bit } temp_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename temp_1 \
    op interface \
    ports { temp_1_address0 { O 7 vector } temp_1_ce0 { O 1 bit } temp_1_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename temp_2 \
    op interface \
    ports { temp_2_address0 { O 7 vector } temp_2_ce0 { O 1 bit } temp_2_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename temp_3 \
    op interface \
    ports { temp_3_address0 { O 7 vector } temp_3_ce0 { O 1 bit } temp_3_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename h \
    op interface \
    ports { h_address0 { O 5 vector } h_ce0 { O 1 bit } h_q0 { I 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln98 \
    op interface \
    ports { add_ln98 { I 64 vector } } \
} "
}
