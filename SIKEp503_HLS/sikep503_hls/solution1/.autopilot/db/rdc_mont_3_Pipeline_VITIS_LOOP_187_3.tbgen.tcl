set moduleName rdc_mont_3_Pipeline_VITIS_LOOP_187_3
set isTopModule 0
...
set cdfgNum 712
set C_modelName {rdc_mont.3_Pipeline_VITIS_LOOP_187_3}
...
set C_modelArgList {
	...
	{ empty int 3 regular  }
	{ v_29_out int 64 regular {pointer 1}  }
	{ u_26_out int 64 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "v", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "v_29_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "u_26_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ v_29_out sc_out sc_lv 64 signal 6 } 
	{ v_29_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ u_26_out sc_out sc_lv 64 signal 7 } 
	{ u_26_out_ap_vld sc_out sc_logic 1 outvld 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v_29_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v_29_out", "role": "default" }} , 
 	{ "name": "v_29_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "v_29_out", "role": "ap_vld" }} , 
 	{ "name": "u_26_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "u_26_out", "role": "default" }} , 
 	{ "name": "u_26_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "u_26_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6"],
		"CDFG" : "rdc_mont_3_Pipeline_VITIS_LOOP_187_3",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U1276", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U1277", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U1278", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U1279", "Parent" : "0"},
...
set ArgLastReadFirstWriteLatency {
	rdc_mont_3_Pipeline_VITIS_LOOP_187_3 {
		...
		v_29_out {Type O LastRead -1 FirstWrite 6}
		u_26_out {Type O LastRead -1 FirstWrite 6}
...
set Spec2ImplPortList { 
	...
	v_29_out { ap_vld {  { v_29_out out_data 1 64 }  { v_29_out_ap_vld out_vld 1 1 } } }
	u_26_out { ap_vld {  { u_26_out out_data 1 64 }  { u_26_out_ap_vld out_vld 1 1 } } }
