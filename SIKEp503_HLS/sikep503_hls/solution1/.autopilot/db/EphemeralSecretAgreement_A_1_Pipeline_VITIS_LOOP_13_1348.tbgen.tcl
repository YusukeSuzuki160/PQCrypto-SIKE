set moduleName EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_13_1348
set isTopModule 0
...
set cdfgNum 855
set C_modelName {EphemeralSecretAgreement_A.1_Pipeline_VITIS_LOOP_13_1348}
...
set C_modelArgList {
	{ zext_ln14_7 int 7 regular  }
	{ pts_X int 64 regular {array 112 { 1 3 } 1 1 }  }
	{ R_X int 64 regular {array 16 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln14_7", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln14_7 sc_in sc_lv 7 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln14_7", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln14_7", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_13_1348",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "zext_ln14_7", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_13_1348 {
		zext_ln14_7 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	zext_ln14_7 { ap_none {  { zext_ln14_7 in_data 0 7 } } }
	pts_X { ap_memory {  { pts_X_address0 mem_address 1 7 }  { pts_X_ce0 mem_ce 1 1 }  { pts_X_q0 mem_dout 0 64 } } }
