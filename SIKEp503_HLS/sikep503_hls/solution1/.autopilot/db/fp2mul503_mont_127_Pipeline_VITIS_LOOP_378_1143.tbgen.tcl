set moduleName fp2mul503_mont_127_Pipeline_VITIS_LOOP_378_1143
set isTopModule 0
...
set cdfgNum 684
set C_modelName {fp2mul503_mont.127_Pipeline_VITIS_LOOP_378_1143}
...
set C_modelArgList {
	{ tt1 int 64 regular {array 16 { 2 } 1 1 }  }
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "fp2mul503_mont_127_Pipeline_VITIS_LOOP_378_1143",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	fp2mul503_mont_127_Pipeline_VITIS_LOOP_378_1143 {
...
set Spec2ImplPortList { 
	tt1 { ap_memory {  { tt1_address0 mem_address 1 4 }  { tt1_ce0 mem_ce 1 1 }  { tt1_we0 mem_we 1 1 }  { tt1_d0 mem_din 1 64 }  { tt1_q0 mem_dout 0 64 } } }
