set moduleName crypto_kem_enc_1_Pipeline_VITIS_LOOP_56_1
set isTopModule 0
...
set cdfgNum 712
set C_modelName {crypto_kem_enc.1_Pipeline_VITIS_LOOP_56_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict temp { MEM_WIDTH 8 MEM_SIZE 107 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict temp_1 { MEM_WIDTH 8 MEM_SIZE 107 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict temp_2 { MEM_WIDTH 8 MEM_SIZE 107 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict temp_3 { MEM_WIDTH 8 MEM_SIZE 107 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict h { MEM_WIDTH 8 MEM_SIZE 24 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem0 int 8 regular {axi_master 1}  }
	{ ct int 32 regular  }
	{ add_ln56 int 32 regular  }
	{ temp int 8 regular {array 107 { 1 3 } 1 1 }  }
	{ temp_1 int 8 regular {array 107 { 1 3 } 1 1 }  }
	{ temp_2 int 8 regular {array 107 { 1 3 } 1 1 }  }
	{ temp_3 int 8 regular {array 107 { 1 3 } 1 1 }  }
	{ h int 8 regular {array 24 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "ct","offset": { "type": "dynamic","port_name": "ct","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "ct", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "add_ln56", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ m_axi_gmem0_0_AWADDR sc_out sc_lv 32 signal 0 } 
	...
	{ m_axi_gmem0_0_ARADDR sc_out sc_lv 32 signal 0 } 
	...
	{ ct sc_in sc_lv 32 signal 1 } 
	{ add_ln56 sc_in sc_lv 32 signal 2 } 
	{ temp_address0 sc_out sc_lv 7 signal 3 } 
	{ temp_ce0 sc_out sc_logic 1 signal 3 } 
	{ temp_q0 sc_in sc_lv 8 signal 3 } 
	{ temp_1_address0 sc_out sc_lv 7 signal 4 } 
	{ temp_1_ce0 sc_out sc_logic 1 signal 4 } 
	{ temp_1_q0 sc_in sc_lv 8 signal 4 } 
	{ temp_2_address0 sc_out sc_lv 7 signal 5 } 
	{ temp_2_ce0 sc_out sc_logic 1 signal 5 } 
	{ temp_2_q0 sc_in sc_lv 8 signal 5 } 
	{ temp_3_address0 sc_out sc_lv 7 signal 6 } 
	{ temp_3_ce0 sc_out sc_logic 1 signal 6 } 
	{ temp_3_q0 sc_in sc_lv 8 signal 6 } 
	{ h_address0 sc_out sc_lv 5 signal 7 } 
	{ h_ce0 sc_out sc_logic 1 signal 7 } 
	{ h_q0 sc_in sc_lv 8 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln56", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "add_ln56", "role": "default" }} , 
 	{ "name": "temp_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "temp", "role": "address0" }} , 
 	...
 	{ "name": "temp_1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "temp_1", "role": "address0" }} , 
 	...
 	{ "name": "temp_2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "temp_2", "role": "address0" }} , 
 	...
 	{ "name": "temp_3_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "temp_3", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "crypto_kem_enc_1_Pipeline_VITIS_LOOP_56_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "add_ln56", "Type" : "None", "Direction" : "I"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_2_8_1_1_U3328", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	crypto_kem_enc_1_Pipeline_VITIS_LOOP_56_1 {
		gmem0 {Type O LastRead -1 FirstWrite 2}
		ct {Type I LastRead 0 FirstWrite -1}
		add_ln56 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	 { m_axi {  { m_axi_gmem0_0_AWVALID VALID 1 1 }  { m_axi_gmem0_0_AWREADY READY 0 1 }  { m_axi_gmem0_0_AWADDR ADDR 1 32 }  { m_axi_gmem0_0_AWID ID 1 1 }  { m_axi_gmem0_0_AWLEN SIZE 1 32 }  { m_axi_gmem0_0_AWSIZE BURST 1 3 }  { m_axi_gmem0_0_AWBURST LOCK 1 2 }  { m_axi_gmem0_0_AWLOCK CACHE 1 2 }  { m_axi_gmem0_0_AWCACHE PROT 1 4 }  { m_axi_gmem0_0_AWPROT QOS 1 3 }  { m_axi_gmem0_0_AWQOS REGION 1 4 }  { m_axi_gmem0_0_AWREGION USER 1 4 }  { m_axi_gmem0_0_AWUSER DATA 1 1 }  { m_axi_gmem0_0_WVALID VALID 1 1 }  { m_axi_gmem0_0_WREADY READY 0 1 }  { m_axi_gmem0_0_WDATA FIFONUM 1 8 }  { m_axi_gmem0_0_WSTRB STRB 1 1 }  { m_axi_gmem0_0_WLAST LAST 1 1 }  { m_axi_gmem0_0_WID ID 1 1 }  { m_axi_gmem0_0_WUSER DATA 1 1 }  { m_axi_gmem0_0_ARVALID VALID 1 1 }  { m_axi_gmem0_0_ARREADY READY 0 1 }  { m_axi_gmem0_0_ARADDR ADDR 1 32 }  { m_axi_gmem0_0_ARID ID 1 1 }  { m_axi_gmem0_0_ARLEN SIZE 1 32 }  { m_axi_gmem0_0_ARSIZE BURST 1 3 }  { m_axi_gmem0_0_ARBURST LOCK 1 2 }  { m_axi_gmem0_0_ARLOCK CACHE 1 2 }  { m_axi_gmem0_0_ARCACHE PROT 1 4 }  { m_axi_gmem0_0_ARPROT QOS 1 3 }  { m_axi_gmem0_0_ARQOS REGION 1 4 }  { m_axi_gmem0_0_ARREGION USER 1 4 }  { m_axi_gmem0_0_ARUSER DATA 1 1 }  { m_axi_gmem0_0_RVALID VALID 0 1 }  { m_axi_gmem0_0_RREADY READY 1 1 }  { m_axi_gmem0_0_RDATA FIFONUM 0 8 }  { m_axi_gmem0_0_RLAST LAST 0 1 }  { m_axi_gmem0_0_RID ID 0 1 }  { m_axi_gmem0_0_RFIFONUM LEN 0 11 }  { m_axi_gmem0_0_RUSER DATA 0 1 }  { m_axi_gmem0_0_RRESP RESP 0 2 }  { m_axi_gmem0_0_BVALID VALID 0 1 }  { m_axi_gmem0_0_BREADY READY 1 1 }  { m_axi_gmem0_0_BRESP RESP 0 2 }  { m_axi_gmem0_0_BID ID 0 1 }  { m_axi_gmem0_0_BUSER DATA 0 1 } } }
	ct { ap_none {  { ct in_data 0 32 } } }
	add_ln56 { ap_none {  { add_ln56 in_data 0 32 } } }
	temp { ap_memory {  { temp_address0 mem_address 1 7 }  { temp_ce0 mem_ce 1 1 }  { temp_q0 mem_dout 0 8 } } }
	temp_1 { ap_memory {  { temp_1_address0 mem_address 1 7 }  { temp_1_ce0 mem_ce 1 1 }  { temp_1_q0 mem_dout 0 8 } } }
	temp_2 { ap_memory {  { temp_2_address0 mem_address 1 7 }  { temp_2_ce0 mem_ce 1 1 }  { temp_2_q0 mem_dout 0 8 } } }
	temp_3 { ap_memory {  { temp_3_address0 mem_address 1 7 }  { temp_3_ce0 mem_ce 1 1 }  { temp_3_q0 mem_dout 0 8 } } }
