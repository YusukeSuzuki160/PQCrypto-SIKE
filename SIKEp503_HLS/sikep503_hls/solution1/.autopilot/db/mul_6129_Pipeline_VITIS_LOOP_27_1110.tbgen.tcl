set moduleName mul_6129_Pipeline_VITIS_LOOP_27_1110
set isTopModule 0
...
set cdfgNum 779
set C_modelName {mul.6129_Pipeline_VITIS_LOOP_27_1110}
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln31", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln31 sc_in sc_lv 7 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln31", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln31", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.partset_512ns_512ns_64ns_32ns_512_1_1_U1437", "Parent" : "0"},
...
set Spec2ImplPortList { 
	zext_ln31 { ap_none {  { zext_ln31 in_data 0 7 } } }
