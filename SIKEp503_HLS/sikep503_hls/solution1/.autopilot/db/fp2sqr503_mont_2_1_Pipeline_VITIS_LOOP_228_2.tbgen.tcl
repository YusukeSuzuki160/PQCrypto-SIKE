set moduleName fp2sqr503_mont_2_1_Pipeline_VITIS_LOOP_228_2
set isTopModule 0
...
set cdfgNum 855
set C_modelName {fp2sqr503_mont.2.1_Pipeline_VITIS_LOOP_228_2}
...
set portList { 
	...
	{ temp_12_address0 sc_out sc_lv 4 signal 1 } 
	{ temp_12_ce0 sc_out sc_logic 1 signal 1 } 
	{ temp_12_we0 sc_out sc_logic 1 signal 1 } 
	{ temp_12_d0 sc_out sc_lv 64 signal 1 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "fp2sqr503_mont_2_1_Pipeline_VITIS_LOOP_228_2",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.partselect_64ns_1024ns_32ns_64_1_1_U2605", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	fp2sqr503_mont_2_1_Pipeline_VITIS_LOOP_228_2 {
