set moduleName rdc_mont_47_Pipeline_VITIS_LOOP_291_1
set isTopModule 0
...
set cdfgNum 855
set C_modelName {rdc_mont.47_Pipeline_VITIS_LOOP_291_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict PKB { MEM_WIDTH 64 MEM_SIZE 384 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ PKB int 64 regular {array 48 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "PKB", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ PKB_we0 sc_out sc_lv 8 signal 0 } 
	{ PKB_d0 sc_out sc_lv 64 signal 0 } 
	{ p_cast sc_in sc_lv 6 signal 1 } 
...
set Spec2ImplPortList { 
	PKB { ap_memory {  { PKB_address0 mem_address 1 6 }  { PKB_ce0 mem_ce 1 1 }  { PKB_we0 mem_we 1 8 }  { PKB_d0 mem_din 1 64 } } }
