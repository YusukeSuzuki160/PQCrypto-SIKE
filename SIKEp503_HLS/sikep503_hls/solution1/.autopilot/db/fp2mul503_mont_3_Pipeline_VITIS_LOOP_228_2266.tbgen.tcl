set moduleName fp2mul503_mont_3_Pipeline_VITIS_LOOP_228_2266
set isTopModule 0
...
set cdfgNum 855
set C_modelName {fp2mul503_mont.3_Pipeline_VITIS_LOOP_228_2266}
...
set C_modelArgMapList {[ 
	{ "Name" : "P_51", "interface" : "wire", "bitwidth" : 1024, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ P_51 sc_in sc_lv 1024 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "P_51", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "P_51", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.partselect_64ns_1024ns_32ns_64_1_1_U413", "Parent" : "0"},
...
set Spec2ImplPortList { 
	P_51 { ap_none {  { P_51 in_data 0 1024 } } }
