set moduleName rdc_mont_142_Pipeline_VITIS_LOOP_208_5
set isTopModule 0
...
set cdfgNum 712
set C_modelName {rdc_mont.142_Pipeline_VITIS_LOOP_208_5}
...
set C_modelArgList {
	...
	{ empty int 3 regular  }
	{ v_53_out int 64 regular {pointer 1}  }
	{ u_46_out int 64 regular {pointer 1}  }
	{ t_29_out int 64 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "indvars_iv", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "v_53_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "u_46_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "t_29_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ v_53_out sc_out sc_lv 64 signal 6 } 
	{ v_53_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ u_46_out sc_out sc_lv 64 signal 7 } 
	{ u_46_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ t_29_out sc_out sc_lv 64 signal 8 } 
	{ t_29_out_ap_vld sc_out sc_logic 1 outvld 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v_53_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v_53_out", "role": "default" }} , 
 	{ "name": "v_53_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "v_53_out", "role": "ap_vld" }} , 
 	...
 	{ "name": "t_29_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "t_29_out", "role": "default" }} , 
 	{ "name": "t_29_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "t_29_out", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U2001", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U2002", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U2003", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U2004", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	v_53_out { ap_vld {  { v_53_out out_data 1 64 }  { v_53_out_ap_vld out_vld 1 1 } } }
	u_46_out { ap_vld {  { u_46_out out_data 1 64 }  { u_46_out_ap_vld out_vld 1 1 } } }
	t_29_out { ap_vld {  { t_29_out out_data 1 64 }  { t_29_out_ap_vld out_vld 1 1 } } }
}
