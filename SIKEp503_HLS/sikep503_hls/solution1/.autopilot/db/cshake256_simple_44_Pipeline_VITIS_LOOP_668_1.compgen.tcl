...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename t_97 \
    op interface \
    ports { t_97_address0 { O 6 vector } t_97_ce0 { O 1 bit } t_97_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 't_97'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename t_98 \
    op interface \
    ports { t_98_address0 { O 6 vector } t_98_ce0 { O 1 bit } t_98_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename t_99 \
    op interface \
    ports { t_99_address0 { O 6 vector } t_99_ce0 { O 1 bit } t_99_q0 { I 8 vector } } \
} "
} else {
