set moduleName mp_mul_7_Pipeline_VITIS_LOOP_157_4
set isTopModule 0
...
set cdfgNum 712
set C_modelName {mp_mul.7_Pipeline_VITIS_LOOP_157_4}
...
set C_modelArgMapList {[ 
	{ "Name" : "indvars_iv", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln145_7", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ i_16 sc_in sc_lv 4 signal 5 } 
	{ zext_ln145_7 sc_in sc_lv 4 signal 6 } 
	...
	{ grp_fu_472_p_dout0 sc_in sc_lv 64 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln145_7", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln145_7", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_472_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "grp_fu_472_p_dout0", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln145_7 { ap_none {  { zext_ln145_7 in_data 0 4 } } }
