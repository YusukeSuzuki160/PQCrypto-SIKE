set moduleName mul_63_Pipeline_VITIS_LOOP_215_3
set isTopModule 0
...
set cdfgNum 684
set C_modelName {mul.63_Pipeline_VITIS_LOOP_215_3}
...
set C_modelArgMapList {[ 
	{ "Name" : "select_ln207", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln207_10", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln207_10 sc_in sc_lv 4 signal 4 } 
	{ R_Z_address0 sc_out sc_lv 4 signal 5 } 
	{ R_Z_ce0 sc_out sc_logic 1 signal 5 } 
	{ R_Z_q0 sc_in sc_lv 64 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln207_10", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln207_10", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_64ns_64ns_128_1_1_U813", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	zext_ln207_10 { ap_none {  { zext_ln207_10 in_data 0 4 } } }
