set moduleName EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_14_1238
set isTopModule 0
...
set cdfgNum 712
set C_modelName {EphemeralSecretAgreement_A.1_Pipeline_VITIS_LOOP_14_1238}
...
set C_modelArgMapList {[ 
	{ "Name" : "npts_4", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "npts_4", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "npts_4", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_14_1238",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_14_1238 {
...
set Spec2ImplPortList { 
	npts_4 { ap_none {  { npts_4 in_data 0 3 } } }
