set moduleName fp2mul503_mont_38_1_Pipeline_VITIS_LOOP_219_1174
set isTopModule 0
...
set cdfgNum 855
set C_modelName {fp2mul503_mont.38.1_Pipeline_VITIS_LOOP_219_1174}
...
set C_modelArgList {
	{ c int 64 regular {array 16 { 1 3 } 1 1 }  }
	{ coeff int 64 regular {array 48 { 1 3 } 1 1 }  }
	{ B_50_out int 512 regular {pointer 1}  }
	{ A_52_out int 512 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "c", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "B_50_out", "interface" : "wire", "bitwidth" : 512, "direction" : "WRITEONLY"} , 
 	{ "Name" : "A_52_out", "interface" : "wire", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ B_50_out sc_out sc_lv 512 signal 2 } 
	{ B_50_out_ap_vld sc_out sc_logic 1 outvld 2 } 
	{ A_52_out sc_out sc_lv 512 signal 3 } 
	{ A_52_out_ap_vld sc_out sc_logic 1 outvld 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "B_50_out", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "B_50_out", "role": "default" }} , 
 	{ "name": "B_50_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "B_50_out", "role": "ap_vld" }} , 
 	{ "name": "A_52_out", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "A_52_out", "role": "default" }} , 
 	{ "name": "A_52_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "A_52_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	c { ap_memory {  { c_address0 mem_address 1 4 }  { c_ce0 mem_ce 1 1 }  { c_q0 mem_dout 0 64 } } }
	coeff { ap_memory {  { coeff_address0 mem_address 1 6 }  { coeff_ce0 mem_ce 1 1 }  { coeff_q0 mem_dout 0 64 } } }
	B_50_out { ap_vld {  { B_50_out out_data 1 512 }  { B_50_out_ap_vld out_vld 1 1 } } }
	A_52_out { ap_vld {  { A_52_out out_data 1 512 }  { A_52_out_ap_vld out_vld 1 1 } } }
}
