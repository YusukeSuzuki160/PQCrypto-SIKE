set moduleName fpcorrection503_Pipeline_VITIS_LOOP_91_1
set isTopModule 0
...
set cdfgNum 712
set C_modelName {fpcorrection503_Pipeline_VITIS_LOOP_91_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict a { MEM_WIDTH 64 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ zext_ln92_3 int 4 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln92_3", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln92_3 sc_in sc_lv 4 signal 0 } 
	...
	{ borrow_out sc_out sc_lv 1 signal 2 } 
	{ borrow_out_ap_vld sc_out sc_logic 1 outvld 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln92_3", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln92_3", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln92_3 { ap_none {  { zext_ln92_3 in_data 0 4 } } }
