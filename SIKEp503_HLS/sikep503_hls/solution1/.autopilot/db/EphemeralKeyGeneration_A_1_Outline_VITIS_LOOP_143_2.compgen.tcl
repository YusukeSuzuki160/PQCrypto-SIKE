...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sikep503_kem_enc_hw_EphemeralKeyGeneration_A_1_Outline_VITIS_LOOP_143_2_strat_Alice_1_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename pts_index \
    op interface \
    ports { pts_index_address0 { O 3 vector } pts_index_ce0 { O 1 bit } pts_index_we0 { O 1 bit } pts_index_d0 { O 7 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'pts_index'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_ii_4_out \
    op interface \
    ports { ii_4_out_i { I 32 vector } ii_4_out_o { O 32 vector } ii_4_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_npts_5_out \
    op interface \
    ports { npts_5_out { O 32 vector } npts_5_out_ap_vld { O 1 bit } } \
} "
}
