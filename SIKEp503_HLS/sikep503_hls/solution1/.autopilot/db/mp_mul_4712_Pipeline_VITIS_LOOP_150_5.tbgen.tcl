set moduleName mp_mul_4712_Pipeline_VITIS_LOOP_150_5
set isTopModule 0
...
set cdfgNum 684
set C_modelName {mp_mul.4712_Pipeline_VITIS_LOOP_150_5}
...
set C_modelArgMapList {[ 
	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "add_ln150", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ add_ln150 sc_in sc_lv 5 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln150", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "add_ln150", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	add_ln150 { ap_none {  { add_ln150 in_data 0 5 } } }
