set moduleName rdc_mont_139_Pipeline_VITIS_LOOP_206_5
set isTopModule 0
...
set cdfgNum 712
set C_modelName {rdc_mont.139_Pipeline_VITIS_LOOP_206_5}
...
set C_modelArgList {
	...
	{ zext_ln181 int 7 regular  }
	{ mc int 64 regular {array 120 { 1 3 } 1 1 }  }
	{ empty int 3 regular  }
	{ v_81_out int 64 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "indvars_iv", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln181", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
 	{ "Name" : "mc", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "v_81_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ zext_ln181 sc_in sc_lv 7 signal 4 } 
	{ mc_address0 sc_out sc_lv 7 signal 5 } 
	{ mc_ce0 sc_out sc_logic 1 signal 5 } 
	{ mc_q0 sc_in sc_lv 64 signal 5 } 
	{ empty sc_in sc_lv 3 signal 6 } 
	{ v_81_out sc_out sc_lv 64 signal 7 } 
	{ v_81_out_ap_vld sc_out sc_logic 1 outvld 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln181", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln181", "role": "default" }} , 
 	...
 	{ "name": "v_81_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v_81_out", "role": "default" }} , 
 	{ "name": "v_81_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "v_81_out", "role": "ap_vld" }} , 
