...
set C_modelArgMapList {[ 
	{ "Name" : "A_1_reload", "interface" : "wire", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "B_23_reload", "interface" : "wire", "bitwidth" : 512, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ B_23_reload sc_in sc_lv 512 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "B_23_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "B_23_reload", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_64ns_64ns_128_1_1_U392", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	B_23_reload { ap_none {  { B_23_reload in_data 0 512 } } }
