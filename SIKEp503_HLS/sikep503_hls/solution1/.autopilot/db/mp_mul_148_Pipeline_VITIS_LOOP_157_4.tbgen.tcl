set moduleName mp_mul_148_Pipeline_VITIS_LOOP_157_4
set isTopModule 0
...
set cdfgNum 712
set C_modelName {mp_mul.148_Pipeline_VITIS_LOOP_157_4}
...
set C_modelArgMapList {[ 
	{ "Name" : "indvars_iv", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln145_23", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln145_23 sc_in sc_lv 4 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln145_23", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln145_23", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln145_23 { ap_none {  { zext_ln145_23 in_data 0 4 } } }
