set moduleName mp_mul_685_Pipeline_VITIS_LOOP_159_4
set isTopModule 0
...
set cdfgNum 712
set C_modelName {mp_mul.685_Pipeline_VITIS_LOOP_159_4}
...
set C_modelArgMapList {[ 
	{ "Name" : "indvars_iv", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln157_9", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln157_9 sc_in sc_lv 4 signal 4 } 
	{ coeff_address0 sc_out sc_lv 6 signal 5 } 
	{ coeff_ce0 sc_out sc_logic 1 signal 5 } 
	{ coeff_q0 sc_in sc_lv 64 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln157_9", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln157_9", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U1409", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U1410", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U1411", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U1412", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	zext_ln157_9 { ap_none {  { zext_ln157_9 in_data 0 4 } } }
