set moduleName fpadd503_25_Pipeline_VITIS_LOOP_35_2
set isTopModule 0
...
set cdfgNum 855
set C_modelName {fpadd503.25_Pipeline_VITIS_LOOP_35_2}
...
set C_modelArgList {
	...
	{ carry_140_out int 1 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "coeff", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "carry_140_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ carry_140_out sc_out sc_lv 1 signal 1 } 
	{ carry_140_out_ap_vld sc_out sc_logic 1 outvld 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "carry_140_out", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "carry_140_out", "role": "default" }} , 
 	{ "name": "carry_140_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "carry_140_out", "role": "ap_vld" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "fpadd503_25_Pipeline_VITIS_LOOP_35_2",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "carry_140_out", "Type" : "Vld", "Direction" : "O"},
...
set ArgLastReadFirstWriteLatency {
	fpadd503_25_Pipeline_VITIS_LOOP_35_2 {
		coeff {Type IO LastRead 0 FirstWrite 1}
		carry_140_out {Type O LastRead -1 FirstWrite 0}
...
set Spec2ImplPortList { 
	...
	carry_140_out { ap_vld {  { carry_140_out out_data 1 1 }  { carry_140_out_ap_vld out_vld 1 1 } } }
}
