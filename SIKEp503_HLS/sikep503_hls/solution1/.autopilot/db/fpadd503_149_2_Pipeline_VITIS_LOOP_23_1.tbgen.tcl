set moduleName fpadd503_149_2_Pipeline_VITIS_LOOP_23_1
set isTopModule 0
...
set cdfgNum 712
set C_modelName {fpadd503.149.2_Pipeline_VITIS_LOOP_23_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln24_25", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln24_25 sc_in sc_lv 4 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln24_25", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln24_25", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "fpadd503_149_2_Pipeline_VITIS_LOOP_23_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "zext_ln24_25", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	fpadd503_149_2_Pipeline_VITIS_LOOP_23_1 {
		zext_ln24_25 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	zext_ln24_25 { ap_none {  { zext_ln24_25 in_data 0 4 } } }
