set moduleName mp_mul_94_95_Pipeline_VITIS_LOOP_145_2
set isTopModule 0
...
set cdfgNum 712
set C_modelName {mp_mul.94.95_Pipeline_VITIS_LOOP_145_2}
...
set C_modelArgList {
	...
	{ u_59_out int 64 regular {pointer 2}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "v_017", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "u_59_out", "interface" : "wire", "bitwidth" : 64, "direction" : "READWRITE"} , 
...
set portList { 
	...
	{ v_66_out sc_out sc_lv 64 signal 10 } 
	{ v_66_out_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ u_59_out_i sc_in sc_lv 64 signal 11 } 
	{ u_59_out_o sc_out sc_lv 64 signal 11 } 
	{ u_59_out_o_ap_vld sc_out sc_logic 1 outvld 11 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "u_59_out_i", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "u_59_out", "role": "i" }} , 
 	{ "name": "u_59_out_o", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "u_59_out", "role": "o" }} , 
 	{ "name": "u_59_out_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "u_59_out", "role": "o_ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "mp_mul_94_95_Pipeline_VITIS_LOOP_145_2",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	mp_mul_94_95_Pipeline_VITIS_LOOP_145_2 {
...
set Spec2ImplPortList { 
	...
	u_59_out { ap_ovld {  { u_59_out_i in_data 0 64 }  { u_59_out_o out_data 1 64 }  { u_59_out_o_ap_vld out_vld 1 1 } } }
