set moduleName mp_mul_151_Pipeline_VITIS_LOOP_159_4
set isTopModule 0
...
set cdfgNum 712
set C_modelName {mp_mul.151_Pipeline_VITIS_LOOP_159_4}
...
set C_modelArgList {
	...
	{ zext_ln146_13 int 4 regular  }
	{ a int 64 regular {array 16 { 1 3 } 1 1 }  }
	{ i_27 int 4 regular  }
	{ zext_ln146_12 int 4 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "indvars_iv", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln146_13", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "a", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "i_27", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln146_12", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln146_13 sc_in sc_lv 4 signal 3 } 
	...
	{ zext_ln146_12 sc_in sc_lv 4 signal 6 } 
	...
	{ grp_fu_493_p_dout0 sc_in sc_lv 64 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln146_13", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln146_13", "role": "default" }} , 
 	...
 	{ "name": "zext_ln146_12", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln146_12", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_493_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "grp_fu_493_p_dout0", "role": "default" }} , 
