set moduleName fpsub503_3_Pipeline_VITIS_LOOP_57_1
set isTopModule 0
...
set cdfgNum 855
set C_modelName {fpsub503.3_Pipeline_VITIS_LOOP_57_1}
...
set C_modelArgList {
	{ zext_ln59_9 int 4 regular  }
	{ a int 64 regular {array 16 { 1 3 } 1 1 }  }
	{ zext_ln59_8 int 4 regular  }
	{ b int 64 regular {array 16 { 1 3 } 1 1 }  }
	{ zext_ln59_7 int 4 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln59_9", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "a", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln59_8", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "b", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln59_7", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln59_9", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln59_9", "role": "default" }} , 
 	...
 	{ "name": "zext_ln59_8", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln59_8", "role": "default" }} , 
 	...
 	{ "name": "zext_ln59_7", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln59_7", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "fpsub503_3_Pipeline_VITIS_LOOP_57_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "zext_ln59_9", "Type" : "None", "Direction" : "I"},
			{"Name" : "a", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "zext_ln59_8", "Type" : "None", "Direction" : "I"},
			{"Name" : "b", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "zext_ln59_7", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	fpsub503_3_Pipeline_VITIS_LOOP_57_1 {
		zext_ln59_9 {Type I LastRead 0 FirstWrite -1}
		a {Type I LastRead 0 FirstWrite -1}
		zext_ln59_8 {Type I LastRead 0 FirstWrite -1}
		b {Type I LastRead 0 FirstWrite -1}
		zext_ln59_7 {Type I LastRead 0 FirstWrite -1}
