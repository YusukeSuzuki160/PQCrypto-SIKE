set moduleName fpadd503_248_Pipeline_VITIS_LOOP_39_2
set isTopModule 0
...
set cdfgNum 684
set C_modelName {fpadd503.248_Pipeline_VITIS_LOOP_39_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict c { MEM_WIDTH 64 MEM_SIZE 448 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ zext_ln35_13 int 6 regular  }
	{ c int 64 regular {array 56 { 2 } 1 1 }  }
	{ carry_165_out int 1 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln35_13", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "carry_165_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ zext_ln35_13 sc_in sc_lv 6 signal 0 } 
	...
	{ carry_165_out sc_out sc_lv 1 signal 2 } 
	{ carry_165_out_ap_vld sc_out sc_logic 1 outvld 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "carry_165_out", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "carry_165_out", "role": "default" }} , 
 	{ "name": "carry_165_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "carry_165_out", "role": "ap_vld" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "fpadd503_248_Pipeline_VITIS_LOOP_39_2",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	fpadd503_248_Pipeline_VITIS_LOOP_39_2 {
...
set Spec2ImplPortList { 
	...
	carry_165_out { ap_vld {  { carry_165_out out_data 1 1 }  { carry_165_out_ap_vld out_vld 1 1 } } }
}
