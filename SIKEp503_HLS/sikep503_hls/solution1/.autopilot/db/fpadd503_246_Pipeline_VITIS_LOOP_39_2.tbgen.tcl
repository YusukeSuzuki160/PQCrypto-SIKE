...
set C_modelArgList {
	{ zext_ln35_16 int 7 regular  }
	{ c int 64 regular {array 112 { 2 } 1 1 }  }
	{ carry_183_out int 1 regular {pointer 1}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln35_16", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
 	{ "Name" : "c", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "carry_183_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ zext_ln35_16 sc_in sc_lv 7 signal 0 } 
	...
	{ carry_183_out sc_out sc_lv 1 signal 2 } 
	{ carry_183_out_ap_vld sc_out sc_logic 1 outvld 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln35_16", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln35_16", "role": "default" }} , 
 	...
 	{ "name": "carry_183_out", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "carry_183_out", "role": "default" }} , 
 	{ "name": "carry_183_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "carry_183_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	zext_ln35_16 { ap_none {  { zext_ln35_16 in_data 0 7 } } }
	c { ap_memory {  { c_address0 mem_address 1 7 }  { c_ce0 mem_ce 1 1 }  { c_we0 mem_we 1 1 }  { c_d0 mem_din 1 64 }  { c_q0 mem_dout 0 64 } } }
	carry_183_out { ap_vld {  { carry_183_out out_data 1 1 }  { carry_183_out_ap_vld out_vld 1 1 } } }
}
