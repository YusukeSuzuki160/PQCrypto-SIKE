set moduleName fpadd503_136_3_Pipeline_VITIS_LOOP_29_1
set isTopModule 0
...
set cdfgNum 855
set C_modelName {fpadd503.136.3_Pipeline_VITIS_LOOP_29_1}
...
set C_modelArgList {
	{ zext_ln31_28 int 4 regular  }
	{ b int 64 regular {array 16 { 1 3 } 1 1 }  }
	{ zext_ln31_27 int 4 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln31_28", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "b", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln31_27", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln31_28 sc_in sc_lv 4 signal 0 } 
	{ b_address0 sc_out sc_lv 4 signal 1 } 
	{ b_ce0 sc_out sc_logic 1 signal 1 } 
	{ b_q0 sc_in sc_lv 64 signal 1 } 
	{ zext_ln31_27 sc_in sc_lv 4 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln31_28", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln31_28", "role": "default" }} , 
 	...
 	{ "name": "zext_ln31_27", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln31_27", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "fpadd503_136_3_Pipeline_VITIS_LOOP_29_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "zext_ln31_28", "Type" : "None", "Direction" : "I"},
			{"Name" : "b", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "zext_ln31_27", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	fpadd503_136_3_Pipeline_VITIS_LOOP_29_1 {
		zext_ln31_28 {Type I LastRead 0 FirstWrite -1}
		b {Type I LastRead 0 FirstWrite -1}
		zext_ln31_27 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	zext_ln31_28 { ap_none {  { zext_ln31_28 in_data 0 4 } } }
	b { ap_memory {  { b_address0 mem_address 1 4 }  { b_ce0 mem_ce 1 1 }  { b_q0 mem_dout 0 64 } } }
	zext_ln31_27 { ap_none {  { zext_ln31_27 in_data 0 4 } } }
