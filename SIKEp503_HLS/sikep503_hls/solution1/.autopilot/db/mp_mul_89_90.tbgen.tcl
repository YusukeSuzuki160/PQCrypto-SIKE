...
set C_modelArgList {
	...
	{ a_0_offset int 1 regular  }
	{ a_1 int 64 regular {array 8 { 1 3 } 1 1 }  }
	{ a_1_offset int 1 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "a_0", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "a_0_offset", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "a_1", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "a_1_offset", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ a_0_offset sc_in sc_lv 1 signal 1 } 
	{ a_1_address0 sc_out sc_lv 3 signal 2 } 
	{ a_1_ce0 sc_out sc_logic 1 signal 2 } 
	{ a_1_q0 sc_in sc_lv 64 signal 2 } 
	{ a_1_offset sc_in sc_lv 1 signal 3 } 
	{ b_address0 sc_out sc_lv 4 signal 4 } 
	{ b_ce0 sc_out sc_logic 1 signal 4 } 
	{ b_q0 sc_in sc_lv 64 signal 4 } 
	{ b_offset sc_in sc_lv 1 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "a_0_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "a_0_offset", "role": "default" }} , 
 	...
 	{ "name": "a_1_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "a_1_offset", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "5", "6", "7", "8"],
		...
		"Port" : [
			{"Name" : "a_0", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_mp_mul_89_90_Pipeline_VITIS_LOOP_144_2_fu_148", "Port" : "a_0", "Inst_start_state" : "3", "Inst_end_state" : "4"},
					{"ID" : "3", "SubInstance" : "grp_mp_mul_89_90_Pipeline_VITIS_LOOP_157_4_fu_168", "Port" : "a_0", "Inst_start_state" : "7", "Inst_end_state" : "8"}]},
			{"Name" : "a_0_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "a_1", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_mp_mul_89_90_Pipeline_VITIS_LOOP_144_2_fu_148", "Port" : "a_1", "Inst_start_state" : "3", "Inst_end_state" : "4"},
					{"ID" : "3", "SubInstance" : "grp_mp_mul_89_90_Pipeline_VITIS_LOOP_157_4_fu_168", "Port" : "a_1", "Inst_start_state" : "7", "Inst_end_state" : "8"}]},
			{"Name" : "a_1_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "b", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_mp_mul_89_90_Pipeline_VITIS_LOOP_144_2_fu_148", "Port" : "b", "Inst_start_state" : "3", "Inst_end_state" : "4"},
					{"ID" : "3", "SubInstance" : "grp_mp_mul_89_90_Pipeline_VITIS_LOOP_157_4_fu_168", "Port" : "b", "Inst_start_state" : "7", "Inst_end_state" : "8"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_mp_mul_89_90_Pipeline_VITIS_LOOP_144_2_fu_148", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "mp_mul_89_90_Pipeline_VITIS_LOOP_144_2",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		...
		"Port" : [
			...
			{"Name" : "u_62_out", "Type" : "OVld", "Direction" : "IO"},
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_mp_mul_89_90_Pipeline_VITIS_LOOP_144_2_fu_148.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_mp_mul_89_90_Pipeline_VITIS_LOOP_157_4_fu_168", "Parent" : "0", "Child" : ["4"],
		"CDFG" : "mp_mul_89_90_Pipeline_VITIS_LOOP_157_4",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		...
		"Port" : [
			...
			{"Name" : "zext_ln145_3", "Type" : "None", "Direction" : "I"},
			{"Name" : "a_0", "Type" : "Memory", "Direction" : "I"},
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_157_4", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter9", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter9", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_mp_mul_89_90_Pipeline_VITIS_LOOP_157_4_fu_168.flow_control_loop_pipe_sequential_init_U", "Parent" : "3"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_2_1_U2954", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_2_1_U2955", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_2_1_U2956", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_2_1_U2957", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	...
	mp_mul_89_90_Pipeline_VITIS_LOOP_144_2 {
		...
		b {Type I LastRead 1 FirstWrite -1}
		v_73_out {Type O LastRead -1 FirstWrite 8}
		u_62_out {Type IO LastRead 8 FirstWrite 0}
		t_out {Type IO LastRead 9 FirstWrite 0}}
	mp_mul_89_90_Pipeline_VITIS_LOOP_157_4 {
		indvars_iv {Type I LastRead 0 FirstWrite -1}
		v {Type I LastRead 0 FirstWrite -1}
		zext_ln156 {Type I LastRead 0 FirstWrite -1}
		zext_ln145_3 {Type I LastRead 0 FirstWrite -1}
		a_0 {Type I LastRead 1 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	a_0_offset { ap_none {  { a_0_offset in_data 0 1 } } }
	a_1 { ap_memory {  { a_1_address0 mem_address 1 3 }  { a_1_ce0 mem_ce 1 1 }  { a_1_q0 mem_dout 0 64 } } }
	a_1_offset { ap_none {  { a_1_offset in_data 0 1 } } }
