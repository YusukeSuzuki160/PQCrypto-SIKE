set moduleName mul_68_Pipeline_VITIS_LOOP_215_3
set isTopModule 0
...
set cdfgNum 684
set C_modelName {mul.68_Pipeline_VITIS_LOOP_215_3}
...
set C_modelArgMapList {[ 
	{ "Name" : "select_ln207", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln207_2", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "a", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "coeff", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "sum_1_out", "interface" : "wire", "bitwidth" : 133, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ zext_ln207_2 sc_in sc_lv 4 signal 4 } 
	{ a_address0 sc_out sc_lv 3 signal 5 } 
	{ a_ce0 sc_out sc_logic 1 signal 5 } 
	{ a_q0 sc_in sc_lv 64 signal 5 } 
	{ coeff_address0 sc_out sc_lv 6 signal 6 } 
	{ coeff_ce0 sc_out sc_logic 1 signal 6 } 
	{ coeff_q0 sc_in sc_lv 64 signal 6 } 
	{ sum_1_out sc_out sc_lv 133 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln207_2", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln207_2", "role": "default" }} , 
 	...
 	{ "name": "sum_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":133, "type": "signal", "bundle":{"name": "sum_1_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_64ns_64ns_128_1_1_U1109", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	zext_ln207_2 { ap_none {  { zext_ln207_2 in_data 0 4 } } }
	...
	sum_1_out { ap_vld {  { sum_1_out out_data 1 133 }  { sum_1_out_ap_vld out_vld 1 1 } } }
}
