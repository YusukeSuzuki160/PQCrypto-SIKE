set moduleName mp_mul_8_Pipeline_VITIS_LOOP_144_2
set isTopModule 0
...
set cdfgNum 712
set C_modelName {mp_mul.8_Pipeline_VITIS_LOOP_144_2}
...
set C_modelArgList {
	...
	{ i int 3 regular  }
	{ v_80_out int 64 regular {pointer 1}  }
	{ u_65_out int 64 regular {pointer 2}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "v_017", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "v_80_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "u_65_out", "interface" : "wire", "bitwidth" : 64, "direction" : "READWRITE"} , 
...
set portList { 
	...
	{ PKB_address1 sc_out sc_lv 6 signal 3 } 
	{ PKB_ce1 sc_out sc_logic 1 signal 3 } 
	{ PKB_q1 sc_in sc_lv 64 signal 3 } 
	{ i sc_in sc_lv 3 signal 4 } 
	{ v_80_out sc_out sc_lv 64 signal 5 } 
	{ v_80_out_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ u_65_out_i sc_in sc_lv 64 signal 6 } 
	{ u_65_out_o sc_out sc_lv 64 signal 6 } 
	{ u_65_out_o_ap_vld sc_out sc_logic 1 outvld 6 } 
	...
	{ grp_fu_418_p_dout0 sc_in sc_lv 64 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v_80_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v_80_out", "role": "default" }} , 
 	{ "name": "v_80_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "v_80_out", "role": "ap_vld" }} , 
 	{ "name": "u_65_out_i", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "u_65_out", "role": "i" }} , 
 	{ "name": "u_65_out_o", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "u_65_out", "role": "o" }} , 
 	{ "name": "u_65_out_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "u_65_out", "role": "o_ap_vld" }} , 
 	...
 	{ "name": "grp_fu_418_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "grp_fu_418_p_dout0", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	v_80_out { ap_vld {  { v_80_out out_data 1 64 }  { v_80_out_ap_vld out_vld 1 1 } } }
	u_65_out { ap_ovld {  { u_65_out_i in_data 0 64 }  { u_65_out_o out_data 1 64 }  { u_65_out_o_ap_vld out_vld 1 1 } } }
