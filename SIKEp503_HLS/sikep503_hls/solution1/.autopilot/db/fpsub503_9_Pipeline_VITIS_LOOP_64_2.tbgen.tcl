set moduleName fpsub503_9_Pipeline_VITIS_LOOP_64_2
set isTopModule 0
...
set cdfgNum 855
set C_modelName {fpsub503.9_Pipeline_VITIS_LOOP_64_2}
...
set C_modelArgList {
	{ zext_ln59_1 int 4 regular  }
	{ c int 64 regular {array 16 { 0 1 } 1 1 }  }
	{ sext_ln54 int 1 regular  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln59_1", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "c", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "sext_ln54", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ zext_ln59_1 sc_in sc_lv 4 signal 0 } 
	...
	{ sext_ln54 sc_in sc_lv 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln59_1", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln59_1", "role": "default" }} , 
 	...
 	{ "name": "sext_ln54", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "sext_ln54", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "fpsub503_9_Pipeline_VITIS_LOOP_64_2",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	fpsub503_9_Pipeline_VITIS_LOOP_64_2 {
...
set Spec2ImplPortList { 
	zext_ln59_1 { ap_none {  { zext_ln59_1 in_data 0 4 } } }
	...
	sext_ln54 { ap_none {  { sext_ln54 in_data 0 1 } } }
}
