set moduleName cshake256_simple_18_Pipeline_VITIS_LOOP_668_1
set isTopModule 0
...
set cdfgNum 684
set C_modelName {cshake256_simple.18_Pipeline_VITIS_LOOP_668_1}
...
dict set ap_memory_interface_dict t_68 { MEM_WIDTH 8 MEM_SIZE 34 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict t_69 { MEM_WIDTH 8 MEM_SIZE 34 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict t_70 { MEM_WIDTH 8 MEM_SIZE 34 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem int 8 regular {axi_master 1}  }
	{ output_r int 64 regular  }
	{ t int 8 regular {array 34 { 1 3 } 1 1 }  }
	{ t_68 int 8 regular {array 34 { 1 3 } 1 1 }  }
	{ t_69 int 8 regular {array 34 { 1 3 } 1 1 }  }
	{ t_70 int 8 regular {array 34 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "ct","offset": { "type": "dynamic","port_name": "ct","bundle": "control"},"direction": "READWRITE"},{"cName": "pk","offset": { "type": "dynamic","port_name": "pk","bundle": "control"},"direction": "READONLY"},{"cName": "ss","offset": { "type": "dynamic","port_name": "ss","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "t_68", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "t_69", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "t_70", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ t_68_address0 sc_out sc_lv 6 signal 3 } 
	{ t_68_ce0 sc_out sc_logic 1 signal 3 } 
	{ t_68_q0 sc_in sc_lv 8 signal 3 } 
	{ t_69_address0 sc_out sc_lv 6 signal 4 } 
	{ t_69_ce0 sc_out sc_logic 1 signal 4 } 
	{ t_69_q0 sc_in sc_lv 8 signal 4 } 
	{ t_70_address0 sc_out sc_lv 6 signal 5 } 
	{ t_70_ce0 sc_out sc_logic 1 signal 5 } 
	{ t_70_q0 sc_in sc_lv 8 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "t_68_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "t_68", "role": "q0" }} , 
 	...
 	{ "name": "t_69_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "t_69", "role": "q0" }} , 
 	...
 	{ "name": "t_70_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "t_70", "role": "q0" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "cshake256_simple_18_Pipeline_VITIS_LOOP_668_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "t_68", "Type" : "Memory", "Direction" : "I"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_2_8_1_1_U2197", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	cshake256_simple_18_Pipeline_VITIS_LOOP_668_1 {
		gmem {Type O LastRead -1 FirstWrite 2}
		output_r {Type I LastRead 0 FirstWrite -1}
		t {Type I LastRead 0 FirstWrite -1}
		t_68 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	t_68 { ap_memory {  { t_68_address0 mem_address 1 6 }  { t_68_ce0 mem_ce 1 1 }  { t_68_q0 mem_dout 0 8 } } }
	t_69 { ap_memory {  { t_69_address0 mem_address 1 6 }  { t_69_ce0 mem_ce 1 1 }  { t_69_q0 mem_dout 0 8 } } }
	t_70 { ap_memory {  { t_70_address0 mem_address 1 6 }  { t_70_ce0 mem_ce 1 1 }  { t_70_q0 mem_dout 0 8 } } }
}
