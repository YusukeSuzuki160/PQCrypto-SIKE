set moduleName EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_13_1359
set isTopModule 0
...
set cdfgNum 855
set C_modelName {EphemeralKeyGeneration_A.1_Pipeline_VITIS_LOOP_13_1359}
...
set C_modelArgMapList {[ 
	{ "Name" : "npts_5", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "npts_5", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "npts_5", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_13_1359",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_13_1359 {
...
set Spec2ImplPortList { 
	npts_5 { ap_none {  { npts_5 in_data 0 3 } } }
