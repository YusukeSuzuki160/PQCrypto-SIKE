set moduleName EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_40_1
set isTopModule 0
...
set cdfgNum 712
set C_modelName {EphemeralKeyGeneration_A.1_Pipeline_VITIS_LOOP_40_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "ct","offset": { "type": "dynamic","port_name": "ct","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "PublicKeyA", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ PublicKeyA sc_in sc_lv 32 signal 1 } 
	{ t_i_address0 sc_out sc_lv 4 signal 2 } 
	{ t_i_ce0 sc_out sc_logic 1 signal 2 } 
	{ t_i_q0 sc_in sc_lv 64 signal 2 } 
	{ t_i_address1 sc_out sc_lv 4 signal 2 } 
	{ t_i_ce1 sc_out sc_logic 1 signal 2 } 
	{ t_i_q1 sc_in sc_lv 64 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "PublicKeyA", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "PublicKeyA", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_40_1",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_40_1 {
...
set Spec2ImplPortList { 
	...
	PublicKeyA { ap_none {  { PublicKeyA in_data 0 32 } } }
