set moduleName crypto_kem_enc_1_Pipeline_VITIS_LOOP_570_1
set isTopModule 0
...
set cdfgNum 712
set C_modelName {crypto_kem_enc.1_Pipeline_VITIS_LOOP_570_1}
...
dict set ap_memory_interface_dict t_78 { MEM_WIDTH 8 MEM_SIZE 34 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict t_79 { MEM_WIDTH 8 MEM_SIZE 34 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict t_80 { MEM_WIDTH 8 MEM_SIZE 34 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem1 int 8 regular {axi_master 1}  }
	{ ss int 32 regular  }
	{ t int 8 regular {array 34 { 1 3 } 1 1 }  }
	{ t_78 int 8 regular {array 34 { 1 3 } 1 1 }  }
	{ t_79 int 8 regular {array 34 { 1 3 } 1 1 }  }
	{ t_80 int 8 regular {array 34 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "pk","offset": { "type": "dynamic","port_name": "pk","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "ss", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "t", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "t_78", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "t_79", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "t_80", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ m_axi_gmem1_0_AWADDR sc_out sc_lv 32 signal 0 } 
	...
	{ m_axi_gmem1_0_ARADDR sc_out sc_lv 32 signal 0 } 
	...
	{ ss sc_in sc_lv 32 signal 1 } 
	{ t_address0 sc_out sc_lv 6 signal 2 } 
	{ t_ce0 sc_out sc_logic 1 signal 2 } 
	{ t_q0 sc_in sc_lv 8 signal 2 } 
	{ t_78_address0 sc_out sc_lv 6 signal 3 } 
	{ t_78_ce0 sc_out sc_logic 1 signal 3 } 
	{ t_78_q0 sc_in sc_lv 8 signal 3 } 
	{ t_79_address0 sc_out sc_lv 6 signal 4 } 
	{ t_79_ce0 sc_out sc_logic 1 signal 4 } 
	{ t_79_q0 sc_in sc_lv 8 signal 4 } 
	{ t_80_address0 sc_out sc_lv 6 signal 5 } 
	{ t_80_ce0 sc_out sc_logic 1 signal 5 } 
	{ t_80_q0 sc_in sc_lv 8 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ss", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ss", "role": "default" }} , 
 	...
 	{ "name": "t_78_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "t_78", "role": "q0" }} , 
 	...
 	{ "name": "t_79_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "t_79", "role": "q0" }} , 
 	...
 	{ "name": "t_80_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "t_80", "role": "q0" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "crypto_kem_enc_1_Pipeline_VITIS_LOOP_570_1",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_2_8_1_1_U3348", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	crypto_kem_enc_1_Pipeline_VITIS_LOOP_570_1 {
		gmem1 {Type O LastRead -1 FirstWrite 2}
		ss {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	ss { ap_none {  { ss in_data 0 32 } } }
	t { ap_memory {  { t_address0 mem_address 1 6 }  { t_ce0 mem_ce 1 1 }  { t_q0 mem_dout 0 8 } } }
	t_78 { ap_memory {  { t_78_address0 mem_address 1 6 }  { t_78_ce0 mem_ce 1 1 }  { t_78_q0 mem_dout 0 8 } } }
	t_79 { ap_memory {  { t_79_address0 mem_address 1 6 }  { t_79_ce0 mem_ce 1 1 }  { t_79_q0 mem_dout 0 8 } } }
	t_80 { ap_memory {  { t_80_address0 mem_address 1 6 }  { t_80_ce0 mem_ce 1 1 }  { t_80_q0 mem_dout 0 8 } } }
}
