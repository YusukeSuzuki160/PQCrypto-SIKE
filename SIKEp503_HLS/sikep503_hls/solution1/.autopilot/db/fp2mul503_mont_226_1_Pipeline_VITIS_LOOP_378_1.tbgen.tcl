set moduleName fp2mul503_mont_226_1_Pipeline_VITIS_LOOP_378_1
set isTopModule 0
...
set cdfgNum 779
set C_modelName {fp2mul503_mont.226.1_Pipeline_VITIS_LOOP_378_1}
...
set C_modelArgList {
	{ zext_ln381_52 int 6 regular  }
	{ c_0 int 64 regular {array 56 { 1 } 1 1 }  }
	{ zext_ln381_51 int 6 regular  }
	{ c_1 int 64 regular {array 56 { 1 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln381_52", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "c_0", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln381_51", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln381_52 sc_in sc_lv 6 signal 0 } 
	{ c_0_address0 sc_out sc_lv 6 signal 1 } 
	{ c_0_ce0 sc_out sc_logic 1 signal 1 } 
	{ c_0_q0 sc_in sc_lv 64 signal 1 } 
	{ zext_ln381_51 sc_in sc_lv 6 signal 2 } 
	{ c_1_address0 sc_out sc_lv 6 signal 3 } 
	{ c_1_ce0 sc_out sc_logic 1 signal 3 } 
	{ c_1_q0 sc_in sc_lv 64 signal 3 } 
	{ t1_address0 sc_out sc_lv 3 signal 4 } 
	{ t1_ce0 sc_out sc_logic 1 signal 4 } 
	{ t1_we0 sc_out sc_logic 1 signal 4 } 
	{ t1_d0 sc_out sc_lv 64 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln381_52", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln381_52", "role": "default" }} , 
 	...
 	{ "name": "zext_ln381_51", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln381_51", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "fp2mul503_mont_226_1_Pipeline_VITIS_LOOP_378_1",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	fp2mul503_mont_226_1_Pipeline_VITIS_LOOP_378_1 {
...
set Spec2ImplPortList { 
	zext_ln381_52 { ap_none {  { zext_ln381_52 in_data 0 6 } } }
	c_0 { ap_memory {  { c_0_address0 mem_address 1 6 }  { c_0_ce0 mem_ce 1 1 }  { c_0_q0 mem_dout 0 64 } } }
	zext_ln381_51 { ap_none {  { zext_ln381_51 in_data 0 6 } } }
	c_1 { ap_memory {  { c_1_address0 mem_address 1 6 }  { c_1_ce0 mem_ce 1 1 }  { c_1_q0 mem_dout 0 64 } } }
