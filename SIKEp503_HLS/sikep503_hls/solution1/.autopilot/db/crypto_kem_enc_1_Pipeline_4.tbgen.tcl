set moduleName crypto_kem_enc_1_Pipeline_4
set isTopModule 0
...
set cdfgNum 712
set C_modelName {crypto_kem_enc.1_Pipeline_4}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "ct","offset": { "type": "dynamic","port_name": "ct","bundle": "control"},"direction": "READWRITE"}]}]} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "crypto_kem_enc_1_Pipeline_4",
		"Protocol" : "ap_ctrl_hs",
