set moduleName fp2mul503_mont_42_Pipeline_VITIS_LOOP_228_2147
set isTopModule 0
...
set cdfgNum 855
set C_modelName {fp2mul503_mont.42_Pipeline_VITIS_LOOP_228_2147}
...
set C_modelArgMapList {[ 
	{ "Name" : "P_17", "interface" : "wire", "bitwidth" : 1024, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ P_17 sc_in sc_lv 1024 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "P_17", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "P_17", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.partselect_64ns_1024ns_32ns_64_1_1_U1365", "Parent" : "0"},
...
set Spec2ImplPortList { 
	P_17 { ap_none {  { P_17 in_data 0 1024 } } }
