set moduleName EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_13_1205
set isTopModule 0
...
set cdfgNum 684
set C_modelName {EphemeralSecretAgreement_A.1_Pipeline_VITIS_LOOP_13_1205}
...
set C_modelArgList {
	...
	{ pts_X_1 int 64 regular {array 56 { 1 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln14_1", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "pts_X_1", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ pts_X_1_q0 sc_in sc_lv 64 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_13_1205",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_13_1205 {
		zext_ln14_1 {Type I LastRead 0 FirstWrite -1}
		pts_X_1 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	pts_X_1 { ap_memory {  { pts_X_1_address0 mem_address 1 6 }  { pts_X_1_ce0 mem_ce 1 1 }  { pts_X_1_q0 mem_dout 0 64 } } }
