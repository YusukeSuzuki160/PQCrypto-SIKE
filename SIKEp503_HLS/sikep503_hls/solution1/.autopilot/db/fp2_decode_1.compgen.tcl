...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 2616 \
    name Montgomery_R2_1 \
    reset_level 1 \
    sync_rst true \
    dir I \
    corename Montgomery_R2_1 \
    op interface \
    ports { Montgomery_R2_1_address0 { O 3 vector } Montgomery_R2_1_ce0 { O 1 bit } Montgomery_R2_1_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'Montgomery_R2_1'"
}
}
