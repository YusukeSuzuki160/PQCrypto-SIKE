set moduleName fpsub503_144_276_Pipeline_VITIS_LOOP_47_1
set isTopModule 0
...
set cdfgNum 712
set C_modelName {fpsub503.144.276_Pipeline_VITIS_LOOP_47_1}
...
set C_modelArgList {
	{ zext_ln48_18 int 4 regular  }
	{ a int 64 regular {array 16 { 1 3 } 1 1 }  }
	{ zext_ln48_17 int 4 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln48_18", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "a", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln48_17", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln48_18", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln48_18", "role": "default" }} , 
 	...
 	{ "name": "zext_ln48_17", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln48_17", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "fpsub503_144_276_Pipeline_VITIS_LOOP_47_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "zext_ln48_18", "Type" : "None", "Direction" : "I"},
			{"Name" : "a", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "zext_ln48_17", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	fpsub503_144_276_Pipeline_VITIS_LOOP_47_1 {
		zext_ln48_18 {Type I LastRead 0 FirstWrite -1}
		a {Type I LastRead 0 FirstWrite -1}
		zext_ln48_17 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	zext_ln48_18 { ap_none {  { zext_ln48_18 in_data 0 4 } } }
	a { ap_memory {  { a_address0 mem_address 1 4 }  { a_ce0 mem_ce 1 1 }  { a_q0 mem_dout 0 64 } } }
	zext_ln48_17 { ap_none {  { zext_ln48_17 in_data 0 4 } } }
