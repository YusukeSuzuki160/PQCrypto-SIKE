set moduleName fp2sqr503_mont_135_Pipeline_VITIS_LOOP_350_1
set isTopModule 0
...
set cdfgNum 712
set C_modelName {fp2sqr503_mont.135_Pipeline_VITIS_LOOP_350_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "c_offset", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln352_11", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln352_11 sc_in sc_lv 7 signal 2 } 
	{ t1_address0 sc_out sc_lv 3 signal 3 } 
	{ t1_ce0 sc_out sc_logic 1 signal 3 } 
	{ t1_we0 sc_out sc_logic 1 signal 3 } 
	{ t1_d0 sc_out sc_lv 64 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln352_11", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln352_11", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln352_11 { ap_none {  { zext_ln352_11 in_data 0 7 } } }
