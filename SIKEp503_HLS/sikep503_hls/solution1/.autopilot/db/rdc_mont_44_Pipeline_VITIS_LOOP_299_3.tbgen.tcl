set moduleName rdc_mont_44_Pipeline_VITIS_LOOP_299_3
set isTopModule 0
...
set cdfgNum 855
set C_modelName {rdc_mont.44_Pipeline_VITIS_LOOP_299_3}
...
set C_modelArgList {
	...
	{ u int 64 regular  }
	{ i_11 int 3 regular  }
	{ add_ln299 int 4 regular  }
	{ R_Z int 64 regular {array 16 { 1 3 } 1 1 }  }
	{ empty int 3 regular  }
	{ v_69_out int 64 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "v", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add_ln299", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "R_Z", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "v_69_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ add_ln299 sc_in sc_lv 4 signal 3 } 
	...
	{ v_69_out sc_out sc_lv 64 signal 6 } 
	{ v_69_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ u_47_out sc_out sc_lv 64 signal 7 } 
	{ u_47_out_ap_vld sc_out sc_logic 1 outvld 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln299", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "add_ln299", "role": "default" }} , 
 	...
 	{ "name": "v_69_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v_69_out", "role": "default" }} , 
 	{ "name": "v_69_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "v_69_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_64ns_64ns_128_1_1_U821", "Parent" : "0"},
