set moduleName fp2mul503_mont_325_1_Pipeline_VITIS_LOOP_370_1
set isTopModule 0
...
set cdfgNum 855
set C_modelName {fp2mul503_mont.325.1_Pipeline_VITIS_LOOP_370_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "c_offset", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln220_81", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln220_81 sc_in sc_lv 7 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln220_81", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln220_81", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "fp2mul503_mont_325_1_Pipeline_VITIS_LOOP_370_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "zext_ln220_81", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	fp2mul503_mont_325_1_Pipeline_VITIS_LOOP_370_1 {
		c_offset {Type I LastRead 0 FirstWrite -1}
		c {Type I LastRead 1 FirstWrite -1}
		zext_ln220_81 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	zext_ln220_81 { ap_none {  { zext_ln220_81 in_data 0 7 } } }
