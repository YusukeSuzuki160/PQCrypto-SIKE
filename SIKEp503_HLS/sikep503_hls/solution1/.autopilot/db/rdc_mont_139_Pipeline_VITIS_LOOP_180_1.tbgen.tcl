set moduleName rdc_mont_139_Pipeline_VITIS_LOOP_180_1
set isTopModule 0
...
set cdfgNum 712
set C_modelName {rdc_mont.139_Pipeline_VITIS_LOOP_180_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict mc { MEM_WIDTH 64 MEM_SIZE 960 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ mc int 64 regular {array 120 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ zext_ln181 sc_in sc_lv 7 signal 1 } 
	{ mc_offset sc_in sc_lv 4 signal 2 } 
}
set NewPortList {[ 
