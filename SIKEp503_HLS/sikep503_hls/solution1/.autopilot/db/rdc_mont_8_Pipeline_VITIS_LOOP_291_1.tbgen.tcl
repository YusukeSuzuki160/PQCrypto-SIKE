set moduleName rdc_mont_8_Pipeline_VITIS_LOOP_291_1
set isTopModule 0
...
set cdfgNum 855
set C_modelName {rdc_mont.8_Pipeline_VITIS_LOOP_291_1}
...
set C_modelArgList {
	...
	{ zext_ln293 int 3 regular  }
	{ mc_0 int 64 regular {array 8 { 0 3 } 0 1 }  }
	{ zext_ln293_1 int 3 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mc_1", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "zext_ln293", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "mc_0", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "zext_ln293_1", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln293 sc_in sc_lv 3 signal 1 } 
	...
	{ zext_ln293_1 sc_in sc_lv 3 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln293", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "zext_ln293", "role": "default" }} , 
 	...
 	{ "name": "zext_ln293_1", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "zext_ln293_1", "role": "default" }} , 
