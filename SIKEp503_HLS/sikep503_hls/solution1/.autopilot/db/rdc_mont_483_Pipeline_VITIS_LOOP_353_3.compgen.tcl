...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sikep503_kem_enc_hw_rdc_mont_483_Pipeline_VITIS_LOOP_353_3_p503p1_1_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln353 \
    op interface \
    ports { add_ln353 { I 4 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_v_49_out \
    op interface \
    ports { v_49_out { O 64 vector } v_49_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_u_44_out \
    op interface \
    ports { u_44_out { O 64 vector } u_44_out_ap_vld { O 1 bit } } \
} "
}
