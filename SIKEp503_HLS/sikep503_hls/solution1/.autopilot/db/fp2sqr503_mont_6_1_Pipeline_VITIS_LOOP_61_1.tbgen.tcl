set moduleName fp2sqr503_mont_6_1_Pipeline_VITIS_LOOP_61_1
set isTopModule 0
...
set cdfgNum 684
set C_modelName {fp2sqr503_mont.6.1_Pipeline_VITIS_LOOP_61_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln381_3", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln381_3 sc_in sc_lv 6 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln381_3", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln381_3", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln381_3 { ap_none {  { zext_ln381_3 in_data 0 6 } } }
