...
entity sikep503_kem_enc_hw_control_s_axi is
generic (
...
end entity sikep503_kem_enc_hw_control_s_axi;
...
-- ----------------------- Register logic ----------------
    ...
    ct                   <= STD_LOGIC_VECTOR(int_ct);
    pk                   <= STD_LOGIC_VECTOR(int_pk);
    ss                   <= STD_LOGIC_VECTOR(int_ss);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_ct(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CT_DATA_0) then
                    int_ct(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_ct(31 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (w_hs = '1' and waddr = ADDR_PK_DATA_0) then
                    int_pk(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_pk(31 downto 0));
                end if;
            end if;
        end if;
    end process;
