...
entity sikep503_kem_enc_hw_fp2mul503_mont_5_Pipeline_VITIS_LOOP_169_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sikep503_kem_enc_hw_fp2mul503_mont_5_Pipeline_VITIS_LOOP_169_1 is 
...
attribute shreg_extract : string;
    ...
    signal zext_ln170_11_fu_131_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln170_11_reg_232 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln170_11_reg_232_pp0_iter1_reg : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal i_207_fu_44 : STD_LOGIC_VECTOR (4 downto 0) := "00000";
...
begin
    ...
    i_207_fu_44_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                tt2_load_reg_253 <= tt2_q0;
                    zext_ln170_11_reg_232(3 downto 0) <= zext_ln170_11_fu_131_p1(3 downto 0);
                    zext_ln170_11_reg_232_pp0_iter1_reg(3 downto 0) <= zext_ln170_11_reg_232(3 downto 0);
            end if;
        end if;
    end process;
    zext_ln170_11_reg_232(31 downto 4) <= "0000000000000000000000000000";
    zext_ln170_11_reg_232_pp0_iter1_reg(31 downto 4) <= "0000000000000000000000000000";
    ...
    ap_sig_allocacmp_i_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, i_207_fu_44)
    begin
    ...
    or_ln105_fu_156_p2 <= (xor_ln105_fu_148_p2 or xor_ln105_162_fu_152_p2);
    ...
    tmp_267_fu_185_p3 <= or_ln95_fu_180_p2(63 downto 63);
    tmp_fu_167_p3 <= xor_ln105_163_fu_162_p2(63 downto 63);
    trunc_ln170_fu_127_p1 <= ap_sig_allocacmp_i(4 - 1 downto 0);
    tt1_address0 <= zext_ln170_11_fu_131_p1(4 - 1 downto 0);
    ...
    tt2_address0 <= zext_ln170_11_fu_131_p1(4 - 1 downto 0);
    ...
    tt3_address0 <= zext_ln170_11_reg_232_pp0_iter1_reg(4 - 1 downto 0);
    ...
    xor_ln105_162_fu_152_p2 <= (tt2_load_reg_253 xor tempReg_reg_259);
    xor_ln105_163_fu_162_p2 <= (tt1_load_reg_247 xor or_ln105_fu_156_p2);
    xor_ln105_fu_148_p2 <= (tt2_load_reg_253 xor tt1_load_reg_247);
    xor_ln170_fu_193_p2 <= (tmp_267_fu_185_p3 xor ap_const_lv1_1);
    zext_ln170_11_fu_131_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(trunc_ln170_fu_127_p1),32));
