...
begin
    sparsemux_9_2_8_1_1_U11705 : component sikep503_kem_enc_hw_sparsemux_9_2_8_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00",
    ...
    add_ln98_1_fu_173_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv5_1));
    ...
    icmp_ln98_fu_167_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv5_18) else "0";
    lshr_ln1_fu_194_p4 <= ap_sig_allocacmp_i_1(4 downto 2);
    ...
    trunc_ln98_fu_190_p1 <= ap_sig_allocacmp_i_1(2 - 1 downto 0);
    ...
    zext_ln98_fu_185_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_1),64));
end behav;
