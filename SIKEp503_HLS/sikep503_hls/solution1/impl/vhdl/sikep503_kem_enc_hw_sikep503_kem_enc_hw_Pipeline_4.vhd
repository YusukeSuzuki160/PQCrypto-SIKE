...
entity sikep503_kem_enc_hw_sikep503_kem_enc_hw_Pipeline_4 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sikep503_kem_enc_hw_sikep503_kem_enc_hw_Pipeline_4 is 
...
attribute shreg_extract : string;
    ...
    signal exitcond_i3_fu_84_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal gmem_blk_n_R : STD_LOGIC;
    signal ap_block_pp0_stage0_grp1 : BOOLEAN;
    signal loop_index_i_load_reg_124 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal loop_index_i_load_reg_124_pp0_iter1_reg : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_block_pp0_stage0_11001_grp1 : BOOLEAN;
    signal gmem_addr_read_reg_138 : STD_LOGIC_VECTOR (7 downto 0);
    signal arrayidx19_sum_i_cast_fu_112_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_grp0 : BOOLEAN;
    signal loop_index_i_fu_48 : STD_LOGIC_VECTOR (8 downto 0) := "000000000";
    signal empty_fu_90_p2 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal arrayidx19_sum_i_fu_107_p2 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((exitcond_i3_fu_84_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    loop_index_i_fu_48 <= empty_fu_90_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    loop_index_i_fu_48 <= ap_const_lv9_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                loop_index_i_load_reg_124 <= ap_sig_allocacmp_loop_index_i_load;
                loop_index_i_load_reg_124_pp0_iter1_reg <= loop_index_i_load_reg_124;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                gmem_addr_read_reg_138 <= m_axi_gmem_0_RDATA;
            end if;
        end if;
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, exitcond_i3_fu_84_p2)
    begin
        if (((exitcond_i3_fu_84_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_loop_index_i_load_assign_proc : process(ap_CS_fsm_pp0_stage0, loop_index_i_fu_48, ap_loop_init, ap_block_pp0_stage0)
    begin
    ...
    arrayidx19_sum_i_cast_fu_112_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(arrayidx19_sum_i_fu_107_p2),64));
    arrayidx19_sum_i_fu_107_p2 <= std_logic_vector(unsigned(loop_index_i_load_reg_124_pp0_iter1_reg) + unsigned(ap_const_lv9_18));
    empty_fu_90_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index_i_load) + unsigned(ap_const_lv9_1));
    exitcond_i3_fu_84_p2 <= "1" when (ap_sig_allocacmp_loop_index_i_load = ap_const_lv9_192) else "0";
    ...
    temp_address0 <= arrayidx19_sum_i_cast_fu_112_p1(9 - 1 downto 0);
    ...
    temp_d0 <= gmem_addr_read_reg_138;
    temp_we0 <= temp_we0_local;

    temp_we0_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001_grp0, ap_block_pp0_stage0_subdone_grp0_done_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
