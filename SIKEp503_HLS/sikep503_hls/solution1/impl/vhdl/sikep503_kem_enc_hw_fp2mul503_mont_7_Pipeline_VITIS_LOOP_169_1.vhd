...
entity sikep503_kem_enc_hw_fp2mul503_mont_7_Pipeline_VITIS_LOOP_169_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sikep503_kem_enc_hw_fp2mul503_mont_7_Pipeline_VITIS_LOOP_169_1 is 
...
attribute shreg_extract : string;
    ...
    signal zext_ln170_4_fu_131_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln170_4_reg_232 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln170_4_reg_232_pp0_iter1_reg : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_251_fu_185_p3 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                tt2_load_reg_253 <= tt2_q0;
                    zext_ln170_4_reg_232(3 downto 0) <= zext_ln170_4_fu_131_p1(3 downto 0);
                    zext_ln170_4_reg_232_pp0_iter1_reg(3 downto 0) <= zext_ln170_4_reg_232(3 downto 0);
            end if;
        end if;
    end process;
    zext_ln170_4_reg_232(31 downto 4) <= "0000000000000000000000000000";
    zext_ln170_4_reg_232_pp0_iter1_reg(31 downto 4) <= "0000000000000000000000000000";
    ...
    tt2_address0 <= zext_ln170_4_fu_131_p1(4 - 1 downto 0);
    ...
    tt3_address0 <= zext_ln170_4_reg_232_pp0_iter1_reg(4 - 1 downto 0);
    ...
    xor_ln170_fu_193_p2 <= (tmp_251_fu_185_p3 xor ap_const_lv1_1);
    zext_ln170_4_fu_131_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(trunc_ln170_fu_127_p1),32));
