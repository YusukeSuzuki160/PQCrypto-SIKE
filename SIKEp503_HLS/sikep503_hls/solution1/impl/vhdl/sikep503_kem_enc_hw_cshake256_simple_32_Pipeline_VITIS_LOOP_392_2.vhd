...
entity sikep503_kem_enc_hw_cshake256_simple_32_Pipeline_VITIS_LOOP_392_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    zext_ln392_1 : IN STD_LOGIC_VECTOR (5 downto 0);
...
architecture behav of sikep503_kem_enc_hw_cshake256_simple_32_Pipeline_VITIS_LOOP_392_2 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln392_fu_193_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal zext_ln392_1_cast_fu_181_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal zext_ln392_1_cast_reg_296 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal i_reg_302 : STD_LOGIC_VECTOR (4 downto 0);
    signal s_addr_reg_312 : STD_LOGIC_VECTOR (4 downto 0);
    signal s_addr_reg_312_pp0_iter1_reg : STD_LOGIC_VECTOR (4 downto 0);
    signal s_load_reg_358 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln392_fu_205_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal zext_ln28_1_fu_231_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln28_3_fu_255_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_250_fu_54 : STD_LOGIC_VECTOR (4 downto 0) := "00000";
    signal i_279_fu_199_p2 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal xor_ln395_fu_283_p2 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal zext_ln28_fu_222_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln28_fu_226_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal or_ln28_fu_239_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal zext_ln28_2_fu_246_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln28_1_fu_250_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal or_ln395_6_fu_263_p9 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln392_fu_193_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_250_fu_54 <= i_279_fu_199_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                s_addr_reg_312 <= zext_ln392_fu_205_p1(5 - 1 downto 0);
                s_addr_reg_312_pp0_iter1_reg <= s_addr_reg_312;
                    zext_ln392_1_cast_reg_296(5 downto 0) <= zext_ln392_1_cast_fu_181_p1(5 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln28_1_fu_250_p2 <= std_logic_vector(unsigned(zext_ln28_2_fu_246_p1) + unsigned(zext_ln392_1_cast_reg_296));
    add_ln28_fu_226_p2 <= std_logic_vector(unsigned(zext_ln28_fu_222_p1) + unsigned(zext_ln392_1_cast_reg_296));
    ap_CS_fsm_pp0_stage0 <= ap_CS_fsm(0);
        ap_block_pp0_stage0 <= not((ap_const_boolean_1 = ap_const_boolean_1));
        ap_block_pp0_stage0_11001 <= not((ap_const_boolean_1 = ap_const_boolean_1));
        ap_block_pp0_stage0_subdone <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln392_fu_193_p2)
    begin
        if (((icmp_ln392_fu_193_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    i_279_fu_199_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i) + unsigned(ap_const_lv5_1));
    icmp_ln392_fu_193_p2 <= "1" when (ap_sig_allocacmp_i = ap_const_lv5_11) else "0";
    in_0_address0 <= zext_ln28_3_fu_255_p1(7 - 1 downto 0);
    in_0_address1 <= zext_ln28_1_fu_231_p1(7 - 1 downto 0);
    ...
    in_1_address0 <= zext_ln28_3_fu_255_p1(7 - 1 downto 0);
    in_1_address1 <= zext_ln28_1_fu_231_p1(7 - 1 downto 0);
    ...
    in_2_address0 <= zext_ln28_3_fu_255_p1(7 - 1 downto 0);
    in_2_address1 <= zext_ln28_1_fu_231_p1(7 - 1 downto 0);
    ...
    in_3_address0 <= zext_ln28_3_fu_255_p1(7 - 1 downto 0);
    in_3_address1 <= zext_ln28_1_fu_231_p1(7 - 1 downto 0);
    ...
    or_ln28_fu_239_p3 <= (i_reg_302 & ap_const_lv1_1);
    or_ln395_6_fu_263_p9 <= (((((((in_3_q0 & in_2_q0) & in_1_q0) & in_0_q0) & in_3_q1) & in_2_q1) & in_1_q1) & in_0_q1);
    s_address0 <= s_addr_reg_312_pp0_iter1_reg;
    s_address1 <= zext_ln392_fu_205_p1(5 - 1 downto 0);
    s_ce0 <= s_ce0_local;
    ...
    shl_ln_fu_215_p3 <= (i_reg_302 & ap_const_lv1_0);
    xor_ln395_fu_283_p2 <= (s_load_reg_358 xor or_ln395_6_fu_263_p9);
    zext_ln28_1_fu_231_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln28_fu_226_p2),64));
    zext_ln28_2_fu_246_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(or_ln28_fu_239_p3),7));
    zext_ln28_3_fu_255_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln28_1_fu_250_p2),64));
    zext_ln28_fu_222_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln_fu_215_p3),7));
    zext_ln392_1_cast_fu_181_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln392_1),7));
    zext_ln392_fu_205_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i),64));
end behav;
