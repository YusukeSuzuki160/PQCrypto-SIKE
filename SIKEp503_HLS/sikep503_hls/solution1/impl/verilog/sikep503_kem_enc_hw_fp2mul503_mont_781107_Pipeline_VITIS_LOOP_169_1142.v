...
module sikep503_kem_enc_hw_fp2mul503_mont_781107_Pipeline_VITIS_LOOP_169_1142 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire    ap_loop_init;
wire   [31:0] zext_ln170_5_fu_108_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tt2_addr_reg_209 <= zext_ln170_5_fu_108_p1;
...
assign xor_ln170_fu_170_p2 = (tmp_254_fu_162_p3 ^ 1'd1);

assign zext_ln170_2_fu_188_p1 = borrow_reg_72;

assign zext_ln170_5_fu_108_p1 = trunc_ln170_fu_104_p1;

endmodule //sikep503_kem_enc_hw_fp2mul503_mont_781107_Pipeline_VITIS_LOOP_169_1142
