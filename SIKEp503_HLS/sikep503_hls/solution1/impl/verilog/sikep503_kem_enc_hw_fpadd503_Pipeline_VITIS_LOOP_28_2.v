...
wire    ap_loop_init;
wire   [31:0] zext_ln29_1_fu_120_p1;
reg   [3:0] i_153_fu_42;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        c_addr_reg_225 <= zext_ln29_1_fu_120_p1;
...
assign c_address1 = zext_ln29_1_fu_120_p1;
...
assign p503x2_1_address0 = zext_ln29_1_fu_120_p1;
...
assign tmp_195_fu_179_p3 = or_ln95_fu_174_p2[32'd63];
...
assign xor_ln29_fu_187_p2 = (tmp_195_fu_179_p3 ^ 1'd1);

assign zext_ln29_1_fu_120_p1 = trunc_ln29_fu_116_p1;
