...
wire   [0:0] exitcond710_fu_139_p2;
...
reg   [6:0] loop_index3_udiv_cast_reg_209;
reg   [6:0] loop_index3_udiv_cast_reg_209_pp0_iter1_reg;
reg   [7:0] gmem_addr_read_reg_214;
wire   [63:0] p_cast_fu_181_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [8:0] loop_index3_fu_64;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond710_fu_139_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index3_fu_64 <= empty_fu_145_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index3_fu_64 <= 9'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        loop_index3_udiv_cast_reg_209 <= {{ap_sig_allocacmp_loop_index3_load[8:2]}};
        loop_index3_udiv_cast_reg_209_pp0_iter1_reg <= loop_index3_udiv_cast_reg_209;
    end
end
...
always @ (*) begin
    if (((exitcond710_fu_139_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_loop_index3_load = loop_index3_fu_64;
    end
end
...
assign empty_177_fu_157_p1 = ap_sig_allocacmp_loop_index3_load[1:0];

assign empty_178_fu_176_p2 = (loop_index3_udiv_cast_reg_209_pp0_iter1_reg + 7'd6);

assign empty_fu_145_p2 = (ap_sig_allocacmp_loop_index3_load + 9'd1);

assign exitcond710_fu_139_p2 = ((ap_sig_allocacmp_loop_index3_load == 9'd378) ? 1'b1 : 1'b0);
...
assign p_cast_fu_181_p1 = empty_178_fu_176_p2;
