...
module sikep503_kem_enc_hw_cshake256_simple_29_Pipeline_VITIS_LOOP_668_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [1:0] trunc_ln668_fu_168_p1;
reg   [1:0] trunc_ln668_reg_234;
wire   [7:0] tmp_fu_195_p11;
reg   [7:0] tmp_reg_259;
wire   [63:0] zext_ln640_fu_182_p1;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [4:0] i_355_fu_72;
wire   [4:0] add_ln668_fu_156_p2;
wire    ap_loop_init;
...
reg    t_292_ce0_local;
reg    t_293_ce0_local;
wire   [1:0] lshr_ln_fu_172_p4;
wire   [7:0] tmp_fu_195_p9;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_fu_195_p1;
wire   [1:0] tmp_fu_195_p3;
wire  signed [1:0] tmp_fu_195_p5;
wire  signed [1:0] tmp_fu_195_p7;
wire    ap_ce_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln668_fu_150_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_355_fu_72 <= add_ln668_fu_156_p2;
...
always @ (*) begin
    if (((icmp_ln668_fu_150_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_i = i_355_fu_72;
    end
end
...
assign add_ln668_fu_156_p2 = (ap_sig_allocacmp_i + 5'd1);
...
assign icmp_ln668_fu_150_p2 = ((ap_sig_allocacmp_i == 5'd16) ? 1'b1 : 1'b0);

assign lshr_ln_fu_172_p4 = {{ap_sig_allocacmp_i[3:2]}};
...
assign m_axi_gmem_0_WDATA = tmp_reg_259;
...
assign t_291_address0 = zext_ln640_fu_182_p1;

assign t_291_ce0 = t_291_ce0_local;

assign t_292_address0 = zext_ln640_fu_182_p1;

assign t_292_ce0 = t_292_ce0_local;

assign t_293_address0 = zext_ln640_fu_182_p1;

assign t_293_ce0 = t_293_ce0_local;

assign t_address0 = zext_ln640_fu_182_p1;

assign t_ce0 = t_ce0_local;

assign tmp_fu_195_p9 = 'bx;

assign trunc_ln668_fu_168_p1 = ap_sig_allocacmp_i[1:0];

assign zext_ln640_fu_182_p1 = lshr_ln_fu_172_p4;

endmodule //sikep503_kem_enc_hw_cshake256_simple_29_Pipeline_VITIS_LOOP_668_1
