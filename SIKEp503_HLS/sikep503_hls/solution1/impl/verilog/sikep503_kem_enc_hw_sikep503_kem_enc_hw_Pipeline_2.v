...
module sikep503_kem_enc_hw_sikep503_kem_enc_hw_Pipeline_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] exitcond7_i5_fu_84_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg    gmem_blk_n_R;
wire    ap_block_pp0_stage0_grp1;
reg   [8:0] loop_index3_i_load_reg_124;
reg    ap_block_pp0_stage0_11001;
reg   [8:0] loop_index3_i_load_reg_124_pp0_iter1_reg;
reg    ap_block_pp0_stage0_11001_grp1;
reg   [7:0] gmem_addr_read_reg_138;
wire   [63:0] arrayidx_sum_i_cast_fu_112_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [8:0] loop_index3_i_fu_48;
wire   [8:0] empty_fu_90_p2;
wire    ap_loop_init;
...
reg    temp_ce0_local;
wire   [8:0] arrayidx_sum_i_fu_107_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond7_i5_fu_84_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index3_i_fu_48 <= empty_fu_90_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index3_i_fu_48 <= 9'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        loop_index3_i_load_reg_124 <= ap_sig_allocacmp_loop_index3_i_load;
        loop_index3_i_load_reg_124_pp0_iter1_reg <= loop_index3_i_load_reg_124;
    end
end
...
always @ (*) begin
    if (((exitcond7_i5_fu_84_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_loop_index3_i_load = loop_index3_i_fu_48;
    end
end
...
assign arrayidx_sum_i_cast_fu_112_p1 = arrayidx_sum_i_fu_107_p2;

assign arrayidx_sum_i_fu_107_p2 = (loop_index3_i_load_reg_124_pp0_iter1_reg + 9'd24);

assign empty_fu_90_p2 = (ap_sig_allocacmp_loop_index3_i_load + 9'd1);

assign exitcond7_i5_fu_84_p2 = ((ap_sig_allocacmp_loop_index3_i_load == 9'd378) ? 1'b1 : 1'b0);
...
assign temp_address0 = arrayidx_sum_i_cast_fu_112_p1;

assign temp_ce0 = temp_ce0_local;

assign temp_d0 = gmem_addr_read_reg_138;

assign temp_we0 = temp_we0_local;

endmodule //sikep503_kem_enc_hw_sikep503_kem_enc_hw_Pipeline_2
