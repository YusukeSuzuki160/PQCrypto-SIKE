...
module sikep503_kem_enc_hw_cshake256_simple_1_Pipeline_VITIS_LOOP_663_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   t_145_ce0;
input  [7:0] t_145_q0;
output  [5:0] t_146_address0;
output   t_146_ce0;
input  [7:0] t_146_q0;
output  [5:0] t_147_address0;
output   t_147_ce0;
input  [7:0] t_147_q0;
...
wire   [1:0] trunc_ln663_fu_170_p1;
reg   [1:0] trunc_ln663_reg_236;
wire   [7:0] tmp_fu_197_p11;
reg   [7:0] tmp_reg_261;
wire   [63:0] zext_ln635_fu_184_p1;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [4:0] i_252_fu_74;
wire   [4:0] add_ln663_fu_158_p2;
wire    ap_loop_init;
...
reg    t_146_ce0_local;
reg    t_147_ce0_local;
wire   [1:0] lshr_ln_fu_174_p4;
wire   [7:0] tmp_fu_197_p9;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln663_fu_152_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_252_fu_74 <= add_ln663_fu_158_p2;
...
always @ (*) begin
    if (((icmp_ln663_fu_152_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        t_146_ce0_local = 1'b1;
    end else begin
        t_146_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        t_147_ce0_local = 1'b1;
    end else begin
        t_147_ce0_local = 1'b0;
    end
end
...
assign add_ln663_fu_158_p2 = (ap_sig_allocacmp_i + 5'd1);
...
assign icmp_ln663_fu_152_p2 = ((ap_sig_allocacmp_i == 5'd16) ? 1'b1 : 1'b0);

assign lshr_ln_fu_174_p4 = {{ap_sig_allocacmp_i[3:2]}};
...
assign m_axi_gmem_0_WDATA = tmp_reg_261;
...
assign t_145_address0 = zext_ln635_fu_184_p1;

assign t_145_ce0 = t_145_ce0_local;

assign t_146_address0 = zext_ln635_fu_184_p1;

assign t_146_ce0 = t_146_ce0_local;

assign t_147_address0 = zext_ln635_fu_184_p1;

assign t_147_ce0 = t_147_ce0_local;

assign t_address0 = zext_ln635_fu_184_p1;

assign t_ce0 = t_ce0_local;

assign tmp_fu_197_p9 = 'bx;

assign trunc_ln663_fu_170_p1 = ap_sig_allocacmp_i[1:0];

assign zext_ln635_fu_184_p1 = lshr_ln_fu_174_p4;

endmodule //sikep503_kem_enc_hw_cshake256_simple_1_Pipeline_VITIS_LOOP_663_1
