...
module sikep503_kem_enc_hw_crypto_kem_enc_1_Pipeline_VITIS_LOOP_566_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [1:0] trunc_ln566_fu_170_p1;
reg   [1:0] trunc_ln566_reg_236;
wire   [7:0] tmp_s_fu_197_p11;
reg   [7:0] tmp_s_reg_261;
wire   [63:0] zext_ln555_fu_184_p1;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [4:0] i_243_fu_74;
wire   [4:0] add_ln566_fu_158_p2;
wire    ap_loop_init;
...
(* dissolve_hierarchy = "yes" *) sikep503_kem_enc_hw_sparsemux_9_2_8_1_1 #(
    ...
    .sel_WIDTH( 2 ),
    .dout_WIDTH( 8 ))
sparsemux_9_2_8_1_1_U3101(
    .din0(t_q0),
    .din1(t_72_q0),
    .din2(t_73_q0),
    .din3(t_74_q0),
    .def(tmp_s_fu_197_p9),
    .sel(trunc_ln566_reg_236),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln566_fu_152_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_243_fu_74 <= add_ln566_fu_158_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln566_reg_236 <= trunc_ln566_fu_170_p1;
    end
end

always @ (*) begin
    if (((icmp_ln566_fu_152_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_i = i_243_fu_74;
    end
end
...
assign add_ln566_fu_158_p2 = (ap_sig_allocacmp_i + 5'd1);
...
assign icmp_ln566_fu_152_p2 = ((ap_sig_allocacmp_i == 5'd16) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_0_WDATA = tmp_s_reg_261;
...
assign t_72_address0 = zext_ln555_fu_184_p1;

assign t_72_ce0 = t_72_ce0_local;

assign t_73_address0 = zext_ln555_fu_184_p1;

assign t_73_ce0 = t_73_ce0_local;

assign t_74_address0 = zext_ln555_fu_184_p1;

assign t_74_ce0 = t_74_ce0_local;

assign t_address0 = zext_ln555_fu_184_p1;

assign t_ce0 = t_ce0_local;

assign tmp_s_fu_197_p9 = 'bx;

assign trunc_ln566_fu_170_p1 = ap_sig_allocacmp_i[1:0];

assign zext_ln555_fu_184_p1 = lshr_ln_fu_174_p4;

endmodule //sikep503_kem_enc_hw_crypto_kem_enc_1_Pipeline_VITIS_LOOP_566_1
