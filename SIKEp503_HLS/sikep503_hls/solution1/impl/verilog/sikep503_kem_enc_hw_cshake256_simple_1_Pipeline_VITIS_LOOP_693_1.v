...
module sikep503_kem_enc_hw_cshake256_simple_1_Pipeline_VITIS_LOOP_693_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [1:0] trunc_ln693_fu_170_p1;
reg   [1:0] trunc_ln693_reg_236;
wire   [7:0] tmp_fu_197_p11;
reg   [7:0] tmp_reg_261;
wire   [63:0] zext_ln665_fu_184_p1;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [4:0] i_261_fu_74;
wire   [4:0] add_ln693_fu_158_p2;
wire    ap_loop_init;
...
(* dissolve_hierarchy = "yes" *) sikep503_kem_enc_hw_sparsemux_9_2_8_1_1 #(
    ...
    .sel_WIDTH( 2 ),
    .dout_WIDTH( 8 ))
sparsemux_9_2_8_1_1_U3354(
    .din0(t_q0),
    .din1(t_145_q0),
    .din2(t_146_q0),
    .din3(t_147_q0),
    .def(tmp_fu_197_p9),
    .sel(trunc_ln693_reg_236),
    .dout(tmp_fu_197_p11)
);
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln693_fu_152_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_261_fu_74 <= add_ln693_fu_158_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln693_reg_236 <= trunc_ln693_fu_170_p1;
    end
end

always @ (*) begin
    if (((icmp_ln693_fu_152_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_i = i_261_fu_74;
    end
end
...
assign add_ln693_fu_158_p2 = (ap_sig_allocacmp_i + 5'd1);
...
assign icmp_ln693_fu_152_p2 = ((ap_sig_allocacmp_i == 5'd16) ? 1'b1 : 1'b0);
...
assign t_145_address0 = zext_ln665_fu_184_p1;

assign t_145_ce0 = t_145_ce0_local;

assign t_146_address0 = zext_ln665_fu_184_p1;

assign t_146_ce0 = t_146_ce0_local;

assign t_147_address0 = zext_ln665_fu_184_p1;

assign t_147_ce0 = t_147_ce0_local;

assign t_address0 = zext_ln665_fu_184_p1;

assign t_ce0 = t_ce0_local;

assign tmp_fu_197_p9 = 'bx;

assign trunc_ln693_fu_170_p1 = ap_sig_allocacmp_i[1:0];

assign zext_ln665_fu_184_p1 = lshr_ln_fu_174_p4;

endmodule //sikep503_kem_enc_hw_cshake256_simple_1_Pipeline_VITIS_LOOP_693_1
