...
module sikep503_kem_enc_hw_crypto_kem_enc_1_Pipeline_VITIS_LOOP_59_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [1:0] trunc_ln59_fu_190_p1;
reg   [1:0] trunc_ln59_reg_262;
wire   [7:0] xor_ln61_fu_240_p2;
reg   [7:0] xor_ln61_reg_292;
wire   [63:0] zext_ln44_fu_204_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln59_fu_185_p1;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [4:0] i_256_fu_76;
wire   [4:0] add_ln59_1_fu_173_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln59_fu_167_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_256_fu_76 <= add_ln59_1_fu_173_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln59_reg_262 <= trunc_ln59_fu_190_p1;
        xor_ln61_reg_292 <= xor_ln61_fu_240_p2;
    end
end
...
assign add_ln59_1_fu_173_p2 = (ap_sig_allocacmp_i + 5'd1);
...
assign h_address0 = zext_ln59_fu_185_p1;

assign h_ce0 = h_ce0_local;

assign icmp_ln59_fu_167_p2 = ((ap_sig_allocacmp_i == 5'd24) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_0_WDATA = xor_ln61_reg_292;
...
assign trunc_ln59_fu_190_p1 = ap_sig_allocacmp_i[1:0];

assign xor_ln61_fu_240_p2 = (tmp_fu_217_p11 ^ h_q0);

assign zext_ln44_fu_204_p1 = lshr_ln_fu_194_p4;

assign zext_ln59_fu_185_p1 = ap_sig_allocacmp_i;

endmodule //sikep503_kem_enc_hw_crypto_kem_enc_1_Pipeline_VITIS_LOOP_59_1
