...
module sikep503_kem_enc_hw_EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_42_1261 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [3:0] t_i421_address0;
output   t_i421_ce0;
input  [63:0] t_i421_q0;
output  [3:0] t_i421_address1;
output   t_i421_ce1;
input  [63:0] t_i421_q1;
...
reg   [63:0] t_i421_load_1_reg_305;
...
reg    t_i421_ce1_local;
reg    t_i421_ce0_local;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage1_11001_grp0))) begin
        t_i421_load_1_reg_305 <= t_i421_q0;
        t_i421_load_reg_294 <= t_i421_q1;
    end
end
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        t_i421_ce0_local = 1'b1;
    end else begin
        t_i421_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        t_i421_ce1_local = 1'b1;
    end else begin
        t_i421_ce1_local = 1'b0;
    end
end
...
assign lshr_ln44_fu_243_p2 = t_i421_load_reg_294 >> zext_ln44_2_fu_239_p1;

assign lshr_ln45_fu_252_p2 = t_i421_load_1_reg_305 >> zext_ln44_2_reg_316;
...
assign t_i421_address0 = zext_ln45_fu_174_p1;

assign t_i421_address1 = zext_ln44_fu_161_p1;

assign t_i421_ce0 = t_i421_ce0_local;

assign t_i421_ce1 = t_i421_ce1_local;
...
endmodule //sikep503_kem_enc_hw_EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_42_1261
