...
module sikep503_kem_enc_hw_cshake256_simple_1_Pipeline_VITIS_LOOP_667_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [1:0] trunc_ln667_fu_170_p1;
reg   [1:0] trunc_ln667_reg_236;
wire   [7:0] tmp_fu_197_p11;
reg   [7:0] tmp_reg_261;
wire   [63:0] zext_ln639_fu_184_p1;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [4:0] i_269_fu_74;
wire   [4:0] add_ln667_fu_158_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln667_fu_152_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln667_fu_152_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln667_fu_158_p2 = (ap_sig_allocacmp_i + 5'd1);
...
assign icmp_ln667_fu_152_p2 = ((ap_sig_allocacmp_i == 5'd16) ? 1'b1 : 1'b0);
...
assign t_148_address0 = zext_ln639_fu_184_p1;

assign t_148_ce0 = t_148_ce0_local;

assign t_149_address0 = zext_ln639_fu_184_p1;

assign t_149_ce0 = t_149_ce0_local;

assign t_150_address0 = zext_ln639_fu_184_p1;

assign t_150_ce0 = t_150_ce0_local;

assign t_151_address0 = zext_ln639_fu_184_p1;

assign t_151_ce0 = t_151_ce0_local;

assign tmp_fu_197_p9 = 'bx;

assign trunc_ln667_fu_170_p1 = ap_sig_allocacmp_i[1:0];

assign zext_ln639_fu_184_p1 = lshr_ln_fu_174_p4;

endmodule //sikep503_kem_enc_hw_cshake256_simple_1_Pipeline_VITIS_LOOP_667_1
