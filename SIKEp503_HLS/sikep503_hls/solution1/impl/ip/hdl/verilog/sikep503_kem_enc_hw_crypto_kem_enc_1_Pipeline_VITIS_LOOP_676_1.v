...
module sikep503_kem_enc_hw_crypto_kem_enc_1_Pipeline_VITIS_LOOP_676_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [1:0] trunc_ln676_fu_170_p1;
reg   [1:0] trunc_ln676_reg_236;
wire   [7:0] tmp_s_fu_197_p11;
reg   [7:0] tmp_s_reg_261;
wire   [63:0] zext_ln648_fu_184_p1;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [4:0] i_258_fu_74;
wire   [4:0] add_ln676_fu_158_p2;
wire    ap_loop_init;
...
(* dissolve_hierarchy = "yes" *) sikep503_kem_enc_hw_sparsemux_9_2_8_1_1 #(
    ...
    .sel_WIDTH( 2 ),
    .dout_WIDTH( 8 ))
sparsemux_9_2_8_1_1_U3320(
    .din0(t_q0),
    .din1(t_78_q0),
    .din2(t_79_q0),
    .din3(t_80_q0),
    .def(tmp_s_fu_197_p9),
    .sel(trunc_ln676_reg_236),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln676_fu_152_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_258_fu_74 <= add_ln676_fu_158_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln676_reg_236 <= trunc_ln676_fu_170_p1;
    end
end

always @ (*) begin
    if (((icmp_ln676_fu_152_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln676_fu_158_p2 = (ap_sig_allocacmp_i + 5'd1);
...
assign icmp_ln676_fu_152_p2 = ((ap_sig_allocacmp_i == 5'd16) ? 1'b1 : 1'b0);
...
assign t_78_address0 = zext_ln648_fu_184_p1;

assign t_78_ce0 = t_78_ce0_local;

assign t_79_address0 = zext_ln648_fu_184_p1;

assign t_79_ce0 = t_79_ce0_local;

assign t_80_address0 = zext_ln648_fu_184_p1;

assign t_80_ce0 = t_80_ce0_local;

assign t_address0 = zext_ln648_fu_184_p1;

assign t_ce0 = t_ce0_local;

assign tmp_s_fu_197_p9 = 'bx;

assign trunc_ln676_fu_170_p1 = ap_sig_allocacmp_i[1:0];

assign zext_ln648_fu_184_p1 = lshr_ln_fu_174_p4;

endmodule //sikep503_kem_enc_hw_crypto_kem_enc_1_Pipeline_VITIS_LOOP_676_1
