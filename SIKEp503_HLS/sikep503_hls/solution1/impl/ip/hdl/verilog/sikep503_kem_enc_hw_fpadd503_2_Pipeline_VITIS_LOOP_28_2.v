...
wire    ap_loop_init;
wire   [63:0] zext_ln29_7_fu_138_p1;
...
wire   [5:0] zext_ln29_6_fu_130_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        coeff_addr_reg_237[2 : 0] <= zext_ln29_7_fu_138_p1[2 : 0];
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        ...
        coeff_address0_local = zext_ln29_7_fu_138_p1;
    end else begin
...
assign tmp_191_fu_191_p3 = or_ln95_fu_186_p2[32'd63];
...
assign xor_ln29_fu_199_p2 = (tmp_191_fu_191_p3 ^ 1'd1);

assign zext_ln28_fu_121_p1 = ap_sig_allocacmp_i;

assign zext_ln29_6_fu_130_p3 = {{3'd5}, {trunc_ln29_fu_126_p1}};

assign zext_ln29_7_fu_138_p1 = zext_ln29_6_fu_130_p3;
