...
attribute shreg_extract : string;
    ...
    signal zext_ln416_1_cast_reg_296 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal or_ln419_6_fu_263_p9 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                s_addr_reg_312 <= zext_ln416_fu_205_p1(5 - 1 downto 0);
                s_addr_reg_312_pp0_iter1_reg <= s_addr_reg_312;
                    zext_ln416_1_cast_reg_296(5 downto 0) <= zext_ln416_1_cast_fu_181_p1(5 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln28_1_fu_250_p2 <= std_logic_vector(unsigned(zext_ln28_2_fu_246_p1) + unsigned(zext_ln416_1_cast_reg_296));
    add_ln28_fu_226_p2 <= std_logic_vector(unsigned(zext_ln28_fu_222_p1) + unsigned(zext_ln416_1_cast_reg_296));
    ...
    or_ln419_6_fu_263_p9 <= (((((((in_3_q0 & in_2_q0) & in_1_q0) & in_0_q0) & in_3_q1) & in_2_q1) & in_1_q1) & in_0_q1);
    ...
    xor_ln419_fu_283_p2 <= (s_load_reg_358 xor or_ln419_6_fu_263_p9);
