...
entity sikep503_kem_enc_hw_LADDER3PT_1_Pipeline_VITIS_LOOP_267_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sikep503_kem_enc_hw_LADDER3PT_1_Pipeline_VITIS_LOOP_267_1 is 
...
attribute shreg_extract : string;
    ...
    signal R2_X_4_addr_reg_328 : STD_LOGIC_VECTOR (2 downto 0);
    signal R2_Z_addr_reg_333 : STD_LOGIC_VECTOR (2 downto 0);
    signal R2_Z_4_addr_reg_338 : STD_LOGIC_VECTOR (2 downto 0);
    signal R_X_addr_reg_343 : STD_LOGIC_VECTOR (3 downto 0);
    signal R_Z_addr_reg_348 : STD_LOGIC_VECTOR (3 downto 0);
    signal R_X_addr_5_reg_353 : STD_LOGIC_VECTOR (3 downto 0);
    signal R_Z_addr_10_reg_358 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal R_X_load_4_reg_381 : STD_LOGIC_VECTOR (63 downto 0);
    signal R_Z_load_6_reg_387 : STD_LOGIC_VECTOR (63 downto 0);
    signal R2_X_4_load_reg_393 : STD_LOGIC_VECTOR (63 downto 0);
    signal R2_Z_load_reg_399 : STD_LOGIC_VECTOR (63 downto 0);
    signal R2_Z_4_load_reg_405 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln269_fu_192_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln275_fu_210_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_282_fu_48 : STD_LOGIC_VECTOR (3 downto 0) := "0000";
    ...
    signal temp_103_fu_246_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal xor_ln272_fu_263_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal temp_102_fu_267_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal xor_ln278_fu_284_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal temp_104_fu_288_p2 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    i_282_fu_48_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                if ((icmp_ln267_fu_176_p2 = ap_const_lv1_0)) then 
                    i_282_fu_48 <= add_ln267_fu_182_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    i_282_fu_48 <= ap_const_lv4_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                R2_X_4_addr_reg_328 <= zext_ln269_fu_192_p1(3 - 1 downto 0);
                R2_X_addr_reg_323 <= zext_ln269_fu_192_p1(3 - 1 downto 0);
                R2_Z_4_addr_reg_338 <= zext_ln269_fu_192_p1(3 - 1 downto 0);
                R2_Z_addr_reg_333 <= zext_ln269_fu_192_p1(3 - 1 downto 0);
                    R_X_addr_5_reg_353(2 downto 0) <= zext_ln275_fu_210_p1(4 - 1 downto 0)(2 downto 0);
                    R_X_addr_reg_343(2 downto 0) <= zext_ln269_fu_192_p1(4 - 1 downto 0)(2 downto 0);
                    R_Z_addr_10_reg_358(2 downto 0) <= zext_ln275_fu_210_p1(4 - 1 downto 0)(2 downto 0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                R2_X_4_load_reg_393 <= R2_X_4_q0;
                R2_X_load_reg_369 <= R2_X_q0;
                R2_Z_4_load_reg_405 <= R2_Z_4_q0;
                R2_Z_load_reg_399 <= R2_Z_q0;
                R_X_load_4_reg_381 <= R_X_q0;
                R_X_load_reg_363 <= R_X_q1;
                R_Z_load_6_reg_387 <= R_Z_q0;
    ...
    R_X_addr_5_reg_353(3) <= '1';
    R_Z_addr_10_reg_358(3) <= '1';
    ...
    R2_X_4_address0_local_assign_proc : process(ap_CS_fsm_state1, icmp_ln267_fu_176_p2, ap_CS_fsm_state3, R2_X_4_addr_reg_328, zext_ln269_fu_192_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            R2_X_4_address0_local <= R2_X_4_addr_reg_328;
        elsif (((icmp_ln267_fu_176_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            R2_X_4_address0_local <= zext_ln269_fu_192_p1(3 - 1 downto 0);
        else 
    ...
    R2_X_4_ce0_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, icmp_ln267_fu_176_p2, ap_CS_fsm_state3)
    begin
    ...
    R2_Z_4_address0_local_assign_proc : process(ap_CS_fsm_state1, icmp_ln267_fu_176_p2, ap_CS_fsm_state3, R2_Z_4_addr_reg_338, zext_ln269_fu_192_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            R2_Z_4_address0_local <= R2_Z_4_addr_reg_338;
        elsif (((icmp_ln267_fu_176_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            R2_Z_4_address0_local <= zext_ln269_fu_192_p1(3 - 1 downto 0);
        else 
    ...
    R2_Z_4_ce0_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, icmp_ln267_fu_176_p2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) or ((icmp_ln267_fu_176_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
    ...
    R_X_address0_local_assign_proc : process(ap_CS_fsm_state1, icmp_ln267_fu_176_p2, ap_CS_fsm_state3, R_X_addr_5_reg_353, zext_ln275_fu_210_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            R_X_address0_local <= R_X_addr_5_reg_353;
        elsif (((icmp_ln267_fu_176_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    R_Z_address0_local_assign_proc : process(ap_CS_fsm_state1, icmp_ln267_fu_176_p2, ap_CS_fsm_state3, R_Z_addr_10_reg_358, zext_ln275_fu_210_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            R_Z_address0_local <= R_Z_addr_10_reg_358;
        elsif (((icmp_ln267_fu_176_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    ap_sig_allocacmp_i_assign_proc : process(ap_CS_fsm_state1, i_282_fu_48, ap_loop_init)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_i <= ap_const_lv4_0;
        else 
            ap_sig_allocacmp_i <= i_282_fu_48;
        end if; 
    end process;
    ...
    sext_ln288_cast_fu_160_p3 <= 
        ...
        ap_const_lv64_0;
    temp_102_fu_267_p2 <= (xor_ln272_fu_263_p2 and sext_ln288_cast_reg_312);
    temp_103_fu_246_p2 <= (xor_ln275_fu_242_p2 and sext_ln288_cast_reg_312);
    temp_104_fu_288_p2 <= (xor_ln278_fu_284_p2 and sext_ln288_cast_reg_312);
    ...
    xor_ln273_fu_272_p2 <= (temp_102_fu_267_p2 xor R_Z_load_reg_375);
    xor_ln274_fu_278_p2 <= (temp_102_fu_267_p2 xor R2_Z_load_reg_399);
    xor_ln275_fu_242_p2 <= (R_X_load_4_reg_381 xor R2_X_4_load_reg_393);
    xor_ln276_fu_251_p2 <= (temp_103_fu_246_p2 xor R_X_load_4_reg_381);
    xor_ln277_fu_257_p2 <= (temp_103_fu_246_p2 xor R2_X_4_load_reg_393);
    xor_ln278_fu_284_p2 <= (R_Z_load_6_reg_387 xor R2_Z_4_load_reg_405);
    xor_ln279_fu_293_p2 <= (temp_104_fu_288_p2 xor R_Z_load_6_reg_387);
    xor_ln280_fu_299_p2 <= (temp_104_fu_288_p2 xor R2_Z_4_load_reg_405);
