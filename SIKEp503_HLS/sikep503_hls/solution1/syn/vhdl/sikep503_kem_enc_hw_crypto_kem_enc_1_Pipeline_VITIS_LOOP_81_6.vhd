...
attribute shreg_extract : string;
    ...
    signal i_256_fu_76 : STD_LOGIC_VECTOR (4 downto 0) := "00000";
...
begin
    sparsemux_9_2_8_1_1_U3301 : component sikep503_kem_enc_hw_sparsemux_9_2_8_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00",
    ...
    ap_sig_allocacmp_i_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_256_fu_76, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_i <= ap_const_lv5_0;
        else 
            ap_sig_allocacmp_i <= i_256_fu_76;
        end if; 
    end process;
