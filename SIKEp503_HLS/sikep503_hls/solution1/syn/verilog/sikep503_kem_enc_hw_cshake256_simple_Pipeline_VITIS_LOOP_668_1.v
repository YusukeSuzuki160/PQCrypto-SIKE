...
module sikep503_kem_enc_hw_cshake256_simple_Pipeline_VITIS_LOOP_668_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire    ap_loop_init;
reg   [5:0] ap_sig_allocacmp_i_358;
reg    t_ce0_local;
reg    t_78_ce0_local;
reg    t_79_ce0_local;
reg    t_80_ce0_local;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_358_reg_205 <= ap_sig_allocacmp_i_358;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_i_358 = 6'd0;
    end else begin
        ap_sig_allocacmp_i_358 = i_fu_54;
    end
end
...
assign add_ln668_fu_137_p2 = (ap_sig_allocacmp_i_358 + 6'd1);
...
assign ephemeralsk_i_address0 = zext_ln668_fu_166_p1;
...
assign icmp_ln668_fu_131_p2 = ((ap_sig_allocacmp_i_358 == 6'd32) ? 1'b1 : 1'b0);

assign lshr_ln_fu_143_p4 = {{ap_sig_allocacmp_i_358[4:2]}};
...
assign t_80_address0 = zext_ln640_fu_153_p1;
...
assign tmp_fu_173_p10 = i_358_reg_205[1:0];

assign tmp_fu_173_p9 = 'bx;

assign zext_ln640_fu_153_p1 = lshr_ln_fu_143_p4;

assign zext_ln668_fu_166_p1 = i_358_reg_205;
