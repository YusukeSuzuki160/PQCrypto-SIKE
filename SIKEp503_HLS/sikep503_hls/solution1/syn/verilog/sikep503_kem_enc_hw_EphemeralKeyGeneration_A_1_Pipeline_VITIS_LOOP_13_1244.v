...
module sikep503_kem_enc_hw_EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_13_1244 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_321_reg_136 <= ap_sig_allocacmp_i_321;
    end
end
...
assign tmp_s_fu_113_p3 = {{npts_5}, {i_321_reg_136}};

assign zext_ln13_fu_103_p1 = ap_sig_allocacmp_i_321;

assign zext_ln14_12_fu_119_p1 = tmp_s_fu_113_p3;

endmodule //sikep503_kem_enc_hw_EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_13_1244
