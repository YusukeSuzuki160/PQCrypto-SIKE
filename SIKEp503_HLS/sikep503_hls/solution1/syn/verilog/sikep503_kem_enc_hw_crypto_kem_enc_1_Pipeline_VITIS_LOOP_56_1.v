...
module sikep503_kem_enc_hw_crypto_kem_enc_1_Pipeline_VITIS_LOOP_56_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [1:0] trunc_ln56_fu_183_p1;
reg   [1:0] trunc_ln56_reg_266;
wire   [7:0] xor_ln56_fu_238_p2;
reg   [7:0] xor_ln56_reg_296;
wire   [31:0] zext_ln56_fu_197_p1;
wire    ap_block_pp0_stage0;
wire   [31:0] zext_ln56_8_fu_205_p1;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [4:0] i_256_fu_74;
wire   [4:0] add_ln56_4_fu_177_p2;
wire    ap_loop_init;
...
reg    h_ce0_local;
wire   [2:0] lshr_ln_fu_187_p4;
wire   [7:0] tmp_fu_215_p9;
wire   [7:0] tmp_fu_215_p11;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_fu_215_p1;
wire   [1:0] tmp_fu_215_p3;
wire  signed [1:0] tmp_fu_215_p5;
wire  signed [1:0] tmp_fu_215_p7;
wire    ap_ce_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln56_fu_171_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln56_fu_171_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln56_4_fu_177_p2 = (ap_sig_allocacmp_i + 5'd1);
...
assign h_address0 = zext_ln56_8_fu_205_p1;

assign h_ce0 = h_ce0_local;

assign icmp_ln56_fu_171_p2 = ((ap_sig_allocacmp_i == 5'd24) ? 1'b1 : 1'b0);

assign lshr_ln_fu_187_p4 = {{ap_sig_allocacmp_i[4:2]}};
...
assign m_axi_gmem0_0_WDATA = xor_ln56_reg_296;
...
assign temp_1_address0 = zext_ln56_fu_197_p1;

assign temp_1_ce0 = temp_1_ce0_local;

assign temp_2_address0 = zext_ln56_fu_197_p1;

assign temp_2_ce0 = temp_2_ce0_local;

assign temp_3_address0 = zext_ln56_fu_197_p1;

assign temp_3_ce0 = temp_3_ce0_local;

assign temp_address0 = zext_ln56_fu_197_p1;

assign temp_ce0 = temp_ce0_local;

assign tmp_fu_215_p9 = 'bx;

assign trunc_ln56_fu_183_p1 = ap_sig_allocacmp_i[1:0];

assign xor_ln56_fu_238_p2 = (tmp_fu_215_p11 ^ h_q0);

assign zext_ln56_8_fu_205_p1 = ap_sig_allocacmp_i;

assign zext_ln56_fu_197_p1 = lshr_ln_fu_187_p4;

endmodule //sikep503_kem_enc_hw_crypto_kem_enc_1_Pipeline_VITIS_LOOP_56_1
