...
module sikep503_kem_enc_hw_sikep503_kem_enc_hw_Pipeline_VITIS_LOOP_59_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [1:0] trunc_ln59_fu_192_p1;
reg   [1:0] trunc_ln59_reg_264;
wire   [7:0] xor_ln61_fu_242_p2;
reg   [7:0] xor_ln61_reg_294;
wire   [63:0] zext_ln44_fu_206_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln59_fu_187_p1;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [4:0] i_fu_78;
wire   [4:0] add_ln59_1_fu_175_p2;
wire    ap_loop_init;
...
reg    h_ce0_local;
wire   [2:0] lshr_ln1_fu_196_p4;
wire   [7:0] tmp_fu_219_p9;
wire   [7:0] tmp_fu_219_p11;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_fu_219_p1;
wire   [1:0] tmp_fu_219_p3;
wire  signed [1:0] tmp_fu_219_p5;
wire  signed [1:0] tmp_fu_219_p7;
wire    ap_ce_reg;
...
(* dissolve_hierarchy = "yes" *) sikep503_kem_enc_hw_sparsemux_9_2_8_1_1 #(
    ...
    .sel_WIDTH( 2 ),
    .dout_WIDTH( 8 ))
sparsemux_9_2_8_1_1_U3296(
    .din0(temp_q0),
    .din1(temp_1_q0),
    .din2(temp_2_q0),
    .din3(temp_3_q0),
    .def(tmp_fu_219_p9),
    .sel(trunc_ln59_reg_264),
    .dout(tmp_fu_219_p11)
);
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln59_fu_169_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_78 <= add_ln59_1_fu_175_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln59_reg_264 <= trunc_ln59_fu_192_p1;
        xor_ln61_reg_294 <= xor_ln61_fu_242_p2;
    end
end

always @ (*) begin
    if (((icmp_ln59_fu_169_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln59_1_fu_175_p2 = (ap_sig_allocacmp_i_1 + 5'd1);
...
assign h_address0 = zext_ln59_fu_187_p1;

assign h_ce0 = h_ce0_local;

assign icmp_ln59_fu_169_p2 = ((ap_sig_allocacmp_i_1 == 5'd24) ? 1'b1 : 1'b0);

assign lshr_ln1_fu_196_p4 = {{ap_sig_allocacmp_i_1[4:2]}};
...
assign m_axi_gmem_0_WDATA = xor_ln61_reg_294;
...
assign temp_1_address0 = zext_ln44_fu_206_p1;

assign temp_1_ce0 = temp_1_ce0_local;

assign temp_2_address0 = zext_ln44_fu_206_p1;

assign temp_2_ce0 = temp_2_ce0_local;

assign temp_3_address0 = zext_ln44_fu_206_p1;

assign temp_3_ce0 = temp_3_ce0_local;

assign temp_address0 = zext_ln44_fu_206_p1;

assign temp_ce0 = temp_ce0_local;

assign tmp_fu_219_p9 = 'bx;

assign trunc_ln59_fu_192_p1 = ap_sig_allocacmp_i_1[1:0];

assign xor_ln61_fu_242_p2 = (tmp_fu_219_p11 ^ h_q0);

assign zext_ln44_fu_206_p1 = lshr_ln1_fu_196_p4;

assign zext_ln59_fu_187_p1 = ap_sig_allocacmp_i_1;

endmodule //sikep503_kem_enc_hw_sikep503_kem_enc_hw_Pipeline_VITIS_LOOP_59_1
