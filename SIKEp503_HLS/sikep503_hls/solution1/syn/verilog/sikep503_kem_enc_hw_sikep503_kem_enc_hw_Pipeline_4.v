...
module sikep503_kem_enc_hw_sikep503_kem_enc_hw_Pipeline_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] exitcond_i3_fu_141_p2;
...
wire   [1:0] empty_127_fu_159_p1;
reg   [1:0] empty_127_reg_207;
reg   [1:0] empty_127_reg_207_pp0_iter1_reg;
reg   [6:0] loop_index_i_udiv_cast_reg_211;
reg   [6:0] loop_index_i_udiv_cast_reg_211_pp0_iter1_reg;
reg   [7:0] gmem_addr_read_reg_216;
wire   [63:0] p_cast2_fu_183_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [8:0] loop_index_i_fu_66;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond_i3_fu_141_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index_i_fu_66 <= empty_fu_147_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index_i_fu_66 <= 9'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        empty_127_reg_207 <= empty_127_fu_159_p1;
        empty_127_reg_207_pp0_iter1_reg <= empty_127_reg_207;
        loop_index_i_udiv_cast_reg_211 <= {{ap_sig_allocacmp_loop_index_i_load[8:2]}};
        loop_index_i_udiv_cast_reg_211_pp0_iter1_reg <= loop_index_i_udiv_cast_reg_211;
    end
end
...
always @ (*) begin
    if (((exitcond_i3_fu_141_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_loop_index_i_load = loop_index_i_fu_66;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (empty_127_reg_207_pp0_iter1_reg == 2'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (empty_127_reg_207_pp0_iter1_reg == 2'd2))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (empty_127_reg_207_pp0_iter1_reg == 2'd3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (empty_127_reg_207_pp0_iter1_reg == 2'd0))) begin
        temp_we0_local = 1'b1;
    end else begin
        temp_we0_local = 1'b0;
    end
...
assign empty_127_fu_159_p1 = ap_sig_allocacmp_loop_index_i_load[1:0];

assign empty_128_fu_178_p2 = (loop_index_i_udiv_cast_reg_211_pp0_iter1_reg + 7'd6);

assign empty_fu_147_p2 = (ap_sig_allocacmp_loop_index_i_load + 9'd1);

assign exitcond_i3_fu_141_p2 = ((ap_sig_allocacmp_loop_index_i_load == 9'd402) ? 1'b1 : 1'b0);
...
assign p_cast2_fu_183_p1 = empty_128_fu_178_p2;

assign temp_1_address0 = p_cast2_fu_183_p1;
...
assign temp_2_address0 = p_cast2_fu_183_p1;
...
assign temp_3_address0 = p_cast2_fu_183_p1;
...
assign temp_address0 = p_cast2_fu_183_p1;
...
endmodule //sikep503_kem_enc_hw_sikep503_kem_enc_hw_Pipeline_4
