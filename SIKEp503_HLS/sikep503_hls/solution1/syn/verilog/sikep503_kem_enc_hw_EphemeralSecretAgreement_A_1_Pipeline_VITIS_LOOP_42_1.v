...
wire   [63:0] zext_ln45_1_fu_307_p1;
reg   [5:0] i_fu_64;
wire   [5:0] add_ln42_fu_191_p2;
wire    ap_loop_init;
reg   [5:0] ap_sig_allocacmp_i_384;
reg    t_i_ce1_local;
reg    t_i_ce0_local;
...
always @ (*) begin
    if ((1'b1 == ap_condition_107)) begin
        if ((trunc_ln42_reg_332 == 2'd0)) begin
            ...
            SharedSecretA_0_address0_local = zext_ln45_1_fu_307_p1;
        end else begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_107)) begin
        if ((trunc_ln42_reg_332 == 2'd1)) begin
            ...
            SharedSecretA_1_address0_local = zext_ln45_1_fu_307_p1;
        end else begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_107)) begin
        if ((trunc_ln42_reg_332 == 2'd3)) begin
            SharedSecretA_2_address0_local = zext_ln45_1_fu_307_p1;
        end else if ((trunc_ln42_reg_332 == 2'd2)) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_107)) begin
        if ((trunc_ln42_reg_332 == 2'd3)) begin
            ...
            SharedSecretA_3_address0_local = zext_ln45_1_fu_307_p1;
        end else begin
...
assign add_ln42_fu_191_p2 = (ap_sig_allocacmp_i_384 + 6'd1);
...
assign icmp_ln42_fu_185_p2 = ((ap_sig_allocacmp_i_384 == 6'd63) ? 1'b1 : 1'b0);

assign lshr_ln38_fu_237_p4 = {{i_384_reg_322[5:2]}};

assign lshr_ln44_1_fu_263_p2 = t_i_q1 >> zext_ln44_8_fu_259_p1;

assign lshr_ln44_fu_201_p4 = {{ap_sig_allocacmp_i_384[5:3]}};

assign lshr_ln45_2_fu_297_p4 = {{add_ln45_fu_291_p2[6:2]}};

assign lshr_ln45_fu_277_p2 = t_i_q0 >> zext_ln44_8_fu_259_p1;

assign shl_ln44_fu_254_p2 = i_384_reg_322 << 6'd3;
...
assign trunc_ln42_fu_197_p1 = ap_sig_allocacmp_i_384[1:0];
...
assign zext_ln42_fu_234_p1 = i_384_reg_322;

assign zext_ln44_8_fu_259_p1 = shl_ln44_fu_254_p2;

assign zext_ln44_fu_211_p1 = lshr_ln44_fu_201_p4;

assign zext_ln45_1_fu_307_p1 = lshr_ln45_2_fu_297_p4;
