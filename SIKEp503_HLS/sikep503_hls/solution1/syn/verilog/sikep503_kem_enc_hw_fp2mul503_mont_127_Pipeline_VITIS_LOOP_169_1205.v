...
module sikep503_kem_enc_hw_fp2mul503_mont_127_Pipeline_VITIS_LOOP_169_1205 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    tt2_ce1_local;
reg    tt2_we0_local;
wire   [63:0] sub_ln170_24_fu_192_p2;
reg    tt2_ce0_local;
reg    tt1_ce0_local;
...
assign sub_ln170_24_fu_192_p2 = (tempReg_reg_232 - zext_ln170_12_fu_188_p1);

assign sub_ln95_fu_152_p2 = (64'd0 - tempReg_reg_232);

assign tempReg_fu_119_p2 = (tt2_q1 - tt1_q0);

assign tmp_294_fu_162_p3 = or_ln95_fu_157_p2[32'd63];
...
assign tt2_d0 = sub_ln170_24_fu_192_p2;
...
assign xor_ln170_fu_170_p2 = (tmp_294_fu_162_p3 ^ 1'd1);

assign zext_ln170_12_fu_188_p1 = borrow_reg_72;

assign zext_ln170_fu_108_p1 = trunc_ln170_fu_104_p1;

endmodule //sikep503_kem_enc_hw_fp2mul503_mont_127_Pipeline_VITIS_LOOP_169_1205
