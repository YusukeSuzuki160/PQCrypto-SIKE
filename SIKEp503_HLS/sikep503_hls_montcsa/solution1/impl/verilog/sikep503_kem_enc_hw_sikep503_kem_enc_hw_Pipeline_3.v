...
wire   [1:0] empty_179_fu_157_p1;
reg   [1:0] empty_179_reg_205;
reg   [1:0] empty_179_reg_205_pp0_iter1_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        empty_179_reg_205 <= empty_179_fu_157_p1;
        empty_179_reg_205_pp0_iter1_reg <= empty_179_reg_205;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (empty_179_reg_205_pp0_iter1_reg == 2'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (empty_179_reg_205_pp0_iter1_reg == 2'd2))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (empty_179_reg_205_pp0_iter1_reg == 2'd3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (empty_179_reg_205_pp0_iter1_reg == 2'd0))) begin
        temp_we0_local = 1'b1;
    end else begin
        temp_we0_local = 1'b0;
    end
...
assign empty_179_fu_157_p1 = ap_sig_allocacmp_loop_index3_i_load[1:0];

assign empty_180_fu_176_p2 = (loop_index3_i_udiv_cast_reg_209_pp0_iter1_reg + 7'd6);
...
assign p_cast2_fu_181_p1 = empty_180_fu_176_p2;
