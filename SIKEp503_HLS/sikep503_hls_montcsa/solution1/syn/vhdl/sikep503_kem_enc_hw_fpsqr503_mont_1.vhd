...
attribute shreg_extract : string;
    ...
    signal grp_mul_1_3_fu_14_ap_start : STD_LOGIC;
    signal grp_mul_1_3_fu_14_ap_done : STD_LOGIC;
    signal grp_mul_1_3_fu_14_ap_idle : STD_LOGIC;
    signal grp_mul_1_3_fu_14_ap_ready : STD_LOGIC;
    signal grp_mul_1_3_fu_14_c_address0 : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_mul_1_3_fu_14_c_ce0 : STD_LOGIC;
    signal grp_mul_1_3_fu_14_c_we0 : STD_LOGIC;
    signal grp_mul_1_3_fu_14_c_d0 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_mul_1_3_fu_14_ap_ce : STD_LOGIC;
...
begin
    grp_mul_1_3_fu_14 : component sikep503_kem_enc_hw_mul_1_3
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state38, ap_ce)
    begin
        if ((((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_state38)))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state38, ap_ce)
    begin
        if (((ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_state38))) then 
    ...
    grp_mul_1_3_fu_14_ap_ce_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_ce)
    begin
        if (((ap_const_logic_0 = ap_ce) or ((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
            grp_mul_1_3_fu_14_ap_ce <= ap_const_logic_0;
        else 
            grp_mul_1_3_fu_14_ap_ce <= ap_const_logic_1;
        end if; 
    end process;


    grp_mul_1_3_fu_14_ap_start_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_ce)
    begin
        if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_logic_1 = ap_ce))) then 
            grp_mul_1_3_fu_14_ap_start <= ap_const_logic_1;
        else 
            grp_mul_1_3_fu_14_ap_start <= ap_const_logic_0;
        end if; 
    end process;

    mc_address0 <= grp_mul_1_3_fu_14_c_address0;
    mc_ce0 <= grp_mul_1_3_fu_14_c_ce0;
    mc_d0 <= grp_mul_1_3_fu_14_c_d0;
    mc_we0 <= grp_mul_1_3_fu_14_c_we0;
end behav;
