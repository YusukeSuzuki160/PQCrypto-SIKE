...
module sikep503_kem_enc_hw_cshake256_simple_35_Pipeline_VITIS_LOOP_668_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   t_100_ce0;
input  [7:0] t_100_q0;
output  [5:0] t_101_address0;
output   t_101_ce0;
input  [7:0] t_101_q0;
output  [5:0] t_102_address0;
output   t_102_ce0;
input  [7:0] t_102_q0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln668_fu_150_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_217_fu_72 <= add_ln668_fu_156_p2;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_i = i_217_fu_72;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        t_101_ce0_local = 1'b1;
    end else begin
        t_101_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        t_102_ce0_local = 1'b1;
    end else begin
        t_102_ce0_local = 1'b0;
    end
end
...
assign t_100_address0 = zext_ln640_fu_182_p1;

assign t_100_ce0 = t_100_ce0_local;

assign t_101_address0 = zext_ln640_fu_182_p1;

assign t_101_ce0 = t_101_ce0_local;

assign t_102_address0 = zext_ln640_fu_182_p1;

assign t_102_ce0 = t_102_ce0_local;
...
endmodule //sikep503_kem_enc_hw_cshake256_simple_35_Pipeline_VITIS_LOOP_668_1
