set moduleName fp2mul503_mont_49_Pipeline_VITIS_LOOP_396_1142
set isTopModule 0
...
set cdfgNum 655
set C_modelName {fp2mul503_mont.49_Pipeline_VITIS_LOOP_396_1142}
...
set C_modelArgMapList {[ 
	{ "Name" : "b_offset", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add_ln201", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ add_ln201 sc_in sc_lv 9 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln201", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "add_ln201", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	add_ln201 { ap_none {  { add_ln201 in_data 0 9 } } }
