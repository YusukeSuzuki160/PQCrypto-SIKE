...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename t_100 \
    op interface \
    ports { t_100_address0 { O 6 vector } t_100_ce0 { O 1 bit } t_100_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename t_101 \
    op interface \
    ports { t_101_address0 { O 6 vector } t_101_ce0 { O 1 bit } t_101_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 't_101'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename t_102 \
    op interface \
    ports { t_102_address0 { O 6 vector } t_102_ce0 { O 1 bit } t_102_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 't_102'"
}
}
