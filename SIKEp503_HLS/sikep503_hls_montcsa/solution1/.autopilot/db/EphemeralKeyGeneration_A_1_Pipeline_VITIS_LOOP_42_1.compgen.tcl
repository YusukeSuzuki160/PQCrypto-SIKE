...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename t_116 \
    op interface \
    ports { t_116_address0 { O 4 vector } t_116_ce0 { O 1 bit } t_116_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 't_116'"
}
}
