set moduleName EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_17_1215
set isTopModule 0
...
set cdfgNum 655
set C_modelName {EphemeralKeyGeneration_A.1_Pipeline_VITIS_LOOP_17_1215}
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln18_12", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln18_12 sc_in sc_lv 6 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln18_12", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln18_12", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_17_1215",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "zext_ln18_12", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_17_1215 {
		zext_ln18_12 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	zext_ln18_12 { ap_none {  { zext_ln18_12 in_data 0 6 } } }
