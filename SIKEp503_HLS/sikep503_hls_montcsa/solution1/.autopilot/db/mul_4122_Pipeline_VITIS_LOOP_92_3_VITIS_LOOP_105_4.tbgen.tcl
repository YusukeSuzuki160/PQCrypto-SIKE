set moduleName mul_4122_Pipeline_VITIS_LOOP_92_3_VITIS_LOOP_105_4
set isTopModule 0
...
set cdfgNum 655
set C_modelName {mul.4122_Pipeline_VITIS_LOOP_92_3_VITIS_LOOP_105_4}
...
set C_modelArgList {
	{ p_reload int 512 regular  }
	{ p_reload75 int 512 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "p_reload", "interface" : "wire", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "p_reload75", "interface" : "wire", "bitwidth" : 512, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ p_reload sc_in sc_lv 512 signal 0 } 
	{ p_reload75 sc_in sc_lv 512 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "p_reload", "role": "default" }} , 
 	{ "name": "p_reload75", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "p_reload75", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_64ns_64ns_128_1_1_U1997", "Parent" : "0"},
...
set Spec2ImplPortList { 
	p_reload { ap_none {  { p_reload in_data 0 512 } } }
	p_reload75 { ap_none {  { p_reload75 in_data 0 512 } } }
