set moduleName EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_17_1193
set isTopModule 0
...
set cdfgNum 655
set C_modelName {EphemeralSecretAgreement_A.1_Pipeline_VITIS_LOOP_17_1193}
...
set C_modelArgList {
	{ zext_ln18 int 6 regular  }
	{ pts_X_2 int 64 regular {array 56 { 1 3 } 1 1 }  }
	{ R_X int 64 regular {array 16 { 0 } 0 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln18", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "pts_X_2", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "R_X", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ zext_ln18 sc_in sc_lv 6 signal 0 } 
	{ pts_X_2_address0 sc_out sc_lv 6 signal 1 } 
	{ pts_X_2_ce0 sc_out sc_logic 1 signal 1 } 
	{ pts_X_2_q0 sc_in sc_lv 64 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln18", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln18", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_17_1193",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_17_1193 {
...
set Spec2ImplPortList { 
	zext_ln18 { ap_none {  { zext_ln18 in_data 0 6 } } }
	pts_X_2 { ap_memory {  { pts_X_2_address0 mem_address 1 6 }  { pts_X_2_ce0 mem_ce 1 1 }  { pts_X_2_q0 mem_dout 0 64 } } }
	R_X { ap_memory {  { R_X_address0 mem_address 1 4 }  { R_X_ce0 mem_ce 1 1 }  { R_X_we0 mem_we 1 1 }  { R_X_d0 mem_din 1 64 } } }
}
