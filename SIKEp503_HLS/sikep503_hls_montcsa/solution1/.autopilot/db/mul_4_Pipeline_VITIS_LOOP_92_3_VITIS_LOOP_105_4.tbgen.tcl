set moduleName mul_4_Pipeline_VITIS_LOOP_92_3_VITIS_LOOP_105_4
set isTopModule 0
...
set cdfgNum 655
set C_modelName {mul.4_Pipeline_VITIS_LOOP_92_3_VITIS_LOOP_105_4}
...
set C_modelArgMapList {[ 
	{ "Name" : "p_reload", "interface" : "wire", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "p_reload82", "interface" : "wire", "bitwidth" : 512, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ p_reload82 sc_in sc_lv 512 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_reload82", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "p_reload82", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_64ns_64ns_128_1_1_U486", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	p_reload82 { ap_none {  { p_reload82 in_data 0 512 } } }
