set moduleName EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_313_1191
set isTopModule 0
...
set cdfgNum 655
set C_modelName {EphemeralSecretAgreement_A.1_Pipeline_VITIS_LOOP_313_1191}
...
dict set ap_memory_interface_dict pt_new_X_2 { MEM_WIDTH 64 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
dict set ap_memory_interface_dict pt_new_Z_2 { MEM_WIDTH 64 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	...
	{ pt_new_X_2 int 64 regular {array 8 { 1 } 1 1 }  }
	{ pt_new_Z int 64 regular {array 8 { 1 } 1 1 }  }
	{ pt_new_Z_2 int 64 regular {array 8 { 1 } 1 1 }  }
	{ zext_ln370 int 3 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "pts_Z_2", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "pt_new_X_2", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "pt_new_Z", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "pt_new_Z_2", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln370", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln18_3 sc_in sc_lv 6 signal 1 } 
	...
	{ pt_new_X_2_address0 sc_out sc_lv 3 signal 6 } 
	{ pt_new_X_2_ce0 sc_out sc_logic 1 signal 6 } 
	{ pt_new_X_2_q0 sc_in sc_lv 64 signal 6 } 
	{ pt_new_Z_address0 sc_out sc_lv 3 signal 7 } 
	{ pt_new_Z_ce0 sc_out sc_logic 1 signal 7 } 
	{ pt_new_Z_q0 sc_in sc_lv 64 signal 7 } 
	{ pt_new_Z_2_address0 sc_out sc_lv 3 signal 8 } 
	{ pt_new_Z_2_ce0 sc_out sc_logic 1 signal 8 } 
	{ pt_new_Z_2_q0 sc_in sc_lv 64 signal 8 } 
	{ zext_ln370 sc_in sc_lv 3 signal 9 } 
	{ npts_1 sc_in sc_lv 32 signal 10 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "pt_new_X_2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "pt_new_X_2", "role": "address0" }} , 
 	{ "name": "pt_new_X_2_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "pt_new_X_2", "role": "ce0" }} , 
 	{ "name": "pt_new_X_2_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "pt_new_X_2", "role": "q0" }} , 
 	...
 	{ "name": "pt_new_Z_2_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "pt_new_Z_2", "role": "q0" }} , 
 	{ "name": "zext_ln370", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "zext_ln370", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	pt_new_X_2 { ap_memory {  { pt_new_X_2_address0 mem_address 1 3 }  { pt_new_X_2_ce0 mem_ce 1 1 }  { pt_new_X_2_q0 mem_dout 0 64 } } }
	pt_new_Z { ap_memory {  { pt_new_Z_address0 mem_address 1 3 }  { pt_new_Z_ce0 mem_ce 1 1 }  { pt_new_Z_q0 mem_dout 0 64 } } }
	pt_new_Z_2 { ap_memory {  { pt_new_Z_2_address0 mem_address 1 3 }  { pt_new_Z_2_ce0 mem_ce 1 1 }  { pt_new_Z_2_q0 mem_dout 0 64 } } }
	zext_ln370 { ap_none {  { zext_ln370 in_data 0 3 } } }
