...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename ma \
    op interface \
    ports { ma_address0 { O 3 vector } ma_ce0 { O 1 bit } ma_q0 { I 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename mb \
    op interface \
    ports { mb_address0 { O 3 vector } mb_ce0 { O 1 bit } mb_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'mb'"
}
}
