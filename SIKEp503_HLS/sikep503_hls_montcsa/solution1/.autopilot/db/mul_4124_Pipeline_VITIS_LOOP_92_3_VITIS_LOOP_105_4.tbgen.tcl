set moduleName mul_4124_Pipeline_VITIS_LOOP_92_3_VITIS_LOOP_105_4
set isTopModule 0
...
set cdfgNum 655
set C_modelName {mul.4124_Pipeline_VITIS_LOOP_92_3_VITIS_LOOP_105_4}
...
set C_modelArgMapList {[ 
	{ "Name" : "p_reload", "interface" : "wire", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "p_reload76", "interface" : "wire", "bitwidth" : 512, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ p_reload76 sc_in sc_lv 512 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_reload76", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "p_reload76", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	p_reload76 { ap_none {  { p_reload76 in_data 0 512 } } }
