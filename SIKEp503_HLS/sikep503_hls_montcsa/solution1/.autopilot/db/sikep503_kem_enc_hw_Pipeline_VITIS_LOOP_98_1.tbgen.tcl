set moduleName sikep503_kem_enc_hw_Pipeline_VITIS_LOOP_98_1
set isTopModule 0
...
set cdfgNum 655
set C_modelName {sikep503_kem_enc_hw_Pipeline_VITIS_LOOP_98_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "ct","offset": { "type": "dynamic","port_name": "ct","bundle": "control"},"direction": "READWRITE"},{"cName": "pk","offset": { "type": "dynamic","port_name": "pk","bundle": "control"},"direction": "READONLY"},{"cName": "ss","offset": { "type": "dynamic","port_name": "ss","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "add_ln98", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ add_ln98 sc_in sc_lv 64 signal 1 } 
	{ temp_address0 sc_out sc_lv 7 signal 2 } 
	{ temp_ce0 sc_out sc_logic 1 signal 2 } 
	{ temp_q0 sc_in sc_lv 8 signal 2 } 
	{ temp_1_address0 sc_out sc_lv 7 signal 3 } 
	{ temp_1_ce0 sc_out sc_logic 1 signal 3 } 
	{ temp_1_q0 sc_in sc_lv 8 signal 3 } 
	{ temp_2_address0 sc_out sc_lv 7 signal 4 } 
	{ temp_2_ce0 sc_out sc_logic 1 signal 4 } 
	{ temp_2_q0 sc_in sc_lv 8 signal 4 } 
	{ temp_3_address0 sc_out sc_lv 7 signal 5 } 
	{ temp_3_ce0 sc_out sc_logic 1 signal 5 } 
	{ temp_3_q0 sc_in sc_lv 8 signal 5 } 
	{ h_address0 sc_out sc_lv 5 signal 6 } 
	{ h_ce0 sc_out sc_logic 1 signal 6 } 
	{ h_q0 sc_in sc_lv 8 signal 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln98", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "add_ln98", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "sikep503_kem_enc_hw_Pipeline_VITIS_LOOP_98_1",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_2_8_1_1_U2665", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	sikep503_kem_enc_hw_Pipeline_VITIS_LOOP_98_1 {
...
set Spec2ImplPortList { 
	...
	add_ln98 { ap_none {  { add_ln98 in_data 0 64 } } }
