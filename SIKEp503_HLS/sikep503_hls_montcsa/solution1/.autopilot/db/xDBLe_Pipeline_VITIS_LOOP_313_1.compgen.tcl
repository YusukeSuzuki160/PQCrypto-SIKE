...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename Qnew_X \
    op interface \
    ports { Qnew_X_address0 { O 4 vector } Qnew_X_ce0 { O 1 bit } Qnew_X_q0 { I 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename Qnew_Z \
    op interface \
    ports { Qnew_Z_address0 { O 3 vector } Qnew_Z_ce0 { O 1 bit } Qnew_Z_q0 { I 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename Qnew_Z_4 \
    op interface \
    ports { Qnew_Z_4_address0 { O 3 vector } Qnew_Z_4_ce0 { O 1 bit } Qnew_Z_4_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'Qnew_Z_4'"
}
}
