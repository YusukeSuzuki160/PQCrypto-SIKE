...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename t_115 \
    op interface \
    ports { t_115_address0 { O 4 vector } t_115_ce0 { O 1 bit } t_115_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 't_115'"
}
}
