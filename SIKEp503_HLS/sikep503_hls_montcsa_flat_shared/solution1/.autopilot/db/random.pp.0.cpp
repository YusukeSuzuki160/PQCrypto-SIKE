# 1 "src_montcsa_flat/random/random.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "src_montcsa_flat/random/random.cpp" 2




# 1 "src_montcsa_flat/random/random.h" 1
...
# 5 "src_montcsa_flat/random/random.h" 2




void randombytes(unsigned char *x, unsigned long long xlen);
# 6 "src_montcsa_flat/random/random.cpp" 2
