set moduleName xDBLe_41_Pipeline_VITIS_LOOP_17_1158
set isTopModule 0
...
set cdfgNum 598
set C_modelName {xDBLe.41_Pipeline_VITIS_LOOP_17_1158}
...
set C_modelArgList {
	{ Q_Z_1 int 64 regular {array 8 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "Q_Z_1", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ Q_Z_1_address0 sc_out sc_lv 3 signal 0 } 
	{ Q_Z_1_ce0 sc_out sc_logic 1 signal 0 } 
	{ Q_Z_1_we0 sc_out sc_logic 1 signal 0 } 
	{ Q_Z_1_d0 sc_out sc_lv 64 signal 0 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "xDBLe_41_Pipeline_VITIS_LOOP_17_1158",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	xDBLe_41_Pipeline_VITIS_LOOP_17_1158 {
...
set Spec2ImplPortList { 
	Q_Z_1 { ap_memory {  { Q_Z_1_address0 mem_address 1 3 }  { Q_Z_1_ce0 mem_ce 1 1 }  { Q_Z_1_we0 mem_we 1 1 }  { Q_Z_1_d0 mem_din 1 64 } } }
