set moduleName xDBLe_41_Pipeline_VITIS_LOOP_17_1
set isTopModule 0
...
set cdfgNum 598
set C_modelName {xDBLe.41_Pipeline_VITIS_LOOP_17_1}
...
set C_modelArgList {
	{ Q_X_0 int 64 regular {array 8 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "Q_X_0", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "xDBLe_41_Pipeline_VITIS_LOOP_17_1",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	xDBLe_41_Pipeline_VITIS_LOOP_17_1 {
...
set Spec2ImplPortList { 
	Q_X_0 { ap_memory {  { Q_X_0_address0 mem_address 1 3 }  { Q_X_0_ce0 mem_ce 1 1 }  { Q_X_0_we0 mem_we 1 1 }  { Q_X_0_d0 mem_din 1 64 } } }
