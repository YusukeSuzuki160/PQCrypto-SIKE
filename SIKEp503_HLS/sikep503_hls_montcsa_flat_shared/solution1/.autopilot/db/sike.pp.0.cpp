...
# 11 "src_montcsa_flat/config.h" 2
...
# 9 "src_montcsa_flat/sike.cpp" 2
# 1 "src_montcsa_flat/sha3/fips202.h" 1
# 10 "src_montcsa_flat/sha3/fips202.h"
...
# 10 "src_montcsa_flat/sike.cpp" 2
...
# 11 "src_montcsa_flat/sike.cpp" 2
...
# 12 "src_montcsa_flat/sike.cpp" 2
...
# 98 "src_montcsa_flat/sike.cpp"
  VITIS_LOOP_98_1: for (i = 0; i < 24; i++)
  {
    ct[i + 378] = temp[i] ^ h[i];
  }
# 111 "src_montcsa_flat/sike.cpp"
...
int crypto_kem_dec(unsigned char *ss, const unsigned char *ct, const unsigned char *sk)
{
  ...
  VITIS_LOOP_145_1: for (i = 0; i < 24; i++)
  {
