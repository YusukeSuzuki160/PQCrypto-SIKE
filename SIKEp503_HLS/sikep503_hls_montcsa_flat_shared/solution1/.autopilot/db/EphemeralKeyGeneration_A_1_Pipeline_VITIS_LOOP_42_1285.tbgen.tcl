set moduleName EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_42_1285
set isTopModule 0
...
set cdfgNum 598
set C_modelName {EphemeralKeyGeneration_A.1_Pipeline_VITIS_LOOP_42_1285}
...
set C_modelArgList {
	{ t int 64 regular {array 16 { 1 1 } 1 1 }  }
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_42_1285",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_42_1285 {
...
set Spec2ImplPortList { 
	t { ap_memory {  { t_address0 mem_address 1 4 }  { t_ce0 mem_ce 1 1 }  { t_q0 mem_dout 0 64 }  { t_address1 MemPortADDR2 1 4 }  { t_ce1 MemPortCE2 1 1 }  { t_q1 MemPortDOUT2 0 64 } } }
