set moduleName fpsub503_3_Pipeline_VITIS_LOOP_69_2
set isTopModule 0
...
set cdfgNum 598
set C_modelName {fpsub503.3_Pipeline_VITIS_LOOP_69_2}
...
set C_modelArgList {
	{ zext_ln64_5 int 4 regular  }
	{ c int 64 regular {array 16 { 0 1 } 1 1 }  }
	{ sext_ln59 int 1 regular  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln64_5", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "c", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "sext_ln59", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ zext_ln64_5 sc_in sc_lv 4 signal 0 } 
	...
	{ sext_ln59 sc_in sc_lv 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln64_5", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln64_5", "role": "default" }} , 
 	...
 	{ "name": "sext_ln59", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "sext_ln59", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "fpsub503_3_Pipeline_VITIS_LOOP_69_2",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "zext_ln64_5", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	fpsub503_3_Pipeline_VITIS_LOOP_69_2 {
		zext_ln64_5 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	zext_ln64_5 { ap_none {  { zext_ln64_5 in_data 0 4 } } }
	...
	sext_ln59 { ap_none {  { sext_ln59 in_data 0 1 } } }
}
