...
set C_modelArgList {
	...
	{ x int 64 regular {array 48 { 0 1 } 1 1 }  }
}
set hasAXIMCache 0
...
set Spec2ImplPortList { 
	...
	x { ap_memory {  { x_address0 mem_address 1 6 }  { x_ce0 mem_ce 1 1 }  { x_we0 mem_we 1 1 }  { x_d0 mem_din 1 64 }  { x_address1 MemPortADDR2 1 6 }  { x_ce1 MemPortCE2 1 1 }  { x_q1 MemPortDOUT2 0 64 } } }
}
