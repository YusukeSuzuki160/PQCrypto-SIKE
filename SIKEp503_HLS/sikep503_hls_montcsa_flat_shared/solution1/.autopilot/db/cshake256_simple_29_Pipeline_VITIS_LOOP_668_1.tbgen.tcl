set moduleName cshake256_simple_29_Pipeline_VITIS_LOOP_668_1
set isTopModule 0
...
set cdfgNum 598
set C_modelName {cshake256_simple.29_Pipeline_VITIS_LOOP_668_1}
...
dict set ap_memory_interface_dict t_40 { MEM_WIDTH 8 MEM_SIZE 34 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict t_41 { MEM_WIDTH 8 MEM_SIZE 34 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict t_42 { MEM_WIDTH 8 MEM_SIZE 34 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem int 8 regular {axi_master 1}  }
	{ output_r int 64 regular  }
	{ t int 8 regular {array 34 { 1 3 } 1 1 }  }
	{ t_40 int 8 regular {array 34 { 1 3 } 1 1 }  }
	{ t_41 int 8 regular {array 34 { 1 3 } 1 1 }  }
	{ t_42 int 8 regular {array 34 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "ct","offset": { "type": "dynamic","port_name": "ct","bundle": "control"},"direction": "READWRITE"},{"cName": "pk","offset": { "type": "dynamic","port_name": "pk","bundle": "control"},"direction": "READONLY"},{"cName": "ss","offset": { "type": "dynamic","port_name": "ss","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "t_40", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "t_41", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "t_42", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ t_40_address0 sc_out sc_lv 6 signal 3 } 
	{ t_40_ce0 sc_out sc_logic 1 signal 3 } 
	{ t_40_q0 sc_in sc_lv 8 signal 3 } 
	{ t_41_address0 sc_out sc_lv 6 signal 4 } 
	{ t_41_ce0 sc_out sc_logic 1 signal 4 } 
	{ t_41_q0 sc_in sc_lv 8 signal 4 } 
	{ t_42_address0 sc_out sc_lv 6 signal 5 } 
	{ t_42_ce0 sc_out sc_logic 1 signal 5 } 
	{ t_42_q0 sc_in sc_lv 8 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "t_40_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "t_40", "role": "address0" }} , 
 	{ "name": "t_40_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "t_40", "role": "ce0" }} , 
 	{ "name": "t_40_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "t_40", "role": "q0" }} , 
 	{ "name": "t_41_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "t_41", "role": "address0" }} , 
 	{ "name": "t_41_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "t_41", "role": "ce0" }} , 
 	{ "name": "t_41_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "t_41", "role": "q0" }} , 
 	{ "name": "t_42_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "t_42", "role": "address0" }} , 
 	{ "name": "t_42_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "t_42", "role": "ce0" }} , 
 	{ "name": "t_42_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "t_42", "role": "q0" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "cshake256_simple_29_Pipeline_VITIS_LOOP_668_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "t_40", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "t_41", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "t_42", "Type" : "Memory", "Direction" : "I"}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_668_1", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter2", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter2", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_2_8_1_1_U2801", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	cshake256_simple_29_Pipeline_VITIS_LOOP_668_1 {
		gmem {Type O LastRead -1 FirstWrite 2}
		output_r {Type I LastRead 0 FirstWrite -1}
		t {Type I LastRead 0 FirstWrite -1}
		t_40 {Type I LastRead 0 FirstWrite -1}
		t_41 {Type I LastRead 0 FirstWrite -1}
		t_42 {Type I LastRead 0 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	t_40 { ap_memory {  { t_40_address0 mem_address 1 6 }  { t_40_ce0 mem_ce 1 1 }  { t_40_q0 mem_dout 0 8 } } }
	t_41 { ap_memory {  { t_41_address0 mem_address 1 6 }  { t_41_ce0 mem_ce 1 1 }  { t_41_q0 mem_dout 0 8 } } }
	t_42 { ap_memory {  { t_42_address0 mem_address 1 6 }  { t_42_ce0 mem_ce 1 1 }  { t_42_q0 mem_dout 0 8 } } }
}
