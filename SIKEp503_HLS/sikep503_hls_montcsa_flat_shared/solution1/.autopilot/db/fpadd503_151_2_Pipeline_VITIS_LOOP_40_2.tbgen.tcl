set moduleName fpadd503_151_2_Pipeline_VITIS_LOOP_40_2
set isTopModule 0
...
set cdfgNum 598
set C_modelName {fpadd503.151.2_Pipeline_VITIS_LOOP_40_2}
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln36_28", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln36_28 sc_in sc_lv 4 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln36_28", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln36_28", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "fpadd503_151_2_Pipeline_VITIS_LOOP_40_2",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	fpadd503_151_2_Pipeline_VITIS_LOOP_40_2 {
...
set Spec2ImplPortList { 
	zext_ln36_28 { ap_none {  { zext_ln36_28 in_data 0 4 } } }
