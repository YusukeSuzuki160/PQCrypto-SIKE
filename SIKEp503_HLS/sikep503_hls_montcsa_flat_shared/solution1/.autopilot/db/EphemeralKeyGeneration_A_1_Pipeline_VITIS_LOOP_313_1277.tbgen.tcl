set moduleName EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_313_1277
set isTopModule 0
...
set cdfgNum 598
set C_modelName {EphemeralKeyGeneration_A.1_Pipeline_VITIS_LOOP_313_1277}
...
dict set ap_memory_interface_dict pt_new_X { MEM_WIDTH 64 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict pt_new_Z { MEM_WIDTH 64 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	...
	{ pt_new_X int 64 regular {array 16 { 1 1 } 1 1 }  }
	{ pt_new_Z int 64 regular {array 16 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ zext_ln18_14 sc_in sc_lv 6 signal 1 } 
	...
	{ pt_new_X_address0 sc_out sc_lv 4 signal 5 } 
	{ pt_new_X_ce0 sc_out sc_logic 1 signal 5 } 
	{ pt_new_X_q0 sc_in sc_lv 64 signal 5 } 
	{ pt_new_X_address1 sc_out sc_lv 4 signal 5 } 
	{ pt_new_X_ce1 sc_out sc_logic 1 signal 5 } 
	{ pt_new_X_q1 sc_in sc_lv 64 signal 5 } 
	{ pt_new_Z_address0 sc_out sc_lv 4 signal 6 } 
	{ pt_new_Z_ce0 sc_out sc_logic 1 signal 6 } 
	{ pt_new_Z_q0 sc_in sc_lv 64 signal 6 } 
	{ pt_new_Z_address1 sc_out sc_lv 4 signal 6 } 
	{ pt_new_Z_ce1 sc_out sc_logic 1 signal 6 } 
	{ pt_new_Z_q1 sc_in sc_lv 64 signal 6 } 
	{ zext_ln175 sc_in sc_lv 3 signal 7 } 
	{ npts_4 sc_in sc_lv 32 signal 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "pt_new_X_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "pt_new_X", "role": "address1" }} , 
 	{ "name": "pt_new_X_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "pt_new_X", "role": "ce1" }} , 
 	{ "name": "pt_new_X_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "pt_new_X", "role": "q1" }} , 
 	...
 	{ "name": "pt_new_Z_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "pt_new_Z", "role": "address1" }} , 
 	{ "name": "pt_new_Z_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "pt_new_Z", "role": "ce1" }} , 
 	{ "name": "pt_new_Z_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "pt_new_Z", "role": "q1" }} , 
...
set Spec2ImplPortList { 
	...
	pt_new_X { ap_memory {  { pt_new_X_address0 mem_address 1 4 }  { pt_new_X_ce0 mem_ce 1 1 }  { pt_new_X_q0 mem_dout 0 64 }  { pt_new_X_address1 MemPortADDR2 1 4 }  { pt_new_X_ce1 MemPortCE2 1 1 }  { pt_new_X_q1 MemPortDOUT2 0 64 } } }
	pt_new_Z { ap_memory {  { pt_new_Z_address0 mem_address 1 4 }  { pt_new_Z_ce0 mem_ce 1 1 }  { pt_new_Z_q0 mem_dout 0 64 }  { pt_new_Z_address1 MemPortADDR2 1 4 }  { pt_new_Z_ce1 MemPortCE2 1 1 }  { pt_new_Z_q1 MemPortDOUT2 0 64 } } }
