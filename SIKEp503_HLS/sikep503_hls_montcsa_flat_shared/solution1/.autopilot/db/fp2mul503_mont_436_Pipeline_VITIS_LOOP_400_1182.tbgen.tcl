set moduleName fp2mul503_mont_436_Pipeline_VITIS_LOOP_400_1182
set isTopModule 0
...
set cdfgNum 598
set C_modelName {fp2mul503_mont.436_Pipeline_VITIS_LOOP_400_1182}
...
set C_modelArgMapList {[ 
	{ "Name" : "b_offset", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add_ln205", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ add_ln205 sc_in sc_lv 9 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln205", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "add_ln205", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	add_ln205 { ap_none {  { add_ln205 in_data 0 9 } } }
