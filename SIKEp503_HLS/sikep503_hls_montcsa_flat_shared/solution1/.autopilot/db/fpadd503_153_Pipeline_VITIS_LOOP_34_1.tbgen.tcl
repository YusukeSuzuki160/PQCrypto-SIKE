set moduleName fpadd503_153_Pipeline_VITIS_LOOP_34_1
set isTopModule 0
...
set cdfgNum 598
set C_modelName {fpadd503.153_Pipeline_VITIS_LOOP_34_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln36_16", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "tmp_5598", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ tmp_5598 sc_in sc_lv 5 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_5598", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "tmp_5598", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	tmp_5598 { ap_none {  { tmp_5598 in_data 0 5 } } }
