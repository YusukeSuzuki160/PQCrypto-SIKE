...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename pt_new_X_2 \
    op interface \
    ports { pt_new_X_2_address0 { O 3 vector } pt_new_X_2_ce0 { O 1 bit } pt_new_X_2_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'pt_new_X_2'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename pt_new_Z_2 \
    op interface \
    ports { pt_new_Z_2_address0 { O 3 vector } pt_new_Z_2_ce0 { O 1 bit } pt_new_Z_2_q0 { I 64 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_zext_ln370 \
    op interface \
    ports { zext_ln370 { I 3 vector } } \
} "
}
