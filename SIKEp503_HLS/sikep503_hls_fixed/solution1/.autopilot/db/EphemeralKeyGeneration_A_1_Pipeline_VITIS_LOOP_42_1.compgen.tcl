...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename t_176 \
    op interface \
    ports { t_176_address0 { O 4 vector } t_176_ce0 { O 1 bit } t_176_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 't_176'"
}
}
