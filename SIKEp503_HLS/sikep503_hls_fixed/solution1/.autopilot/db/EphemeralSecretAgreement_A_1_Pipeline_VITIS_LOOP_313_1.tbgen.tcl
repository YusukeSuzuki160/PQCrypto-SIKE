set moduleName EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_313_1
set isTopModule 0
...
set cdfgNum 607
set C_modelName {EphemeralSecretAgreement_A.1_Pipeline_VITIS_LOOP_313_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict pts_Z_2 { MEM_WIDTH 64 MEM_SIZE 448 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
...
dict set ap_memory_interface_dict pts_X_2 { MEM_WIDTH 64 MEM_SIZE 448 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
...
dict set ap_memory_interface_dict R_cand_X_2 { MEM_WIDTH 64 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
dict set ap_memory_interface_dict R_cand_Z_2 { MEM_WIDTH 64 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ pts_Z_2 int 64 regular {array 56 { 0 1 } 1 1 }  }
	{ zext_ln315 int 6 regular  }
	{ pts_Z int 64 regular {array 56 { 0 1 } 1 1 }  }
	{ pts_X_2 int 64 regular {array 56 { 0 1 } 1 1 }  }
	{ pts_X int 64 regular {array 56 { 0 1 } 1 1 }  }
	{ R_cand_X int 64 regular {array 8 { 1 3 } 1 1 }  }
	{ R_cand_X_2 int 64 regular {array 8 { 1 3 } 1 1 }  }
	{ R_cand_Z int 64 regular {array 8 { 1 3 } 1 1 }  }
	{ R_cand_Z_2 int 64 regular {array 8 { 1 3 } 1 1 }  }
	{ index_1 int 32 regular  }
	{ zext_ln347 int 7 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "pts_Z_2", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "R_cand_X_2", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "R_cand_Z", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "R_cand_Z_2", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "index_1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln347", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ pts_Z_2_address0 sc_out sc_lv 6 signal 0 } 
	{ pts_Z_2_ce0 sc_out sc_logic 1 signal 0 } 
	{ pts_Z_2_we0 sc_out sc_logic 1 signal 0 } 
	{ pts_Z_2_d0 sc_out sc_lv 64 signal 0 } 
	{ pts_Z_2_address1 sc_out sc_lv 6 signal 0 } 
	{ pts_Z_2_ce1 sc_out sc_logic 1 signal 0 } 
	{ pts_Z_2_q1 sc_in sc_lv 64 signal 0 } 
	...
	{ pts_X_2_address0 sc_out sc_lv 6 signal 3 } 
	{ pts_X_2_ce0 sc_out sc_logic 1 signal 3 } 
	{ pts_X_2_we0 sc_out sc_logic 1 signal 3 } 
	{ pts_X_2_d0 sc_out sc_lv 64 signal 3 } 
	{ pts_X_2_address1 sc_out sc_lv 6 signal 3 } 
	{ pts_X_2_ce1 sc_out sc_logic 1 signal 3 } 
	{ pts_X_2_q1 sc_in sc_lv 64 signal 3 } 
	...
	{ R_cand_X_2_address0 sc_out sc_lv 3 signal 6 } 
	{ R_cand_X_2_ce0 sc_out sc_logic 1 signal 6 } 
	{ R_cand_X_2_q0 sc_in sc_lv 64 signal 6 } 
	{ R_cand_Z_address0 sc_out sc_lv 3 signal 7 } 
	{ R_cand_Z_ce0 sc_out sc_logic 1 signal 7 } 
	{ R_cand_Z_q0 sc_in sc_lv 64 signal 7 } 
	{ R_cand_Z_2_address0 sc_out sc_lv 3 signal 8 } 
	{ R_cand_Z_2_ce0 sc_out sc_logic 1 signal 8 } 
	{ R_cand_Z_2_q0 sc_in sc_lv 64 signal 8 } 
	{ index_1 sc_in sc_lv 32 signal 9 } 
	{ zext_ln347 sc_in sc_lv 7 signal 10 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "R_cand_X_2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "R_cand_X_2", "role": "address0" }} , 
 	{ "name": "R_cand_X_2_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "R_cand_X_2", "role": "ce0" }} , 
 	{ "name": "R_cand_X_2_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "R_cand_X_2", "role": "q0" }} , 
 	...
 	{ "name": "R_cand_Z_2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "R_cand_Z_2", "role": "address0" }} , 
 	{ "name": "R_cand_Z_2_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "R_cand_Z_2", "role": "ce0" }} , 
 	{ "name": "R_cand_Z_2_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "R_cand_Z_2", "role": "q0" }} , 
 	{ "name": "index_1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "index_1", "role": "default" }} , 
 	{ "name": "zext_ln347", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln347", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_313_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "R_cand_X_2", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "R_cand_Z", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "R_cand_Z_2", "Type" : "Memory", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_313_1 {
		...
		R_cand_X_2 {Type I LastRead 0 FirstWrite -1}
		R_cand_Z {Type I LastRead 0 FirstWrite -1}
		R_cand_Z_2 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	pts_Z_2 { ap_memory {  { pts_Z_2_address0 mem_address 1 6 }  { pts_Z_2_ce0 mem_ce 1 1 }  { pts_Z_2_we0 mem_we 1 1 }  { pts_Z_2_d0 mem_din 1 64 }  { pts_Z_2_address1 MemPortADDR2 1 6 }  { pts_Z_2_ce1 MemPortCE2 1 1 }  { pts_Z_2_q1 MemPortDOUT2 0 64 } } }
	...
	pts_X_2 { ap_memory {  { pts_X_2_address0 mem_address 1 6 }  { pts_X_2_ce0 mem_ce 1 1 }  { pts_X_2_we0 mem_we 1 1 }  { pts_X_2_d0 mem_din 1 64 }  { pts_X_2_address1 MemPortADDR2 1 6 }  { pts_X_2_ce1 MemPortCE2 1 1 }  { pts_X_2_q1 MemPortDOUT2 0 64 } } }
	...
	R_cand_X_2 { ap_memory {  { R_cand_X_2_address0 mem_address 1 3 }  { R_cand_X_2_ce0 mem_ce 1 1 }  { R_cand_X_2_q0 mem_dout 0 64 } } }
	R_cand_Z { ap_memory {  { R_cand_Z_address0 mem_address 1 3 }  { R_cand_Z_ce0 mem_ce 1 1 }  { R_cand_Z_q0 mem_dout 0 64 } } }
	R_cand_Z_2 { ap_memory {  { R_cand_Z_2_address0 mem_address 1 3 }  { R_cand_Z_2_ce0 mem_ce 1 1 }  { R_cand_Z_2_q0 mem_dout 0 64 } } }
	index_1 { ap_none {  { index_1 in_data 0 32 } } }
	zext_ln347 { ap_none {  { zext_ln347 in_data 0 7 } } }
}
