...
void copy_words(const digit_t *a, digit_t *c, const unsigned int nwords)
{
    ...
    VITIS_LOOP_60_1: for (i = 0; i < nwords; i++)
    {
        c[i] = a[i];
    }
}
...
__inline unsigned int mp_sub(const digit_t *a, const digit_t *b, digit_t *c, const unsigned int nwords)
{
    ...
    VITIS_LOOP_172_1: for (i = 0; i < nwords; i++)
    {
...
void fpinv503_chain_mont(felm_t a)
{
    ...
    VITIS_LOOP_218_1: for (i = 0; i <= 13; i++)
        fpmul503_mont(t[i], tt, t[i + 1]);

    fpcopy503(a, tt);
    VITIS_LOOP_222_2: for (i = 0; i < 8; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(a, tt, tt);
    VITIS_LOOP_225_3: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[8], tt, tt);
    VITIS_LOOP_228_4: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[6], tt, tt);
    VITIS_LOOP_231_5: for (i = 0; i < 6; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[9], tt, tt);
    VITIS_LOOP_234_6: for (i = 0; i < 7; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[0], tt, tt);
    VITIS_LOOP_237_7: for (i = 0; i < 7; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(a, tt, tt);
    VITIS_LOOP_240_8: for (i = 0; i < 7; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[6], tt, tt);
    VITIS_LOOP_243_9: for (i = 0; i < 7; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[2], tt, tt);
    VITIS_LOOP_246_10: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[8], tt, tt);
    VITIS_LOOP_249_11: for (i = 0; i < 7; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(a, tt, tt);
    VITIS_LOOP_252_12: for (i = 0; i < 8; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[10], tt, tt);
    VITIS_LOOP_255_13: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[0], tt, tt);
    VITIS_LOOP_258_14: for (i = 0; i < 6; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[10], tt, tt);
    VITIS_LOOP_261_15: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[10], tt, tt);
    VITIS_LOOP_264_16: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[5], tt, tt);
    VITIS_LOOP_267_17: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[2], tt, tt);
    VITIS_LOOP_270_18: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[6], tt, tt);
    VITIS_LOOP_273_19: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[3], tt, tt);
    VITIS_LOOP_276_20: for (i = 0; i < 6; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[5], tt, tt);
    VITIS_LOOP_279_21: for (i = 0; i < 12; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[12], tt, tt);
    VITIS_LOOP_282_22: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[8], tt, tt);
    VITIS_LOOP_285_23: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[6], tt, tt);
    VITIS_LOOP_288_24: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[12], tt, tt);
    VITIS_LOOP_291_25: for (i = 0; i < 6; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[11], tt, tt);
    VITIS_LOOP_294_26: for (i = 0; i < 8; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[6], tt, tt);
    VITIS_LOOP_297_27: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[5], tt, tt);
    VITIS_LOOP_300_28: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[14], tt, tt);
    VITIS_LOOP_303_29: for (i = 0; i < 7; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[14], tt, tt);
    VITIS_LOOP_306_30: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[5], tt, tt);
    VITIS_LOOP_309_31: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[6], tt, tt);
    VITIS_LOOP_312_32: for (i = 0; i < 8; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[8], tt, tt);
    VITIS_LOOP_315_33: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(a, tt, tt);
    VITIS_LOOP_318_34: for (i = 0; i < 8; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[4], tt, tt);
    VITIS_LOOP_321_35: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[6], tt, tt);
    VITIS_LOOP_324_36: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[5], tt, tt);
    VITIS_LOOP_327_37: for (i = 0; i < 8; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[7], tt, tt);
    VITIS_LOOP_330_38: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(a, tt, tt);
    VITIS_LOOP_333_39: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[0], tt, tt);
    VITIS_LOOP_336_40: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[11], tt, tt);
    VITIS_LOOP_339_41: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[13], tt, tt);
    VITIS_LOOP_342_42: for (i = 0; i < 8; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[1], tt, tt);
    VITIS_LOOP_345_43: for (i = 0; i < 6; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[10], tt, tt);
    VITIS_LOOP_348_44: for (j = 0; j < 49; j++)
    {
        VITIS_LOOP_350_45: for (i = 0; i < 5; i++)
            fpsqr503_mont(tt, tt);
        fpmul503_mont(t[14], tt, tt);
    }
    fpcopy503(tt, a);
...
__inline unsigned int mp_add(const digit_t *a, const digit_t *b, digit_t *c, const unsigned int nwords)
{
    ...
    VITIS_LOOP_390_1: for (i = 0; i < nwords; i++)
    {
...
void mp_shiftleft(digit_t *x, unsigned int shift, const unsigned int nwords)
{
    ...
    VITIS_LOOP_403_1: while (shift > 64)
    {
        j += 1;
        shift -= 64;
    }

    VITIS_LOOP_409_2: for (i = 0; i < nwords - j; i++)
    {

        x[nwords - 1 - i] = x[nwords - 1 - i - j];
    }

    VITIS_LOOP_415_3: for (i = nwords - j; i < nwords; i++)
    {
    ...
    if (shift != 0)
    {
        VITIS_LOOP_423_4: for (j = nwords - 1; j > 0; j--)
        {
...
void mp_shiftr1(digit_t *x, const unsigned int nwords)
{
    ...
    VITIS_LOOP_436_1: for (i = 0; i < nwords - 1; i++)
    {
...
void mp_shiftl1(digit_t *x, const unsigned int nwords)
{
    ...
    VITIS_LOOP_448_1: for (i = nwords - 1; i > 0; i--)
    {
