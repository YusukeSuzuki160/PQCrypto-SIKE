...
void XSikep503_kem_enc_hw_Start(XSikep503_kem_enc_hw *InstancePtr) {
    ...
    Data = XSikep503_kem_enc_hw_ReadReg(InstancePtr->Control_r_BaseAddress, XSIKEP503_KEM_ENC_HW_CONTROL_R_ADDR_AP_CTRL) & 0x80;
    XSikep503_kem_enc_hw_WriteReg(InstancePtr->Control_r_BaseAddress, XSIKEP503_KEM_ENC_HW_CONTROL_R_ADDR_AP_CTRL, Data | 0x01);
}
...
u32 XSikep503_kem_enc_hw_IsDone(XSikep503_kem_enc_hw *InstancePtr) {
    ...
    Data = XSikep503_kem_enc_hw_ReadReg(InstancePtr->Control_r_BaseAddress, XSIKEP503_KEM_ENC_HW_CONTROL_R_ADDR_AP_CTRL);
    return (Data >> 1) & 0x1;
}
...
void XSikep503_kem_enc_hw_EnableAutoRestart(XSikep503_kem_enc_hw *InstancePtr) {
    ...
    XSikep503_kem_enc_hw_WriteReg(InstancePtr->Control_r_BaseAddress, XSIKEP503_KEM_ENC_HW_CONTROL_R_ADDR_AP_CTRL, 0x80);
}
...
void XSikep503_kem_enc_hw_DisableAutoRestart(XSikep503_kem_enc_hw *InstancePtr) {
    ...
    XSikep503_kem_enc_hw_WriteReg(InstancePtr->Control_r_BaseAddress, XSIKEP503_KEM_ENC_HW_CONTROL_R_ADDR_AP_CTRL, 0);
}
...
void XSikep503_kem_enc_hw_InterruptGlobalEnable(XSikep503_kem_enc_hw *InstancePtr) {
    ...
    XSikep503_kem_enc_hw_WriteReg(InstancePtr->Control_r_BaseAddress, XSIKEP503_KEM_ENC_HW_CONTROL_R_ADDR_GIE, 1);
}
...
void XSikep503_kem_enc_hw_InterruptGlobalDisable(XSikep503_kem_enc_hw *InstancePtr) {
    ...
    XSikep503_kem_enc_hw_WriteReg(InstancePtr->Control_r_BaseAddress, XSIKEP503_KEM_ENC_HW_CONTROL_R_ADDR_GIE, 0);
}
...
void XSikep503_kem_enc_hw_InterruptEnable(XSikep503_kem_enc_hw *InstancePtr, u32 Mask) {
    ...
    Register =  XSikep503_kem_enc_hw_ReadReg(InstancePtr->Control_r_BaseAddress, XSIKEP503_KEM_ENC_HW_CONTROL_R_ADDR_IER);
    XSikep503_kem_enc_hw_WriteReg(InstancePtr->Control_r_BaseAddress, XSIKEP503_KEM_ENC_HW_CONTROL_R_ADDR_IER, Register | Mask);
}
...
void XSikep503_kem_enc_hw_InterruptClear(XSikep503_kem_enc_hw *InstancePtr, u32 Mask) {
    ...
    XSikep503_kem_enc_hw_WriteReg(InstancePtr->Control_r_BaseAddress, XSIKEP503_KEM_ENC_HW_CONTROL_R_ADDR_ISR, Mask);
}
...
u32 XSikep503_kem_enc_hw_InterruptGetEnabled(XSikep503_kem_enc_hw *InstancePtr) {
    ...
    return XSikep503_kem_enc_hw_ReadReg(InstancePtr->Control_r_BaseAddress, XSIKEP503_KEM_ENC_HW_CONTROL_R_ADDR_IER);
}
...
u32 XSikep503_kem_enc_hw_InterruptGetStatus(XSikep503_kem_enc_hw *InstancePtr) {
    ...
    return XSikep503_kem_enc_hw_ReadReg(InstancePtr->Control_r_BaseAddress, XSIKEP503_KEM_ENC_HW_CONTROL_R_ADDR_ISR);
}
