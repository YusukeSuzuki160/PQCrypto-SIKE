...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename Qnew_Z_2 \
    op interface \
    ports { Qnew_Z_2_address0 { O 3 vector } Qnew_Z_2_ce0 { O 1 bit } Qnew_Z_2_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'Qnew_Z_2'"
}
}
