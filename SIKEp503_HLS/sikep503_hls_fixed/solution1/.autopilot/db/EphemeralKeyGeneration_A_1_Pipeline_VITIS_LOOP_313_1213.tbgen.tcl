set moduleName EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_313_1213
set isTopModule 0
...
set cdfgNum 607
set C_modelName {EphemeralKeyGeneration_A.1_Pipeline_VITIS_LOOP_313_1213}
...
dict set ap_memory_interface_dict pt_new_X { MEM_WIDTH 64 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict pt_new_X_4 { MEM_WIDTH 64 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict pt_new_Z { MEM_WIDTH 64 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict pt_new_Z_4 { MEM_WIDTH 64 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ pts_Z_4 int 64 regular {array 56 { 0 1 } 1 1 }  }
	{ zext_ln14_13 int 6 regular  }
	{ pts_Z int 64 regular {array 56 { 0 1 } 1 1 }  }
	{ pts_X_4 int 64 regular {array 56 { 0 1 } 1 1 }  }
	{ pts_X int 64 regular {array 56 { 0 1 } 1 1 }  }
	{ pt_new_X int 64 regular {array 8 { 1 } 1 1 }  }
	{ pt_new_X_4 int 64 regular {array 8 { 1 } 1 1 }  }
	{ pt_new_Z int 64 regular {array 8 { 1 } 1 1 }  }
	{ pt_new_Z_4 int 64 regular {array 8 { 1 } 1 1 }  }
	{ zext_ln175 int 3 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "pts_Z_4", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "zext_ln14_13", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "pt_new_X", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "pt_new_X_4", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "pt_new_Z", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "pt_new_Z_4", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln175", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln14_13 sc_in sc_lv 6 signal 1 } 
	...
	{ pt_new_X_address0 sc_out sc_lv 3 signal 5 } 
	{ pt_new_X_ce0 sc_out sc_logic 1 signal 5 } 
	{ pt_new_X_q0 sc_in sc_lv 64 signal 5 } 
	{ pt_new_X_4_address0 sc_out sc_lv 3 signal 6 } 
	{ pt_new_X_4_ce0 sc_out sc_logic 1 signal 6 } 
	{ pt_new_X_4_q0 sc_in sc_lv 64 signal 6 } 
	{ pt_new_Z_address0 sc_out sc_lv 3 signal 7 } 
	{ pt_new_Z_ce0 sc_out sc_logic 1 signal 7 } 
	{ pt_new_Z_q0 sc_in sc_lv 64 signal 7 } 
	{ pt_new_Z_4_address0 sc_out sc_lv 3 signal 8 } 
	{ pt_new_Z_4_ce0 sc_out sc_logic 1 signal 8 } 
	{ pt_new_Z_4_q0 sc_in sc_lv 64 signal 8 } 
	{ zext_ln175 sc_in sc_lv 3 signal 9 } 
	{ npts_4 sc_in sc_lv 32 signal 10 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln14_13", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln14_13", "role": "default" }} , 
 	...
 	{ "name": "pt_new_X_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "pt_new_X", "role": "address0" }} , 
 	{ "name": "pt_new_X_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "pt_new_X", "role": "ce0" }} , 
 	{ "name": "pt_new_X_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "pt_new_X", "role": "q0" }} , 
 	{ "name": "pt_new_X_4_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "pt_new_X_4", "role": "address0" }} , 
 	{ "name": "pt_new_X_4_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "pt_new_X_4", "role": "ce0" }} , 
 	{ "name": "pt_new_X_4_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "pt_new_X_4", "role": "q0" }} , 
 	{ "name": "pt_new_Z_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "pt_new_Z", "role": "address0" }} , 
 	{ "name": "pt_new_Z_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "pt_new_Z", "role": "ce0" }} , 
 	{ "name": "pt_new_Z_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "pt_new_Z", "role": "q0" }} , 
 	{ "name": "pt_new_Z_4_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "pt_new_Z_4", "role": "address0" }} , 
 	{ "name": "pt_new_Z_4_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "pt_new_Z_4", "role": "ce0" }} , 
 	{ "name": "pt_new_Z_4_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "pt_new_Z_4", "role": "q0" }} , 
 	{ "name": "zext_ln175", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "zext_ln175", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln14_13 { ap_none {  { zext_ln14_13 in_data 0 6 } } }
	...
	pt_new_X { ap_memory {  { pt_new_X_address0 mem_address 1 3 }  { pt_new_X_ce0 mem_ce 1 1 }  { pt_new_X_q0 mem_dout 0 64 } } }
	pt_new_X_4 { ap_memory {  { pt_new_X_4_address0 mem_address 1 3 }  { pt_new_X_4_ce0 mem_ce 1 1 }  { pt_new_X_4_q0 mem_dout 0 64 } } }
	pt_new_Z { ap_memory {  { pt_new_Z_address0 mem_address 1 3 }  { pt_new_Z_ce0 mem_ce 1 1 }  { pt_new_Z_q0 mem_dout 0 64 } } }
	pt_new_Z_4 { ap_memory {  { pt_new_Z_4_address0 mem_address 1 3 }  { pt_new_Z_4_ce0 mem_ce 1 1 }  { pt_new_Z_4_q0 mem_dout 0 64 } } }
	zext_ln175 { ap_none {  { zext_ln175 in_data 0 3 } } }
