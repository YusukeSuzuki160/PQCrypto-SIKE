...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename C24_0_0 \
    op interface \
    ports { C24_0_0_address0 { O 2 vector } C24_0_0_ce0 { O 1 bit } C24_0_0_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'C24_0_0'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename C24_0_1 \
    op interface \
    ports { C24_0_1_address0 { O 2 vector } C24_0_1_ce0 { O 1 bit } C24_0_1_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'C24_0_1'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename C24_1_0 \
    op interface \
    ports { C24_1_0_address0 { O 2 vector } C24_1_0_ce0 { O 1 bit } C24_1_0_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'C24_1_0'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename C24_1_1 \
    op interface \
    ports { C24_1_1_address0 { O 2 vector } C24_1_1_ce0 { O 1 bit } C24_1_1_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'C24_1_1'"
}
}
