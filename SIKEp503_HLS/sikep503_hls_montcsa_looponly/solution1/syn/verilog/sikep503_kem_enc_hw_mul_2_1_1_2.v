...
module sikep503_kem_enc_hw_mul_2_1_1_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    grp_mul_2_1_1_fu_12_ap_start;
wire    grp_mul_2_1_1_fu_12_ap_done;
wire    grp_mul_2_1_1_fu_12_ap_idle;
wire    grp_mul_2_1_1_fu_12_ap_ready;
wire   [2:0] grp_mul_2_1_1_fu_12_c_address0;
wire    grp_mul_2_1_1_fu_12_c_ce0;
wire    grp_mul_2_1_1_fu_12_c_we0;
wire   [63:0] grp_mul_2_1_1_fu_12_c_d0;
reg    grp_mul_2_1_1_fu_12_ap_ce;
...
sikep503_kem_enc_hw_mul_2_1_1 grp_mul_2_1_1_fu_12(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(grp_mul_2_1_1_fu_12_ap_start),
    .ap_done(grp_mul_2_1_1_fu_12_ap_done),
    .ap_idle(grp_mul_2_1_1_fu_12_ap_idle),
    .ap_ready(grp_mul_2_1_1_fu_12_ap_ready),
    .c_address0(grp_mul_2_1_1_fu_12_c_address0),
    .c_ce0(grp_mul_2_1_1_fu_12_c_ce0),
    .c_we0(grp_mul_2_1_1_fu_12_c_we0),
    .c_d0(grp_mul_2_1_1_fu_12_c_d0),
    .c_q0(c_q0),
    .ap_ce(grp_mul_2_1_1_fu_12_ap_ce)
);
...
always @ (*) begin
    if (((1'b0 == ap_ce) | ((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)))) begin
        grp_mul_2_1_1_fu_12_ap_ce = 1'b0;
    end else begin
        grp_mul_2_1_1_fu_12_ap_ce = 1'b1;
    end
end

always @ (*) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1) & (1'b1 == ap_ce))) begin
        grp_mul_2_1_1_fu_12_ap_start = 1'b1;
    end else begin
        grp_mul_2_1_1_fu_12_ap_start = 1'b0;
    end
end
...
assign c_address0 = grp_mul_2_1_1_fu_12_c_address0;

assign c_ce0 = grp_mul_2_1_1_fu_12_c_ce0;

assign c_d0 = grp_mul_2_1_1_fu_12_c_d0;

assign c_we0 = grp_mul_2_1_1_fu_12_c_we0;

endmodule //sikep503_kem_enc_hw_mul_2_1_1_2
