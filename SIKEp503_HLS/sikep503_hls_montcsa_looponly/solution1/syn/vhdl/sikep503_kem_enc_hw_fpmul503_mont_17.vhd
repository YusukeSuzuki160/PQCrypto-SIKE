...
attribute shreg_extract : string;
    ...
    signal grp_mul_16_fu_78_ap_start : STD_LOGIC;
    signal grp_mul_16_fu_78_ap_done : STD_LOGIC;
    signal grp_mul_16_fu_78_ap_idle : STD_LOGIC;
    signal grp_mul_16_fu_78_ap_ready : STD_LOGIC;
    signal grp_mul_16_fu_78_c_address0 : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_mul_16_fu_78_c_ce0 : STD_LOGIC;
    signal grp_mul_16_fu_78_c_we0 : STD_LOGIC;
    signal grp_mul_16_fu_78_c_d0 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_mul_16_fu_78_ap_ce : STD_LOGIC;
    ...
    component sikep503_kem_enc_hw_mul_16 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_mul_16_fu_78 : component sikep503_kem_enc_hw_mul_16
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_mul_16_fu_78_ap_ce_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_ce)
    begin
        if (((ap_const_logic_0 = ap_ce) or ((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
            grp_mul_16_fu_78_ap_ce <= ap_const_logic_0;
        else 
            grp_mul_16_fu_78_ap_ce <= ap_const_logic_1;
        end if; 
    end process;


    grp_mul_16_fu_78_ap_start_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_ce)
    begin
        if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_logic_1 = ap_ce))) then 
            grp_mul_16_fu_78_ap_start <= ap_const_logic_1;
        else 
            grp_mul_16_fu_78_ap_start <= ap_const_logic_0;
        end if; 
    end process;

    mc_address0 <= grp_mul_16_fu_78_c_address0;
    mc_ce0 <= grp_mul_16_fu_78_c_ce0;
    mc_d0 <= grp_mul_16_fu_78_c_d0;
    mc_we0 <= grp_mul_16_fu_78_c_we0;
end behav;
