...
entity sikep503_kem_enc_hw_sikep503_kem_enc_hw_Pipeline_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sikep503_kem_enc_hw_sikep503_kem_enc_hw_Pipeline_3 is 
...
attribute shreg_extract : string;
    ...
    signal exitcond7_i5_fu_139_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal empty_186_fu_157_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal empty_186_reg_205 : STD_LOGIC_VECTOR (1 downto 0);
    signal empty_186_reg_205_pp0_iter1_reg : STD_LOGIC_VECTOR (1 downto 0);
    signal loop_index3_i_udiv_cast_reg_209 : STD_LOGIC_VECTOR (6 downto 0);
    signal loop_index3_i_udiv_cast_reg_209_pp0_iter1_reg : STD_LOGIC_VECTOR (6 downto 0);
    signal gmem_addr_read_reg_214 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_cast2_fu_181_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_grp0 : BOOLEAN;
    signal loop_index3_i_fu_64 : STD_LOGIC_VECTOR (8 downto 0) := "000000000";
    signal empty_fu_145_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_loop_index3_i_load : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal empty_187_fu_176_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    loop_index3_i_fu_64_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((exitcond7_i5_fu_139_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    loop_index3_i_fu_64 <= empty_fu_145_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    loop_index3_i_fu_64 <= ap_const_lv9_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                empty_186_reg_205 <= empty_186_fu_157_p1;
                empty_186_reg_205_pp0_iter1_reg <= empty_186_reg_205;
                loop_index3_i_udiv_cast_reg_209 <= ap_sig_allocacmp_loop_index3_i_load(8 downto 2);
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, exitcond7_i5_fu_139_p2)
    begin
        if (((exitcond7_i5_fu_139_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_loop_index3_i_load_assign_proc : process(ap_CS_fsm_pp0_stage0, loop_index3_i_fu_64, ap_loop_init, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_loop_index3_i_load <= ap_const_lv9_0;
        else 
            ap_sig_allocacmp_loop_index3_i_load <= loop_index3_i_fu_64;
        end if; 
    end process;

    empty_186_fu_157_p1 <= ap_sig_allocacmp_loop_index3_i_load(2 - 1 downto 0);
    empty_187_fu_176_p2 <= std_logic_vector(unsigned(loop_index3_i_udiv_cast_reg_209_pp0_iter1_reg) + unsigned(ap_const_lv7_6));
    empty_fu_145_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index3_i_load) + unsigned(ap_const_lv9_1));
    exitcond7_i5_fu_139_p2 <= "1" when (ap_sig_allocacmp_loop_index3_i_load = ap_const_lv9_17A) else "0";
    ...
    p_cast2_fu_181_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_187_fu_176_p2),64));
    temp_1_address0 <= p_cast2_fu_181_p1(7 - 1 downto 0);
    ...
    temp_1_d0 <= gmem_addr_read_reg_214;
    temp_1_we0 <= temp_1_we0_local;

    temp_1_we0_local_assign_proc : process(ap_enable_reg_pp0_iter2, empty_186_reg_205_pp0_iter1_reg, ap_block_pp0_stage0_11001_grp0, ap_block_pp0_stage0_subdone_grp0_done_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (empty_186_reg_205_pp0_iter1_reg = ap_const_lv2_1))) then 
    ...
    temp_2_address0 <= p_cast2_fu_181_p1(7 - 1 downto 0);
    ...
    temp_2_d0 <= gmem_addr_read_reg_214;
    temp_2_we0 <= temp_2_we0_local;

    temp_2_we0_local_assign_proc : process(ap_enable_reg_pp0_iter2, empty_186_reg_205_pp0_iter1_reg, ap_block_pp0_stage0_11001_grp0, ap_block_pp0_stage0_subdone_grp0_done_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (empty_186_reg_205_pp0_iter1_reg = ap_const_lv2_2))) then 
    ...
    temp_3_address0 <= p_cast2_fu_181_p1(7 - 1 downto 0);
    ...
    temp_3_d0 <= gmem_addr_read_reg_214;
    temp_3_we0 <= temp_3_we0_local;

    temp_3_we0_local_assign_proc : process(ap_enable_reg_pp0_iter2, empty_186_reg_205_pp0_iter1_reg, ap_block_pp0_stage0_11001_grp0, ap_block_pp0_stage0_subdone_grp0_done_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (empty_186_reg_205_pp0_iter1_reg = ap_const_lv2_3))) then 
    ...
    temp_address0 <= p_cast2_fu_181_p1(7 - 1 downto 0);
    ...
    temp_d0 <= gmem_addr_read_reg_214;
    temp_we0 <= temp_we0_local;

    temp_we0_local_assign_proc : process(ap_enable_reg_pp0_iter2, empty_186_reg_205_pp0_iter1_reg, ap_block_pp0_stage0_11001_grp0, ap_block_pp0_stage0_subdone_grp0_done_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (empty_186_reg_205_pp0_iter1_reg = ap_const_lv2_0))) then 
