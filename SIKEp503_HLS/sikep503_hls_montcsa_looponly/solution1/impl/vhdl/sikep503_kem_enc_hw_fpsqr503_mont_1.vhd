...
attribute shreg_extract : string;
    ...
    signal grp_mul_2_1_1_2_fu_12_ap_start : STD_LOGIC;
    signal grp_mul_2_1_1_2_fu_12_ap_done : STD_LOGIC;
    signal grp_mul_2_1_1_2_fu_12_ap_idle : STD_LOGIC;
    signal grp_mul_2_1_1_2_fu_12_ap_ready : STD_LOGIC;
    signal grp_mul_2_1_1_2_fu_12_c_address0 : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_mul_2_1_1_2_fu_12_c_ce0 : STD_LOGIC;
    signal grp_mul_2_1_1_2_fu_12_c_we0 : STD_LOGIC;
    signal grp_mul_2_1_1_2_fu_12_c_d0 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_mul_2_1_1_2_fu_12_ap_ce : STD_LOGIC;
    ...
    component sikep503_kem_enc_hw_mul_2_1_1_2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_mul_2_1_1_2_fu_12 : component sikep503_kem_enc_hw_mul_2_1_1_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_mul_2_1_1_2_fu_12_ap_start,
        ap_done => grp_mul_2_1_1_2_fu_12_ap_done,
        ap_idle => grp_mul_2_1_1_2_fu_12_ap_idle,
        ap_ready => grp_mul_2_1_1_2_fu_12_ap_ready,
        c_address0 => grp_mul_2_1_1_2_fu_12_c_address0,
        c_ce0 => grp_mul_2_1_1_2_fu_12_c_ce0,
        c_we0 => grp_mul_2_1_1_2_fu_12_c_we0,
        c_d0 => grp_mul_2_1_1_2_fu_12_c_d0,
        c_q0 => mc_q0,
        ap_ce => grp_mul_2_1_1_2_fu_12_ap_ce);
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state5, ap_CS_fsm_state6, ap_CS_fsm_state7, ap_CS_fsm_state8, ap_CS_fsm_state9, ap_CS_fsm_state10, ap_CS_fsm_state11, ap_CS_fsm_state12, ap_CS_fsm_state13, ap_CS_fsm_state14, ap_CS_fsm_state15, ap_CS_fsm_state16, ap_CS_fsm_state17, ap_CS_fsm_state18, ap_CS_fsm_state19, ap_CS_fsm_state20, ap_CS_fsm_state21, ap_CS_fsm_state22, ap_CS_fsm_state23, ap_CS_fsm_state24, ap_CS_fsm_state25, ap_ce)
    begin
        case ap_CS_fsm is
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state25, ap_ce)
    begin
        if ((((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_state25)))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state25, ap_ce)
    begin
        if (((ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_state25))) then 
    ...
    grp_mul_2_1_1_2_fu_12_ap_ce_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_ce)
    begin
        if (((ap_const_logic_0 = ap_ce) or ((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
            grp_mul_2_1_1_2_fu_12_ap_ce <= ap_const_logic_0;
        else 
            grp_mul_2_1_1_2_fu_12_ap_ce <= ap_const_logic_1;
        end if; 
    end process;


    grp_mul_2_1_1_2_fu_12_ap_start_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_ce)
    begin
        if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_logic_1 = ap_ce))) then 
            grp_mul_2_1_1_2_fu_12_ap_start <= ap_const_logic_1;
        else 
            grp_mul_2_1_1_2_fu_12_ap_start <= ap_const_logic_0;
        end if; 
    end process;

    mc_address0 <= grp_mul_2_1_1_2_fu_12_c_address0;
    mc_ce0 <= grp_mul_2_1_1_2_fu_12_c_ce0;
    mc_d0 <= grp_mul_2_1_1_2_fu_12_c_d0;
    mc_we0 <= grp_mul_2_1_1_2_fu_12_c_we0;
end behav;
