...
reg    grp_mul_2_1_1_2_fu_12_ap_start;
wire    grp_mul_2_1_1_2_fu_12_ap_done;
wire    grp_mul_2_1_1_2_fu_12_ap_idle;
wire    grp_mul_2_1_1_2_fu_12_ap_ready;
wire   [2:0] grp_mul_2_1_1_2_fu_12_c_address0;
wire    grp_mul_2_1_1_2_fu_12_c_ce0;
wire    grp_mul_2_1_1_2_fu_12_c_we0;
wire   [63:0] grp_mul_2_1_1_2_fu_12_c_d0;
reg    grp_mul_2_1_1_2_fu_12_ap_ce;
...
sikep503_kem_enc_hw_mul_2_1_1_2 grp_mul_2_1_1_2_fu_12(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (*) begin
    if (((1'b0 == ap_ce) | ((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)))) begin
        grp_mul_2_1_1_2_fu_12_ap_ce = 1'b0;
    end else begin
        grp_mul_2_1_1_2_fu_12_ap_ce = 1'b1;
    end
end

always @ (*) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1) & (1'b1 == ap_ce))) begin
        grp_mul_2_1_1_2_fu_12_ap_start = 1'b1;
    end else begin
        grp_mul_2_1_1_2_fu_12_ap_start = 1'b0;
    end
end
...
assign mc_address0 = grp_mul_2_1_1_2_fu_12_c_address0;

assign mc_ce0 = grp_mul_2_1_1_2_fu_12_c_ce0;

assign mc_d0 = grp_mul_2_1_1_2_fu_12_c_d0;

assign mc_we0 = grp_mul_2_1_1_2_fu_12_c_we0;
