...
dict set ap_memory_interface_dict t_71 { MEM_WIDTH 8 MEM_SIZE 34 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	...
	{ t_71 int 8 regular {array 34 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "ct","offset": { "type": "dynamic","port_name": "ct","bundle": "control"},"direction": "READWRITE"},{"cName": "pk","offset": { "type": "dynamic","port_name": "pk","bundle": "control"},"direction": "READONLY"},{"cName": "ss","offset": { "type": "dynamic","port_name": "ss","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "t_71", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ t_69_address0 sc_out sc_lv 6 signal 3 } 
	{ t_69_ce0 sc_out sc_logic 1 signal 3 } 
	{ t_69_q0 sc_in sc_lv 8 signal 3 } 
	{ t_70_address0 sc_out sc_lv 6 signal 4 } 
	{ t_70_ce0 sc_out sc_logic 1 signal 4 } 
	{ t_70_q0 sc_in sc_lv 8 signal 4 } 
	{ t_71_address0 sc_out sc_lv 6 signal 5 } 
	{ t_71_ce0 sc_out sc_logic 1 signal 5 } 
	{ t_71_q0 sc_in sc_lv 8 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "t_71_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "t_71", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_2_8_1_1_U3508", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	t_71 { ap_memory {  { t_71_address0 mem_address 1 6 }  { t_71_ce0 mem_ce 1 1 }  { t_71_q0 mem_dout 0 8 } } }
}
