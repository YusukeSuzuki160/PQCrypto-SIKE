set moduleName rdc_mont_136_Pipeline_VITIS_LOOP_306_1
set isTopModule 0
...
set cdfgNum 818
set C_modelName {rdc_mont.136_Pipeline_VITIS_LOOP_306_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "mc", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "zext_ln299", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln299 sc_in sc_lv 7 signal 1 } 
	{ mc_offset sc_in sc_lv 3 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln299", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln299", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln299 { ap_none {  { zext_ln299 in_data 0 7 } } }
