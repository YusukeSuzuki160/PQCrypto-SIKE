set moduleName mul_32_Pipeline_VITIS_LOOP_27_1
set isTopModule 0
...
set cdfgNum 818
set C_modelName {mul.32_Pipeline_VITIS_LOOP_27_1}
...
set portList { 
	...
	{ A_1_out sc_out sc_lv 512 signal 2 } 
	{ A_1_out_ap_vld sc_out sc_logic 1 outvld 2 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "mul_32_Pipeline_VITIS_LOOP_27_1",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.partset_512ns_512ns_64ns_32ns_512_1_1_U2832", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	mul_32_Pipeline_VITIS_LOOP_27_1 {
