set moduleName mul_85_Pipeline_VITIS_LOOP_84_3_VITIS_LOOP_98_4
set isTopModule 0
...
set cdfgNum 818
set C_modelName {mul.85_Pipeline_VITIS_LOOP_84_3_VITIS_LOOP_98_4}
...
set C_modelArgList {
	{ A_1_1_reload int 512 regular  }
	{ B_1_reload int 512 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "A_1_1_reload", "interface" : "wire", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "B_1_reload", "interface" : "wire", "bitwidth" : 512, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ A_1_1_reload sc_in sc_lv 512 signal 0 } 
	{ B_1_reload sc_in sc_lv 512 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "A_1_1_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "A_1_1_reload", "role": "default" }} , 
 	{ "name": "B_1_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "B_1_reload", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_64ns_64ns_128_1_1_U1594", "Parent" : "0"},
...
set Spec2ImplPortList { 
	A_1_1_reload { ap_none {  { A_1_1_reload in_data 0 512 } } }
	B_1_reload { ap_none {  { B_1_reload in_data 0 512 } } }
