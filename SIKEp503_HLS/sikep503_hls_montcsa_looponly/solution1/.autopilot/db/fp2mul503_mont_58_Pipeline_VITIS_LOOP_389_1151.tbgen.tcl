set moduleName fp2mul503_mont_58_Pipeline_VITIS_LOOP_389_1151
set isTopModule 0
...
set cdfgNum 818
set C_modelName {fp2mul503_mont.58_Pipeline_VITIS_LOOP_389_1151}
...
set C_modelArgMapList {[ 
	{ "Name" : "b_offset", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add_ln194", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ add_ln194 sc_in sc_lv 9 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln194", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "add_ln194", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "fp2mul503_mont_58_Pipeline_VITIS_LOOP_389_1151",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	fp2mul503_mont_58_Pipeline_VITIS_LOOP_389_1151 {
...
set Spec2ImplPortList { 
	...
	add_ln194 { ap_none {  { add_ln194 in_data 0 9 } } }
