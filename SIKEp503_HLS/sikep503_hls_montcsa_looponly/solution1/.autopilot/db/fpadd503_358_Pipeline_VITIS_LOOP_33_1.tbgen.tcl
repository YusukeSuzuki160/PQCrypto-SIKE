set moduleName fpadd503_358_Pipeline_VITIS_LOOP_33_1
set isTopModule 0
...
set cdfgNum 818
set C_modelName {fpadd503.358_Pipeline_VITIS_LOOP_33_1}
...
set C_modelArgList {
	{ zext_ln35_15 int 7 regular  }
	{ a int 64 regular {array 112 { 1 } 1 1 }  }
	{ zext_ln35_14 int 7 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln35_15", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
 	{ "Name" : "a", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln35_14", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln35_15", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln35_15", "role": "default" }} , 
 	...
 	{ "name": "zext_ln35_14", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln35_14", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln35_15 { ap_none {  { zext_ln35_15 in_data 0 7 } } }
	a { ap_memory {  { a_address0 mem_address 1 7 }  { a_ce0 mem_ce 1 1 }  { a_q0 mem_dout 0 64 } } }
	zext_ln35_14 { ap_none {  { zext_ln35_14 in_data 0 7 } } }
