set moduleName sikep503_kem_enc_hw_Pipeline_3
set isTopModule 0
...
set cdfgNum 818
set C_modelName {sikep503_kem_enc_hw_Pipeline_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict temp_3 { MEM_WIDTH 8 MEM_SIZE 107 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict temp_2 { MEM_WIDTH 8 MEM_SIZE 107 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict temp_1 { MEM_WIDTH 8 MEM_SIZE 107 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict temp { MEM_WIDTH 8 MEM_SIZE 107 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem int 8 regular {axi_master 0}  }
	{ pk int 64 regular  }
	{ temp_3 int 8 regular {array 107 { 0 3 } 0 1 }  }
	{ temp_2 int 8 regular {array 107 { 0 3 } 0 1 }  }
	{ temp_1 int 8 regular {array 107 { 0 3 } 0 1 }  }
	{ temp int 8 regular {array 107 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "ct","offset": { "type": "dynamic","port_name": "ct","bundle": "control"},"direction": "READWRITE"},{"cName": "pk","offset": { "type": "dynamic","port_name": "pk","bundle": "control"},"direction": "READONLY"},{"cName": "ss","offset": { "type": "dynamic","port_name": "ss","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "pk", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ pk sc_in sc_lv 64 signal 1 } 
	{ temp_3_address0 sc_out sc_lv 7 signal 2 } 
	{ temp_3_ce0 sc_out sc_logic 1 signal 2 } 
	{ temp_3_we0 sc_out sc_logic 1 signal 2 } 
	{ temp_3_d0 sc_out sc_lv 8 signal 2 } 
	{ temp_2_address0 sc_out sc_lv 7 signal 3 } 
	{ temp_2_ce0 sc_out sc_logic 1 signal 3 } 
	{ temp_2_we0 sc_out sc_logic 1 signal 3 } 
	{ temp_2_d0 sc_out sc_lv 8 signal 3 } 
	{ temp_1_address0 sc_out sc_lv 7 signal 4 } 
	{ temp_1_ce0 sc_out sc_logic 1 signal 4 } 
	{ temp_1_we0 sc_out sc_logic 1 signal 4 } 
	{ temp_1_d0 sc_out sc_lv 8 signal 4 } 
	{ temp_address0 sc_out sc_lv 7 signal 5 } 
	{ temp_ce0 sc_out sc_logic 1 signal 5 } 
	{ temp_we0 sc_out sc_logic 1 signal 5 } 
	{ temp_d0 sc_out sc_lv 8 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "pk", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "pk", "role": "default" }} , 
 	...
 	{ "name": "temp_3_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "temp_3", "role": "we0" }} , 
 	{ "name": "temp_3_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "temp_3", "role": "d0" }} , 
 	...
 	{ "name": "temp_2_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "temp_2", "role": "we0" }} , 
 	{ "name": "temp_2_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "temp_2", "role": "d0" }} , 
 	...
 	{ "name": "temp_1_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "temp_1", "role": "we0" }} , 
 	{ "name": "temp_1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "temp_1", "role": "d0" }} , 
 	...
 	{ "name": "temp_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "temp", "role": "d0" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "sikep503_kem_enc_hw_Pipeline_3",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	sikep503_kem_enc_hw_Pipeline_3 {
		gmem {Type I LastRead 1 FirstWrite -1}
		pk {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	pk { ap_none {  { pk in_data 0 64 } } }
	temp_3 { ap_memory {  { temp_3_address0 mem_address 1 7 }  { temp_3_ce0 mem_ce 1 1 }  { temp_3_we0 mem_we 1 1 }  { temp_3_d0 mem_din 1 8 } } }
	temp_2 { ap_memory {  { temp_2_address0 mem_address 1 7 }  { temp_2_ce0 mem_ce 1 1 }  { temp_2_we0 mem_we 1 1 }  { temp_2_d0 mem_din 1 8 } } }
	temp_1 { ap_memory {  { temp_1_address0 mem_address 1 7 }  { temp_1_ce0 mem_ce 1 1 }  { temp_1_we0 mem_we 1 1 }  { temp_1_d0 mem_din 1 8 } } }
	temp { ap_memory {  { temp_address0 mem_address 1 7 }  { temp_ce0 mem_ce 1 1 }  { temp_we0 mem_we 1 1 }  { temp_d0 mem_din 1 8 } } }
}
