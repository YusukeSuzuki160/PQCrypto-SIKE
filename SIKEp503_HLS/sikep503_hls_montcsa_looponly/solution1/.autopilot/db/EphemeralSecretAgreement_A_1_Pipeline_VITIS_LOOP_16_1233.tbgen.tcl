set moduleName EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_16_1233
set isTopModule 0
...
set cdfgNum 818
set C_modelName {EphemeralSecretAgreement_A.1_Pipeline_VITIS_LOOP_16_1233}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict pts_Z_1 { MEM_WIDTH 64 MEM_SIZE 448 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
...
set C_modelArgList {
	{ zext_ln17 int 6 regular  }
	{ pts_Z_1 int 64 regular {array 56 { 0 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln17", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "pts_Z_1", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ zext_ln17 sc_in sc_lv 6 signal 0 } 
	{ pts_Z_1_address0 sc_out sc_lv 6 signal 1 } 
	{ pts_Z_1_ce0 sc_out sc_logic 1 signal 1 } 
	{ pts_Z_1_we0 sc_out sc_logic 1 signal 1 } 
	{ pts_Z_1_d0 sc_out sc_lv 64 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln17", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln17", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_16_1233",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "pts_Z_1", "Type" : "Memory", "Direction" : "O"},
...
set ArgLastReadFirstWriteLatency {
	EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_16_1233 {
		zext_ln17 {Type I LastRead 0 FirstWrite -1}
		pts_Z_1 {Type O LastRead -1 FirstWrite 1}
...
set Spec2ImplPortList { 
	zext_ln17 { ap_none {  { zext_ln17 in_data 0 6 } } }
	pts_Z_1 { ap_memory {  { pts_Z_1_address0 mem_address 1 6 }  { pts_Z_1_ce0 mem_ce 1 1 }  { pts_Z_1_we0 mem_we 1 1 }  { pts_Z_1_d0 mem_din 1 64 } } }
