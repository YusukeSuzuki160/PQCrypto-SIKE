set moduleName fp2mul503_mont_2_Pipeline_VITIS_LOOP_389_1
set isTopModule 0
...
set cdfgNum 818
set C_modelName {fp2mul503_mont.2_Pipeline_VITIS_LOOP_389_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "c_offset", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln392_68", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln392_68 sc_in sc_lv 7 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln392_68", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln392_68", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln392_68 { ap_none {  { zext_ln392_68 in_data 0 7 } } }
