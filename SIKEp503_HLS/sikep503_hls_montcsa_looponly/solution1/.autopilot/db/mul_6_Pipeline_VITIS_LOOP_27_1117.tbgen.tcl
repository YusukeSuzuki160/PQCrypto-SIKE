set moduleName mul_6_Pipeline_VITIS_LOOP_27_1117
set isTopModule 0
...
set cdfgNum 818
set C_modelName {mul.6_Pipeline_VITIS_LOOP_27_1117}
...
set C_modelArgList {
	...
	{ B_13_out int 512 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "b_0", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "B_13_out", "interface" : "wire", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ B_13_out sc_out sc_lv 512 signal 2 } 
	{ B_13_out_ap_vld sc_out sc_logic 1 outvld 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "B_13_out", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "B_13_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.partset_512ns_512ns_64ns_32ns_512_1_1_U549", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	B_13_out { ap_vld {  { B_13_out out_data 1 512 }  { B_13_out_ap_vld out_vld 1 1 } } }
}
