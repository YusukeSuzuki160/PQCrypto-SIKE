...
set C_modelArgList {
	...
	{ carry_147_out int 1 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "R_Z", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "carry_147_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ carry_147_out sc_out sc_lv 1 signal 1 } 
	{ carry_147_out_ap_vld sc_out sc_logic 1 outvld 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "carry_147_out", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "carry_147_out", "role": "default" }} , 
 	{ "name": "carry_147_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "carry_147_out", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "carry_147_out", "Type" : "Vld", "Direction" : "O"},
...
set ArgLastReadFirstWriteLatency {
	fpadd503_42_Pipeline_VITIS_LOOP_39_2 {
		...
		carry_147_out {Type O LastRead -1 FirstWrite 0}
...
set Spec2ImplPortList { 
	...
	carry_147_out { ap_vld {  { carry_147_out out_data 1 1 }  { carry_147_out_ap_vld out_vld 1 1 } } }
}
