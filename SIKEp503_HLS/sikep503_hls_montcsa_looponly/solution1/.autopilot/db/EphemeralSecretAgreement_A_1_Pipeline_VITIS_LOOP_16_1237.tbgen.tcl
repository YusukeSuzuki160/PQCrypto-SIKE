set moduleName EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_16_1237
set isTopModule 0
...
set cdfgNum 818
set C_modelName {EphemeralSecretAgreement_A.1_Pipeline_VITIS_LOOP_16_1237}
...
set C_modelArgList {
	{ zext_ln17_1 int 6 regular  }
	{ pts_Z_1 int 64 regular {array 56 { 1 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln17_1", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "pts_Z_1", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln17_1", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln17_1", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_16_1237",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "pts_Z_1", "Type" : "Memory", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	EphemeralSecretAgreement_A_1_Pipeline_VITIS_LOOP_16_1237 {
		zext_ln17_1 {Type I LastRead 0 FirstWrite -1}
		pts_Z_1 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	zext_ln17_1 { ap_none {  { zext_ln17_1 in_data 0 6 } } }
	pts_Z_1 { ap_memory {  { pts_Z_1_address0 mem_address 1 6 }  { pts_Z_1_ce0 mem_ce 1 1 }  { pts_Z_1_q0 mem_dout 0 64 } } }
