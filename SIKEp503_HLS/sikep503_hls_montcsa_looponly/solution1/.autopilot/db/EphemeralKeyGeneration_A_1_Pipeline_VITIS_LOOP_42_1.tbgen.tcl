...
dict set ap_memory_interface_dict t_85 { MEM_WIDTH 64 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ t_85 int 64 regular {array 16 { 1 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "t_85", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ t_85_address0 sc_out sc_lv 4 signal 0 } 
	{ t_85_ce0 sc_out sc_logic 1 signal 0 } 
	{ t_85_q0 sc_in sc_lv 64 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "t_85_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "t_85", "role": "address0" }} , 
 	{ "name": "t_85_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "t_85", "role": "ce0" }} , 
 	{ "name": "t_85_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "t_85", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "t_85", "Type" : "Memory", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	EphemeralKeyGeneration_A_1_Pipeline_VITIS_LOOP_42_1 {
		t_85 {Type I LastRead 1 FirstWrite -1}
...
set Spec2ImplPortList { 
	t_85 { ap_memory {  { t_85_address0 mem_address 1 4 }  { t_85_ce0 mem_ce 1 1 }  { t_85_q0 mem_dout 0 64 } } }
