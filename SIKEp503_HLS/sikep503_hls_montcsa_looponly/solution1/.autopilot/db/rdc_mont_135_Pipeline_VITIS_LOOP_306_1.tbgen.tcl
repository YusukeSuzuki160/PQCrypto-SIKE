set moduleName rdc_mont_135_Pipeline_VITIS_LOOP_306_1
set isTopModule 0
...
set cdfgNum 818
set C_modelName {rdc_mont.135_Pipeline_VITIS_LOOP_306_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict mc { MEM_WIDTH 64 MEM_SIZE 448 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ mc int 64 regular {array 56 { 0 } 0 1 }  }
...
set portList { 
	...
	{ zext_ln308 sc_in sc_lv 6 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	mc { ap_memory {  { mc_address0 mem_address 1 6 }  { mc_ce0 mem_ce 1 1 }  { mc_we0 mem_we 1 1 }  { mc_d0 mem_din 1 64 } } }
