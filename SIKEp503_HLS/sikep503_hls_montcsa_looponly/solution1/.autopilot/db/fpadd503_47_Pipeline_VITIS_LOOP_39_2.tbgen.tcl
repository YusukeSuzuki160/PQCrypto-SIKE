set moduleName fpadd503_47_Pipeline_VITIS_LOOP_39_2
set isTopModule 0
...
set cdfgNum 818
set C_modelName {fpadd503.47_Pipeline_VITIS_LOOP_39_2}
...
set C_modelArgList {
	...
	{ carry_141_out int 1 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "coeff", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "carry_141_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ carry_141_out sc_out sc_lv 1 signal 1 } 
	{ carry_141_out_ap_vld sc_out sc_logic 1 outvld 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "carry_141_out", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "carry_141_out", "role": "default" }} , 
 	{ "name": "carry_141_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "carry_141_out", "role": "ap_vld" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "fpadd503_47_Pipeline_VITIS_LOOP_39_2",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "carry_141_out", "Type" : "Vld", "Direction" : "O"},
...
set ArgLastReadFirstWriteLatency {
	fpadd503_47_Pipeline_VITIS_LOOP_39_2 {
		coeff {Type IO LastRead 1 FirstWrite 2}
		carry_141_out {Type O LastRead -1 FirstWrite 1}
...
set Spec2ImplPortList { 
	...
	carry_141_out { ap_vld {  { carry_141_out out_data 1 1 }  { carry_141_out_ap_vld out_vld 1 1 } } }
}
