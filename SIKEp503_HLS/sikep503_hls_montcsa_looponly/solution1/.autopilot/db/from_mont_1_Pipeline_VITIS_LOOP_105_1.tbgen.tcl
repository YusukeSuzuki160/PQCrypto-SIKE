set moduleName from_mont_1_Pipeline_VITIS_LOOP_105_1
set isTopModule 0
...
set cdfgNum 818
set C_modelName {from_mont.1_Pipeline_VITIS_LOOP_105_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln107_1", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln107_1 sc_in sc_lv 4 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln107_1", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln107_1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln107_1 { ap_none {  { zext_ln107_1 in_data 0 4 } } }
