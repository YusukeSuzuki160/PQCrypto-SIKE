set moduleName fp2mul503_mont_231_1_Pipeline_VITIS_LOOP_389_1
set isTopModule 0
...
set cdfgNum 818
set C_modelName {fp2mul503_mont.231.1_Pipeline_VITIS_LOOP_389_1}
...
set C_modelArgList {
	{ zext_ln392_51 int 6 regular  }
	{ c_0 int 64 regular {array 56 { 1 } 1 1 }  }
	{ zext_ln392_50 int 6 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln392_51", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "c_0", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln392_50", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln392_51", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln392_51", "role": "default" }} , 
 	...
 	{ "name": "zext_ln392_50", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln392_50", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln392_51 { ap_none {  { zext_ln392_51 in_data 0 6 } } }
	c_0 { ap_memory {  { c_0_address0 mem_address 1 6 }  { c_0_ce0 mem_ce 1 1 }  { c_0_q0 mem_dout 0 64 } } }
	zext_ln392_50 { ap_none {  { zext_ln392_50 in_data 0 6 } } }
