...
void copy_words(const digit_t *a, digit_t *c, const unsigned int nwords)
{
    ...
    VITIS_LOOP_50_1: for (i = 0; i < nwords; i++)
    {
...
__inline unsigned int mp_sub(const digit_t *a, const digit_t *b, digit_t *c, const unsigned int nwords)
{
    ...
    VITIS_LOOP_171_1: for (i = 0; i < nwords; i++)
    {
...
void fp2mul503_mont(const f2elm_t a, const f2elm_t b, f2elm_t c)
{
    ...
    VITIS_LOOP_198_1: for (i = 0; i < 8; i++)
    {
...
void fpinv503_chain_mont(felm_t a)
{
    ...
    VITIS_LOOP_217_1: for (i = 0; i <= 13; i++)
        fpmul503_mont(t[i], tt, t[i + 1]);

    fpcopy503(a, tt);
    VITIS_LOOP_221_2: for (i = 0; i < 8; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(a, tt, tt);
    VITIS_LOOP_224_3: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[8], tt, tt);
    VITIS_LOOP_227_4: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[6], tt, tt);
    VITIS_LOOP_230_5: for (i = 0; i < 6; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[9], tt, tt);
    VITIS_LOOP_233_6: for (i = 0; i < 7; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[0], tt, tt);
    VITIS_LOOP_236_7: for (i = 0; i < 7; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(a, tt, tt);
    VITIS_LOOP_239_8: for (i = 0; i < 7; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[6], tt, tt);
    VITIS_LOOP_242_9: for (i = 0; i < 7; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[2], tt, tt);
    VITIS_LOOP_245_10: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[8], tt, tt);
    VITIS_LOOP_248_11: for (i = 0; i < 7; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(a, tt, tt);
    VITIS_LOOP_251_12: for (i = 0; i < 8; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[10], tt, tt);
    VITIS_LOOP_254_13: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[0], tt, tt);
    VITIS_LOOP_257_14: for (i = 0; i < 6; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[10], tt, tt);
    VITIS_LOOP_260_15: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[10], tt, tt);
    VITIS_LOOP_263_16: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[5], tt, tt);
    VITIS_LOOP_266_17: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[2], tt, tt);
    VITIS_LOOP_269_18: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[6], tt, tt);
    VITIS_LOOP_272_19: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[3], tt, tt);
    VITIS_LOOP_275_20: for (i = 0; i < 6; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[5], tt, tt);
    VITIS_LOOP_278_21: for (i = 0; i < 12; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[12], tt, tt);
    VITIS_LOOP_281_22: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[8], tt, tt);
    VITIS_LOOP_284_23: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[6], tt, tt);
    VITIS_LOOP_287_24: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[12], tt, tt);
    VITIS_LOOP_290_25: for (i = 0; i < 6; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[11], tt, tt);
    VITIS_LOOP_293_26: for (i = 0; i < 8; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[6], tt, tt);
    VITIS_LOOP_296_27: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[5], tt, tt);
    VITIS_LOOP_299_28: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[14], tt, tt);
    VITIS_LOOP_302_29: for (i = 0; i < 7; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[14], tt, tt);
    VITIS_LOOP_305_30: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[5], tt, tt);
    VITIS_LOOP_308_31: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[6], tt, tt);
    VITIS_LOOP_311_32: for (i = 0; i < 8; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[8], tt, tt);
    VITIS_LOOP_314_33: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(a, tt, tt);
    VITIS_LOOP_317_34: for (i = 0; i < 8; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[4], tt, tt);
    VITIS_LOOP_320_35: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[6], tt, tt);
    VITIS_LOOP_323_36: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[5], tt, tt);
    VITIS_LOOP_326_37: for (i = 0; i < 8; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[7], tt, tt);
    VITIS_LOOP_329_38: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(a, tt, tt);
    VITIS_LOOP_332_39: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[0], tt, tt);
    VITIS_LOOP_335_40: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[11], tt, tt);
    VITIS_LOOP_338_41: for (i = 0; i < 5; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[13], tt, tt);
    VITIS_LOOP_341_42: for (i = 0; i < 8; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[1], tt, tt);
    VITIS_LOOP_344_43: for (i = 0; i < 6; i++)
        fpsqr503_mont(tt, tt);
    fpmul503_mont(t[10], tt, tt);
    VITIS_LOOP_347_44: for (j = 0; j < 49; j++)
    {
        VITIS_LOOP_349_45: for (i = 0; i < 5; i++)
            fpsqr503_mont(tt, tt);
        fpmul503_mont(t[14], tt, tt);
    }
    fpcopy503(tt, a);
...
__inline unsigned int mp_add(const digit_t *a, const digit_t *b, digit_t *c, const unsigned int nwords)
{
    ...
    VITIS_LOOP_389_1: for (i = 0; i < nwords; i++)
    {
...
void mp_shiftleft(digit_t *x, unsigned int shift, const unsigned int nwords)
{
    ...
    VITIS_LOOP_402_1: while (shift > 64)
    {
        j += 1;
        shift -= 64;
    }

    VITIS_LOOP_408_2: for (i = 0; i < nwords - j; i++)
    {

        x[nwords - 1 - i] = x[nwords - 1 - i - j];
    }

    VITIS_LOOP_414_3: for (i = nwords - j; i < nwords; i++)
    {
    ...
    if (shift != 0)
    {
        VITIS_LOOP_422_4: for (j = nwords - 1; j > 0; j--)
        {
...
void mp_shiftr1(digit_t *x, const unsigned int nwords)
{
    ...
    VITIS_LOOP_435_1: for (i = 0; i < nwords - 1; i++)
    {
...
void mp_shiftl1(digit_t *x, const unsigned int nwords)
{
    ...
    VITIS_LOOP_447_1: for (i = nwords - 1; i > 0; i--)
    {
