...
// 
// ==============================================================
#ifndef XTEST_MUL_KARATSUBA_HANDWRITTEN_FLAT_H
#define XTEST_MUL_KARATSUBA_HANDWRITTEN_FLAT_H
...
#include <stddef.h>
#endif
#include "xtest_mul_karatsuba_handwritten_flat_hw.h"
...
} XTest_mul_karatsuba_handwritten_flat_Config;
#endif

typedef struct {
    u64 Control_BaseAddress;
    u32 IsReady;
} XTest_mul_karatsuba_handwritten_flat;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XTest_mul_karatsuba_handwritten_flat_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XTest_mul_karatsuba_handwritten_flat_ReadReg(BaseAddress, RegOffset) \
