set moduleName mp_mul_flat_Pipeline_VITIS_LOOP_19_14
set isTopModule 0
...
set cdfgNum 20
set C_modelName {mp_mul_flat_Pipeline_VITIS_LOOP_19_14}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict Sal { MEM_WIDTH 64 MEM_SIZE 48 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict Sbl { MEM_WIDTH 64 MEM_SIZE 48 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ umax3 int 3 regular  }
	{ Sal int 64 regular {array 6 { 1 3 } 1 1 }  }
	{ Sbl int 64 regular {array 6 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "umax3", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "Sal", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ umax3 sc_in sc_lv 3 signal 0 } 
	{ Sal_address0 sc_out sc_lv 3 signal 1 } 
	{ Sal_ce0 sc_out sc_logic 1 signal 1 } 
	{ Sal_q0 sc_in sc_lv 64 signal 1 } 
	{ Sbl_address0 sc_out sc_lv 3 signal 2 } 
	{ Sbl_ce0 sc_out sc_logic 1 signal 2 } 
	{ Sbl_q0 sc_in sc_lv 64 signal 2 } 
	{ A_4_out sc_out sc_lv 256 signal 3 } 
	{ A_4_out_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ B_4_out sc_out sc_lv 256 signal 4 } 
	{ B_4_out_ap_vld sc_out sc_logic 1 outvld 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "umax3", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "umax3", "role": "default" }} , 
 	...
 	{ "name": "Sal_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "Sal", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.partset_256ns_256ns_64ns_32ns_256_1_1_U83", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.partset_256ns_256ns_64ns_32ns_256_1_1_U84", "Parent" : "0"},
...
set Spec2ImplPortList { 
	umax3 { ap_none {  { umax3 in_data 0 3 } } }
	Sal { ap_memory {  { Sal_address0 mem_address 1 3 }  { Sal_ce0 mem_ce 1 1 }  { Sal_q0 mem_dout 0 64 } } }
	Sbl { ap_memory {  { Sbl_address0 mem_address 1 3 }  { Sbl_ce0 mem_ce 1 1 }  { Sbl_q0 mem_dout 0 64 } } }
