...
module mp_mul_packed_mp_mul_packed_Pipeline_VITIS_LOOP_48_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [4:0] trunc_ln48_1;
input  [60:0] sext_ln48;
input  [1023:0] P;
...
wire   [63:0] w_fu_124_p3;
reg   [63:0] w_reg_158;
reg    ap_block_pp0_stage0_11001;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [4:0] dst_fu_54;
wire   [4:0] add_ln48_fu_102_p2;
wire    ap_loop_init;
reg   [4:0] ap_sig_allocacmp_i;
wire    ap_block_pp0_stage0;
wire   [3:0] trunc_ln51_fu_108_p1;
wire   [9:0] shl_ln1_fu_112_p3;
wire   [31:0] w_fu_124_p2;
reg    ap_done_reg;
...
mp_mul_packed_partselect_64ns_1024ns_32ns_64_1_1 #(
    .DATAWIDTH( 1024 ),
    .ADDRWIDTH( 32 ),
    .DATA1WIDTH( 64 ))
partselect_64ns_1024ns_32ns_64_1_1_U9(
    .din(P),
    .sel(w_fu_124_p2),
    .dout(w_fu_124_p3)
);
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln48_fu_96_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln48_fu_96_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln48_fu_102_p2 = (ap_sig_allocacmp_i + 5'd1);
...
assign icmp_ln48_fu_96_p2 = ((ap_sig_allocacmp_i == trunc_ln48_1) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_0_WDATA = w_reg_158;
...
assign shl_ln1_fu_112_p3 = {{trunc_ln51_fu_108_p1}, {6'd0}};

assign trunc_ln51_fu_108_p1 = ap_sig_allocacmp_i[3:0];

assign w_fu_124_p2 = shl_ln1_fu_112_p3;

endmodule //mp_mul_packed_mp_mul_packed_Pipeline_VITIS_LOOP_48_1
