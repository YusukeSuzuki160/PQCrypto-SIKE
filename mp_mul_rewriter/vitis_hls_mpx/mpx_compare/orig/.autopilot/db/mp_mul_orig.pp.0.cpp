...
static const bool LSW_FIRST = true;
# 2 "src/mp_mul_orig.cpp" 2
# 19 "src/mp_mul_orig.cpp"
extern "C" __attribute__((sdx_kernel("mp_mul_orig", 0))) void mp_mul_orig(const digit_t* a, const digit_t* b, digit_t* c, const unsigned int nwords) {
#line 32 "/home/meltpoint/eeic/PQCrypto-SIKE/mp_mul_rewriter/vitis_hls_mpx/scripts/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=mp_mul_orig
# 19 "src/mp_mul_orig.cpp"
...
#pragma HLS UNROLL factor=2 skip_exit_check
 const unsigned aj = LSW_FIRST ? j : (nwords-1-j);
      ...
      VITIS_LOOP_42_1: do { ap_uint<2*(8 * sizeof(digit_t))> _p = (ap_uint<(8 * sizeof(digit_t))>)(a[aj]) * (ap_uint<(8 * sizeof(digit_t))>)(b[bj]); (UV[0]) = (digit_t)_p; *(UV+1) = (digit_t)(_p >> (8 * sizeof(digit_t))); } while(0);
      VITIS_LOOP_43_2: do { ap_uint<(8 * sizeof(digit_t))+1> _s = (ap_uint<(8 * sizeof(digit_t))+1>)(0) + (ap_uint<(8 * sizeof(digit_t))>)(UV[0]) + (ap_uint<(8 * sizeof(digit_t))>)(v); (v) = (digit_t)_s; (carry) = (unsigned)(_s >> (8 * sizeof(digit_t))); } while(0);
      VITIS_LOOP_44_3: do { ap_uint<(8 * sizeof(digit_t))+1> _s = (ap_uint<(8 * sizeof(digit_t))+1>)(carry) + (ap_uint<(8 * sizeof(digit_t))>)(UV[1]) + (ap_uint<(8 * sizeof(digit_t))>)(u); (u) = (digit_t)_s; (carry) = (unsigned)(_s >> (8 * sizeof(digit_t))); } while(0);
      t += carry;
    }
...
#pragma HLS UNROLL factor=2 skip_exit_check
 const unsigned aj = LSW_FIRST ? j : (nwords-1-j);
      const unsigned bj = LSW_FIRST ? (i-j) : (nwords-1-(i-j));
      VITIS_LOOP_61_4: do { ap_uint<2*(8 * sizeof(digit_t))> _p = (ap_uint<(8 * sizeof(digit_t))>)(a[aj]) * (ap_uint<(8 * sizeof(digit_t))>)(b[bj]); (UV[0]) = (digit_t)_p; *(UV+1) = (digit_t)(_p >> (8 * sizeof(digit_t))); } while(0);
      VITIS_LOOP_62_5: do { ap_uint<(8 * sizeof(digit_t))+1> _s = (ap_uint<(8 * sizeof(digit_t))+1>)(0) + (ap_uint<(8 * sizeof(digit_t))>)(UV[0]) + (ap_uint<(8 * sizeof(digit_t))>)(v); (v) = (digit_t)_s; (carry) = (unsigned)(_s >> (8 * sizeof(digit_t))); } while(0);
      VITIS_LOOP_63_6: do { ap_uint<(8 * sizeof(digit_t))+1> _s = (ap_uint<(8 * sizeof(digit_t))+1>)(carry) + (ap_uint<(8 * sizeof(digit_t))>)(UV[1]) + (ap_uint<(8 * sizeof(digit_t))>)(u); (u) = (digit_t)_s; (carry) = (unsigned)(_s >> (8 * sizeof(digit_t))); } while(0);
      t += carry;
    }
    const unsigned ci = LSW_FIRST ? i : (2*nwords-1-i);
    c[ci] = v;
