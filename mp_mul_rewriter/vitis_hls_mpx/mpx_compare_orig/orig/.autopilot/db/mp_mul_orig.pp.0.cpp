...
{
#line 31 "/home/meltpoint/eeic/PQCrypto-SIKE/mp_mul_rewriter/vitis_hls_mpx/scripts/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=mp_mul_orig
# 24 "src/mp_mul_orig.cpp"
 ...
 if (j <= i)
        {
          ...
          VITIS_LOOP_53_1: do { ap_uint<2 * (8 * sizeof(digit_t))> _p = (ap_uint<(8 * sizeof(digit_t))>)(a[aj]) * (ap_uint<(8 * sizeof(digit_t))>)(b[bj]); (UV[0]) = (digit_t)_p; *(UV + 1) = (digit_t)(_p >> (8 * sizeof(digit_t))); } while (0);
          VITIS_LOOP_54_2: do { ap_uint<(8 * sizeof(digit_t)) + 1> _s = (ap_uint<(8 * sizeof(digit_t)) + 1>)(0) + (ap_uint<(8 * sizeof(digit_t))>)(UV[0]) + (ap_uint<(8 * sizeof(digit_t))>)(v); (v) = (digit_t)_s; (carry) = (unsigned)(_s >> (8 * sizeof(digit_t))); } while (0);
          VITIS_LOOP_55_3: do { ap_uint<(8 * sizeof(digit_t)) + 1> _s = (ap_uint<(8 * sizeof(digit_t)) + 1>)(carry) + (ap_uint<(8 * sizeof(digit_t))>)(UV[1]) + (ap_uint<(8 * sizeof(digit_t))>)(u); (u) = (digit_t)_s; (carry) = (unsigned)(_s >> (8 * sizeof(digit_t))); } while (0);
          t += carry;
        }
      }
 ...
 if (j >= i + 1 && j < nwords)
        {
          ...
          VITIS_LOOP_83_4: do { ap_uint<2 * (8 * sizeof(digit_t))> _p = (ap_uint<(8 * sizeof(digit_t))>)(a[aj]) * (ap_uint<(8 * sizeof(digit_t))>)(b[bj]); (UV[0]) = (digit_t)_p; *(UV + 1) = (digit_t)(_p >> (8 * sizeof(digit_t))); } while (0);
          VITIS_LOOP_84_5: do { ap_uint<(8 * sizeof(digit_t)) + 1> _s = (ap_uint<(8 * sizeof(digit_t)) + 1>)(0) + (ap_uint<(8 * sizeof(digit_t))>)(UV[0]) + (ap_uint<(8 * sizeof(digit_t))>)(v); (v) = (digit_t)_s; (carry) = (unsigned)(_s >> (8 * sizeof(digit_t))); } while (0);
          VITIS_LOOP_85_6: do { ap_uint<(8 * sizeof(digit_t)) + 1> _s = (ap_uint<(8 * sizeof(digit_t)) + 1>)(carry) + (ap_uint<(8 * sizeof(digit_t))>)(UV[1]) + (ap_uint<(8 * sizeof(digit_t))>)(u); (u) = (digit_t)_s; (carry) = (unsigned)(_s >> (8 * sizeof(digit_t))); } while (0);
          t += carry;
        }
      }
