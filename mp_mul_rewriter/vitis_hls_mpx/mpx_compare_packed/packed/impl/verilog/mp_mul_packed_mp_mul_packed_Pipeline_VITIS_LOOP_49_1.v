...
module mp_mul_packed_mp_mul_packed_Pipeline_VITIS_LOOP_49_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_idle_pp0;
reg   [0:0] icmp_ln52_reg_170;
reg    ap_block_state2_io_grp1;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] icmp_ln49_fu_102_p2;
...
wire   [63:0] w_fu_136_p3;
reg   [63:0] w_reg_174;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [4:0] dst_fu_60;
wire   [4:0] add_ln49_fu_108_p2;
wire    ap_loop_init;
reg   [4:0] ap_sig_allocacmp_i;
wire    ap_block_pp0_stage0;
wire   [3:0] trunc_ln54_fu_120_p1;
wire   [9:0] shl_ln1_fu_124_p3;
wire   [31:0] w_fu_136_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln49_fu_102_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln49_fu_102_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_grp1) & (icmp_ln52_reg_170 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (icmp_ln52_reg_170 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln49_fu_108_p2 = (ap_sig_allocacmp_i + 5'd1);
...
always @ (*) begin
    ap_block_state2_io_grp1 = ((icmp_ln52_reg_170 == 1'd1) & (m_axi_gmem_0_WREADY == 1'b0));
end
...
assign icmp_ln49_fu_102_p2 = ((ap_sig_allocacmp_i == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln52_fu_114_p2 = ((ap_sig_allocacmp_i < trunc_ln1) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_0_WDATA = w_reg_174;
...
assign shl_ln1_fu_124_p3 = {{trunc_ln54_fu_120_p1}, {6'd0}};

assign trunc_ln54_fu_120_p1 = ap_sig_allocacmp_i[3:0];

assign w_fu_136_p2 = shl_ln1_fu_124_p3;

endmodule //mp_mul_packed_mp_mul_packed_Pipeline_VITIS_LOOP_49_1
