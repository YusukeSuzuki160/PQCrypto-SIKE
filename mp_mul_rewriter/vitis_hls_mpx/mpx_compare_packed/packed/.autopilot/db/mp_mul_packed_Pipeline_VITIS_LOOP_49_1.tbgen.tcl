set moduleName mp_mul_packed_Pipeline_VITIS_LOOP_49_1
set isTopModule 0
...
set cdfgNum 6
set C_modelName {mp_mul_packed_Pipeline_VITIS_LOOP_49_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem int 64 regular {axi_master 1}  }
	{ sext_ln49 int 61 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "a","offset": { "type": "dynamic","port_name": "a","bundle": "control"},"direction": "READONLY"},{"cName": "b","offset": { "type": "dynamic","port_name": "b","bundle": "control"},"direction": "READONLY"},{"cName": "c","offset": { "type": "dynamic","port_name": "c","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln49", "interface" : "wire", "bitwidth" : 61, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln49 sc_in sc_lv 61 signal 1 } 
	{ trunc_ln1 sc_in sc_lv 5 signal 2 } 
	{ P sc_in sc_lv 1024 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln49", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "sext_ln49", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "mp_mul_packed_Pipeline_VITIS_LOOP_49_1",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.partselect_64ns_1024ns_32ns_64_1_1_U9", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	mp_mul_packed_Pipeline_VITIS_LOOP_49_1 {
...
set Spec2ImplPortList { 
	...
	sext_ln49 { ap_none {  { sext_ln49 in_data 0 61 } } }
