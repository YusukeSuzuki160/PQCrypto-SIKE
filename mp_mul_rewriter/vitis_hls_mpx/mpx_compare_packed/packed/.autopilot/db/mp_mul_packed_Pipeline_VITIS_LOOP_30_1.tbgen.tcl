set moduleName mp_mul_packed_Pipeline_VITIS_LOOP_30_1
set isTopModule 0
...
set cdfgNum 6
set C_modelName {mp_mul_packed_Pipeline_VITIS_LOOP_30_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem int 64 regular {axi_master 0}  }
	{ sext_ln30 int 61 regular  }
	{ empty int 4 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "a","offset": { "type": "dynamic","port_name": "a","bundle": "control"},"direction": "READONLY"},{"cName": "b","offset": { "type": "dynamic","port_name": "b","bundle": "control"},"direction": "READONLY"},{"cName": "c","offset": { "type": "dynamic","port_name": "c","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln30", "interface" : "wire", "bitwidth" : 61, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln30 sc_in sc_lv 61 signal 1 } 
	{ empty sc_in sc_lv 4 signal 2 } 
	{ A_out sc_out sc_lv 512 signal 3 } 
	{ A_out_ap_vld sc_out sc_logic 1 outvld 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln30", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "sext_ln30", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln30 { ap_none {  { sext_ln30 in_data 0 61 } } }
