; ModuleID = '/home/meltpoint/eeic/PQCrypto-SIKE/mp_mul_rewriter/vitis_hls_mpx/mpx_compare_packed/packed/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline willreturn
define void @apatb_mp_mul_packed_ir(i64* noalias nocapture nonnull readonly "maxi" %a, i64* noalias nocapture nonnull readonly "maxi" %b, i64* noalias nocapture nonnull "maxi" %c, i32 %nwords) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_mp_mul_packed_hw(i64* %a_copy, i64* %b_copy, i64* %c_copy, i32 %nwords)
...
declare void @apatb_mp_mul_packed_hw(i64*, i64*, i64*, i32)
...
declare void @mp_mul_packed_hw_stub(i64* noalias nocapture nonnull readonly, i64* noalias nocapture nonnull readonly, i64* noalias nocapture nonnull, i32)

define void @mp_mul_packed_hw_stub_wrapper(i64*, i64*, i64*, i32) #4 {
entry:
  call void @copy_out(i64* null, i64* %0, i64* null, i64* %1, i64* null, i64* %2)
  call void @mp_mul_packed_hw_stub(i64* %0, i64* %1, i64* %2, i32 %3)
