...
// ==============================================================
`timescale 1ns/1ps
module mp_mul_packed_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_C_DATA_1      = 6'h2c,
    ADDR_C_CTRL        = 6'h30,
    ADDR_NWORDS_DATA_0 = 6'h34,
    ADDR_NWORDS_CTRL   = 6'h38,
    WRIDLE             = 2'd0,
    WRDATA             = 2'd1,
    WRRESP             = 2'd2,
    WRRESET            = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_NWORDS_DATA_0: begin
                    rdata <= int_nwords[31:0];
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_NWORDS_DATA_0)
            int_nwords[31:0] <= (WDATA[31:0] & wmask) | (int_nwords[31:0] & ~wmask);
    end
end
