...
// 多倍長乗算関数（学校式）
void mp_mul_no_hls(const uint64_t *a, const uint64_t *b, uint64_t *c, const unsigned int nwords)
{
    // 結果配列を初期化
...
int main()
{
    ...
    mp_mul_no_hls(a, b, c, 2);

    std::cout << "Test: No HLS directives multiplication\n";
