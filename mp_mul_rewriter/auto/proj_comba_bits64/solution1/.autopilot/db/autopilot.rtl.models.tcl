set SynModuleInfo {
  ...
  {SRCNAME mul_Pipeline_VITIS_LOOP_219_3 MODELNAME mul_Pipeline_VITIS_LOOP_219_3 RTLNAME test_mul_comba_configurable_mul_Pipeline_VITIS_LOOP_219_3
    SUBMODULES {
      {MODELNAME test_mul_comba_configurable_mul_64ns_64ns_128_1_1 RTLNAME test_mul_comba_configurable_mul_64ns_64ns_128_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
    }
  }
