set SynModuleInfo {
  ...
  {SRCNAME mul_Pipeline_VITIS_LOOP_84_2_VITIS_LOOP_98_3 MODELNAME mul_Pipeline_VITIS_LOOP_84_2_VITIS_LOOP_98_3 RTLNAME test_mul_iface_configurable_mul_Pipeline_VITIS_LOOP_84_2_VITIS_LOOP_98_3
    SUBMODULES {
      {MODELNAME test_mul_iface_configurable_partselect_16ns_512ns_32ns_16_1_1 RTLNAME test_mul_iface_configurable_partselect_16ns_512ns_32ns_16_1_1 BINDTYPE op TYPE partselect IMPL auto}
      {MODELNAME test_mul_iface_configurable_mul_16ns_16ns_32_1_1 RTLNAME test_mul_iface_configurable_mul_16ns_16ns_32_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
    }
  }
