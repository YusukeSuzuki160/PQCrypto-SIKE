set moduleName mul_Pipeline_VITIS_LOOP_131_4
set isTopModule 0
...
set cdfgNum 9
set C_modelName {mul_Pipeline_VITIS_LOOP_131_4}
...
set C_modelArgMapList {[ 
	{ "Name" : "ACC_1_reload", "interface" : "wire", "bitwidth" : 1024, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ ACC_1_reload sc_in sc_lv 1024 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ACC_1_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "ACC_1_reload", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.partselect_64ns_1024ns_32ns_64_1_1_U14", "Parent" : "0"},
...
set Spec2ImplPortList { 
	ACC_1_reload { ap_none {  { ACC_1_reload in_data 0 1024 } } }
