set moduleName test_mul_converted_Pipeline_VITIS_LOOP_25_11
set isTopModule 0
...
set cdfgNum 6
set C_modelName {test_mul_converted_Pipeline_VITIS_LOOP_25_11}
...
set C_modelArgList {
	...
	{ A_2_out int 512 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "b", "interface" : "bram", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "A_2_out", "interface" : "wire", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ A_2_out sc_out sc_lv 512 signal 1 } 
	{ A_2_out_ap_vld sc_out sc_logic 1 outvld 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "A_2_out", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "A_2_out", "role": "default" }} , 
 	{ "name": "A_2_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "A_2_out", "role": "ap_vld" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "test_mul_converted_Pipeline_VITIS_LOOP_25_11",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	test_mul_converted_Pipeline_VITIS_LOOP_25_11 {
...
set Spec2ImplPortList { 
	...
	A_2_out { ap_vld {  { A_2_out out_data 1 512 }  { A_2_out_ap_vld out_vld 1 1 } } }
}
