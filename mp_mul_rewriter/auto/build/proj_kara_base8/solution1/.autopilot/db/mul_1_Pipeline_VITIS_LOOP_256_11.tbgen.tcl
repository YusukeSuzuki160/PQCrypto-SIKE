set moduleName mul_1_Pipeline_VITIS_LOOP_256_11
set isTopModule 0
...
set cdfgNum 11
set C_modelName {mul.1_Pipeline_VITIS_LOOP_256_11}
...
dict set ap_memory_interface_dict lb { MEM_WIDTH 64 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ b int 64 regular {bram 8 { 1 3 } 1 1 }  }
	{ lb int 64 regular {array 8 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "b", "interface" : "bram", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "lb", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ b_Addr_A sc_out sc_lv 32 signal 0 } 
	{ b_EN_A sc_out sc_logic 1 signal 0 } 
	{ b_WEN_A sc_out sc_lv 8 signal 0 } 
	{ b_Din_A sc_out sc_lv 64 signal 0 } 
	{ b_Dout_A sc_in sc_lv 64 signal 0 } 
	{ lb_address0 sc_out sc_lv 3 signal 1 } 
	{ lb_ce0 sc_out sc_logic 1 signal 1 } 
	{ lb_we0 sc_out sc_logic 1 signal 1 } 
	{ lb_d0 sc_out sc_lv 64 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "lb_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "lb", "role": "we0" }} , 
 	{ "name": "lb_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "lb", "role": "d0" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "mul_1_Pipeline_VITIS_LOOP_256_11",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	mul_1_Pipeline_VITIS_LOOP_256_11 {
...
set Spec2ImplPortList { 
	...
	lb { ap_memory {  { lb_address0 mem_address 1 3 }  { lb_ce0 mem_ce 1 1 }  { lb_we0 mem_we 1 1 }  { lb_d0 mem_din 1 64 } } }
}
