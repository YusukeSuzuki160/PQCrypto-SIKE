set moduleName mul_1_Pipeline_VITIS_LOOP_256_1
set isTopModule 0
...
set cdfgNum 44
set C_modelName {mul.1_Pipeline_VITIS_LOOP_256_1}
...
dict set ap_memory_interface_dict la { MEM_WIDTH 64 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ a int 64 regular {bram 8 { 1 3 } 1 1 }  }
	{ la int 64 regular {array 8 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "a", "interface" : "bram", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "la", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ la_address0 sc_out sc_lv 3 signal 1 } 
	{ la_ce0 sc_out sc_logic 1 signal 1 } 
	{ la_we0 sc_out sc_logic 1 signal 1 } 
	{ la_d0 sc_out sc_lv 64 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "la_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "la", "role": "address0" }} , 
 	{ "name": "la_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "la", "role": "ce0" }} , 
 	{ "name": "la_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "la", "role": "we0" }} , 
 	{ "name": "la_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "la", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	la { ap_memory {  { la_address0 mem_address 1 3 }  { la_ce0 mem_ce 1 1 }  { la_we0 mem_we 1 1 }  { la_d0 mem_din 1 64 } } }
}
