set moduleName karatsuba_combine_3_Pipeline_VITIS_LOOP_128_15
set isTopModule 0
...
set cdfgNum 44
set C_modelName {karatsuba_combine.3_Pipeline_VITIS_LOOP_128_15}
...
set C_modelArgList {
	...
	{ W2_out int 387 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "nz", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "W2_out", "interface" : "wire", "bitwidth" : 387, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ W2_out sc_out sc_lv 387 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "W2_out", "direction": "out", "datatype": "sc_lv", "bitwidth":387, "type": "signal", "bundle":{"name": "W2_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	W2_out { ap_vld {  { W2_out out_data 1 387 }  { W2_out_ap_vld out_vld 1 1 } } }
}
