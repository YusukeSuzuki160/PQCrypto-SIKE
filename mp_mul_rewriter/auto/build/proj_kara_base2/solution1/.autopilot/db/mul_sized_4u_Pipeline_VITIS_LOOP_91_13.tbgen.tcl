set moduleName mul_sized_4u_Pipeline_VITIS_LOOP_91_13
set isTopModule 0
...
set cdfgNum 44
set C_modelName {mul_sized<4u>_Pipeline_VITIS_LOOP_91_13}
...
set C_modelArgList {
	...
	{ carry_8_out int 2 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "Bl", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "carry_8_out", "interface" : "wire", "bitwidth" : 2, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ Bl_address0 sc_out sc_lv 3 signal 0 } 
	{ Bl_ce0 sc_out sc_logic 1 signal 0 } 
	{ Bl_q0 sc_in sc_lv 64 signal 0 } 
	{ Bh_address0 sc_out sc_lv 3 signal 1 } 
	{ Bh_ce0 sc_out sc_logic 1 signal 1 } 
	{ Bh_q0 sc_in sc_lv 64 signal 1 } 
	{ Sbl_address0 sc_out sc_lv 4 signal 2 } 
	{ Sbl_ce0 sc_out sc_logic 1 signal 2 } 
	{ Sbl_we0 sc_out sc_logic 1 signal 2 } 
	{ Sbl_d0 sc_out sc_lv 64 signal 2 } 
	{ carry_8_out sc_out sc_lv 2 signal 3 } 
	{ carry_8_out_ap_vld sc_out sc_logic 1 outvld 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "carry_8_out", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "carry_8_out", "role": "default" }} , 
 	{ "name": "carry_8_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "carry_8_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	...
	carry_8_out { ap_vld {  { carry_8_out out_data 1 2 }  { carry_8_out_ap_vld out_vld 1 1 } } }
}
