set moduleName karatsuba_combine_Pipeline_VITIS_LOOP_128_110
set isTopModule 0
...
set cdfgNum 56
set C_modelName {karatsuba_combine_Pipeline_VITIS_LOOP_128_110}
...
set C_modelArgList {
	...
	{ W1v_out int 644 regular {pointer 1}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "nz_4", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "z1", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "W1v_out", "interface" : "wire", "bitwidth" : 644, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "nz_4", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "nz_4", "role": "default" }} , 
 	...
 	{ "name": "W1v_out", "direction": "out", "datatype": "sc_lv", "bitwidth":644, "type": "signal", "bundle":{"name": "W1v_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	nz_4 { ap_none {  { nz_4 in_data 0 4 } } }
	z1 { ap_memory {  { z1_address0 mem_address 1 5 }  { z1_ce0 mem_ce 1 1 }  { z1_q0 mem_dout 0 64 } } }
	W1v_out { ap_vld {  { W1v_out out_data 1 644 }  { W1v_out_ap_vld out_vld 1 1 } } }
}
