set moduleName karatsuba_combine_3_Pipeline_VITIS_LOOP_128_18
set isTopModule 0
...
set cdfgNum 56
set C_modelName {karatsuba_combine.3_Pipeline_VITIS_LOOP_128_18}
...
set C_modelArgList {
	...
	{ W1v_out int 515 regular {pointer 1}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "nz_2", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "z1", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "W1v_out", "interface" : "wire", "bitwidth" : 515, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ nz_2 sc_in sc_lv 4 signal 0 } 
	{ z1_address0 sc_out sc_lv 5 signal 1 } 
	{ z1_ce0 sc_out sc_logic 1 signal 1 } 
	{ z1_q0 sc_in sc_lv 64 signal 1 } 
	{ W1v_out sc_out sc_lv 515 signal 2 } 
	{ W1v_out_ap_vld sc_out sc_logic 1 outvld 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "nz_2", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "nz_2", "role": "default" }} , 
 	...
 	{ "name": "W1v_out", "direction": "out", "datatype": "sc_lv", "bitwidth":515, "type": "signal", "bundle":{"name": "W1v_out", "role": "default" }} , 
 	{ "name": "W1v_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "W1v_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	nz_2 { ap_none {  { nz_2 in_data 0 4 } } }
	z1 { ap_memory {  { z1_address0 mem_address 1 5 }  { z1_ce0 mem_ce 1 1 }  { z1_q0 mem_dout 0 64 } } }
	W1v_out { ap_vld {  { W1v_out out_data 1 515 }  { W1v_out_ap_vld out_vld 1 1 } } }
}
