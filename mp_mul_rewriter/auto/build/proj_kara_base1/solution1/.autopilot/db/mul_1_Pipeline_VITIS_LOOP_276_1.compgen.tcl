...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename lc \
    op interface \
    ports { lc_address0 { O 4 vector } lc_ce0 { O 1 bit } lc_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'lc'"
}
}
