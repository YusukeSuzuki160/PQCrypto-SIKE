set moduleName karatsuba_combine_3_Pipeline_VITIS_LOOP_128_1
set isTopModule 0
...
set cdfgNum 56
set C_modelName {karatsuba_combine.3_Pipeline_VITIS_LOOP_128_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "nz", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ nz sc_in sc_lv 3 signal 0 } 
	{ z0_address0 sc_out sc_lv 4 signal 1 } 
	{ z0_ce0 sc_out sc_logic 1 signal 1 } 
	{ z0_q0 sc_in sc_lv 64 signal 1 } 
	{ W0_out sc_out sc_lv 258 signal 2 } 
	{ W0_out_ap_vld sc_out sc_logic 1 outvld 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "nz", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "nz", "role": "default" }} , 
