set moduleName karatsuba_combine_Pipeline_VITIS_LOOP_77_1
set isTopModule 0
...
set cdfgNum 56
set C_modelName {karatsuba_combine_Pipeline_VITIS_LOOP_77_1}
...
set C_modelArgList {
	{ out_words_assign int 5 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "out_words_assign", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ out_words_assign sc_in sc_lv 5 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_words_assign", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "out_words_assign", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.partselect_64ns_1024ns_32ns_64_1_1_U88", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "6", "Max" : "18"}
	, {"Name" : "Interval", "Min" : "6", "Max" : "18"}
]}
...
set Spec2ImplPortList { 
	out_words_assign { ap_none {  { out_words_assign in_data 0 5 } } }
