set moduleName mul_sized_8u_Pipeline_VITIS_LOOP_128_1
set isTopModule 0
...
set cdfgNum 25
set C_modelName {mul_sized<8u>_Pipeline_VITIS_LOOP_128_1}
...
set C_modelArgList {
	...
	{ p_out int 515 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "z0", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "p_out", "interface" : "wire", "bitwidth" : 515, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ z0_address0 sc_out sc_lv 4 signal 0 } 
	{ z0_ce0 sc_out sc_logic 1 signal 0 } 
	{ z0_q0 sc_in sc_lv 64 signal 0 } 
	{ p_out sc_out sc_lv 515 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_out", "direction": "out", "datatype": "sc_lv", "bitwidth":515, "type": "signal", "bundle":{"name": "p_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	p_out { ap_vld {  { p_out out_data 1 515 }  { p_out_ap_vld out_vld 1 1 } } }
}
