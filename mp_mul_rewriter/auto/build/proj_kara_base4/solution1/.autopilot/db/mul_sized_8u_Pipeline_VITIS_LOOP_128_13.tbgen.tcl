set moduleName mul_sized_8u_Pipeline_VITIS_LOOP_128_13
set isTopModule 0
...
set cdfgNum 25
set C_modelName {mul_sized<8u>_Pipeline_VITIS_LOOP_128_13}
...
set C_modelArgMapList {[ 
	{ "Name" : "shl_ln1", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ shl_ln1 sc_in sc_lv 4 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "shl_ln1", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "shl_ln1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	shl_ln1 { ap_none {  { shl_ln1 in_data 0 4 } } }
