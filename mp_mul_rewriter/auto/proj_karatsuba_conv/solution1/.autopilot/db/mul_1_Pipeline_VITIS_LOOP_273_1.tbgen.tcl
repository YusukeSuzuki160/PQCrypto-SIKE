set moduleName mul_1_Pipeline_VITIS_LOOP_273_1
set isTopModule 0
...
set cdfgNum 28
set C_modelName {mul.1_Pipeline_VITIS_LOOP_273_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict lc { MEM_WIDTH 64 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
set C_modelArgList {
	{ lc int 64 regular {array 16 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "lc", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ lc_address0 sc_out sc_lv 4 signal 0 } 
	{ lc_ce0 sc_out sc_logic 1 signal 0 } 
	{ lc_q0 sc_in sc_lv 64 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "lc_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "lc", "role": "address0" }} , 
 	{ "name": "lc_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "lc", "role": "ce0" }} , 
 	{ "name": "lc_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "lc", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	lc { ap_memory {  { lc_address0 mem_address 1 4 }  { lc_ce0 mem_ce 1 1 }  { lc_q0 mem_dout 0 64 } } }
