...
set C_modelArgList {
	{ select_ln210 int 3 regular  }
	{ zext_ln214 int 3 regular  }
	{ zext_ln210 int 132 regular  }
	{ zext_ln219 int 2 regular  }
	{ zext_ln210_1 int 3 regular  }
	{ a int 64 regular {bram 8 { 1 1 } 1 1 }  }
	{ b int 64 regular {bram 8 { 1 1 } 1 1 }  }
	{ sum_1_out int 260 regular {pointer 1}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "select_ln210", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln214", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln210", "interface" : "wire", "bitwidth" : 132, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln219", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln210_1", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "a", "interface" : "bram", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "b", "interface" : "bram", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "sum_1_out", "interface" : "wire", "bitwidth" : 260, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ select_ln210 sc_in sc_lv 3 signal 0 } 
	{ zext_ln214 sc_in sc_lv 3 signal 1 } 
	{ zext_ln210 sc_in sc_lv 132 signal 2 } 
	{ zext_ln219 sc_in sc_lv 2 signal 3 } 
	{ zext_ln210_1 sc_in sc_lv 3 signal 4 } 
	...
	{ sum_1_out sc_out sc_lv 260 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "select_ln210", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "select_ln210", "role": "default" }} , 
 	{ "name": "zext_ln214", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "zext_ln214", "role": "default" }} , 
 	{ "name": "zext_ln210", "direction": "in", "datatype": "sc_lv", "bitwidth":132, "type": "signal", "bundle":{"name": "zext_ln210", "role": "default" }} , 
 	{ "name": "zext_ln219", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "zext_ln219", "role": "default" }} , 
 	{ "name": "zext_ln210_1", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "zext_ln210_1", "role": "default" }} , 
 	...
 	{ "name": "sum_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":260, "type": "signal", "bundle":{"name": "sum_1_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_128ns_128ns_256_1_1_U1", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4", "Max" : "19"}
	, {"Name" : "Interval", "Min" : "4", "Max" : "19"}
]}
...
set Spec2ImplPortList { 
	select_ln210 { ap_none {  { select_ln210 in_data 0 3 } } }
	zext_ln214 { ap_none {  { zext_ln214 in_data 0 3 } } }
	zext_ln210 { ap_none {  { zext_ln210 in_data 0 132 } } }
	zext_ln219 { ap_none {  { zext_ln219 in_data 0 2 } } }
	zext_ln210_1 { ap_none {  { zext_ln210_1 in_data 0 3 } } }
	...
	sum_1_out { ap_vld {  { sum_1_out out_data 1 260 }  { sum_1_out_ap_vld out_vld 1 1 } } }
}
