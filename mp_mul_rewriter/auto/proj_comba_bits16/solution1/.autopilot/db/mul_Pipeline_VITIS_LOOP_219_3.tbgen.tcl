...
set C_modelArgList {
	{ j_start int 6 regular  }
	{ zext_ln210 int 23 regular  }
	{ zext_ln215 int 5 regular  }
	{ t int 6 regular  }
	{ a int 64 regular {bram 8 { 1 1 } 1 1 }  }
	{ b int 64 regular {bram 8 { 1 1 } 1 1 }  }
	{ sum_1_out int 39 regular {pointer 1}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "j_start", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln210", "interface" : "wire", "bitwidth" : 23, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln215", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "t", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "a", "interface" : "bram", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "b", "interface" : "bram", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "sum_1_out", "interface" : "wire", "bitwidth" : 39, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ j_start sc_in sc_lv 6 signal 0 } 
	{ zext_ln210 sc_in sc_lv 23 signal 1 } 
	{ zext_ln215 sc_in sc_lv 5 signal 2 } 
	{ t sc_in sc_lv 6 signal 3 } 
	...
	{ sum_1_out sc_out sc_lv 39 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "j_start", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "j_start", "role": "default" }} , 
 	{ "name": "zext_ln210", "direction": "in", "datatype": "sc_lv", "bitwidth":23, "type": "signal", "bundle":{"name": "zext_ln210", "role": "default" }} , 
 	{ "name": "zext_ln215", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "zext_ln215", "role": "default" }} , 
 	{ "name": "t", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "t", "role": "default" }} , 
 	...
 	{ "name": "sum_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":39, "type": "signal", "bundle":{"name": "sum_1_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "6", "EstimateLatencyMax" : "21",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16ns_16ns_39ns_39_4_1_U1", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "6", "Max" : "21"}
	, {"Name" : "Interval", "Min" : "6", "Max" : "21"}
]}
...
set Spec2ImplPortList { 
	j_start { ap_none {  { j_start in_data 0 6 } } }
	zext_ln210 { ap_none {  { zext_ln210 in_data 0 23 } } }
	zext_ln215 { ap_none {  { zext_ln215 in_data 0 5 } } }
	t { ap_none {  { t in_data 0 6 } } }
	...
	sum_1_out { ap_vld {  { sum_1_out out_data 1 39 }  { sum_1_out_ap_vld out_vld 1 1 } } }
}
