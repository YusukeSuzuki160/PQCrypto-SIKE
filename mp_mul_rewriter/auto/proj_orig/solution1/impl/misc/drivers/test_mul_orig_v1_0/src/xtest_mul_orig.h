...
// 
// ==============================================================
#ifndef XTEST_MUL_ORIG_H
#define XTEST_MUL_ORIG_H
...
#ifndef __linux__
#define XTest_mul_orig_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XTest_mul_orig_ReadReg(BaseAddress, RegOffset) \
